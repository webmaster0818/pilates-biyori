...
const SLUG = "the-silk-matsudo";
const store = getTheSilkStore(SLUG)!;

export const metadata: Metadata = {
  title: `松戸のthe SILK（ザ シルク）｜料金・体験・口コミとアクセス`,
  description: `松戸のthe SILK（the SILK 松戸店）の料金・体験レッスン・アクセスを掲載データで整理。${store.access}。Googleの口コミをもとにした編集部の要約（出典リンクつき）と、松戸エリアのピラティス比較へのリンク付き。`,
