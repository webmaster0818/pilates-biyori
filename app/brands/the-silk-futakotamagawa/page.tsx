...
const SLUG = "the-silk-futakotamagawa";
const store = getTheSilkStore(SLUG)!;

export const metadata: Metadata = {
  title: `二子玉川のthe SILK（ザ シルク）｜料金・体験・口コミとアクセス`,
  description: `二子玉川のthe SILK（the SILK 二子玉川店）の料金・体験レッスン・アクセスを掲載データで整理。${store.access}。Googleの口コミをもとにした編集部の要約（出典リンクつき）と、二子玉川エリアのピラティス比較へのリンク付き。`,
