...
const SLUG = "the-silk-yokohama";
const store = getTheSilkStore(SLUG)!;

export const metadata: Metadata = {
  title: `横浜のthe SILK（ザ シルク）｜料金・体験・口コミとアクセス`,
  description: `横浜のthe SILK（the SILK 横浜店）の料金・体験レッスン・アクセスを掲載データで整理。${store.access}。Googleの口コミをもとにした編集部の要約（出典リンクつき）と、横浜エリアのピラティス比較へのリンク付き。`,
