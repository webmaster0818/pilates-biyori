...
export const metadata: Metadata = {
  title: `${store.areaQuery}のPilates KASANE｜料金・体験・アクセスと店舗情報【2026年8月】`,
  description: `${store.areaQuery}のPilates KASANE（${store.storeName}）の料金・体験レッスン・アクセスを当サイト掲載データで整理。${store.access}。${store.areaQuery}周辺のピラティス比較・ブランド全店舗一覧へのリンク付き。`,
