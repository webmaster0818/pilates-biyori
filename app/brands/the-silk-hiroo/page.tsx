...
const SLUG = "the-silk-hiroo";
const store = getTheSilkStore(SLUG)!;

export const metadata: Metadata = {
  title: `広尾のthe SILK（ザ シルク）｜料金・体験・口コミとアクセス`,
  description: `広尾のthe SILK（the SILK 広尾店）の料金・体験レッスン・アクセスを掲載データで整理。${store.access}。Googleの口コミをもとにした編集部の要約（出典リンクつき）と、広尾エリアのピラティス比較へのリンク付き。`,
