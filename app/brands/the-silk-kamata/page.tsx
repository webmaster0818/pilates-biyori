...
const SLUG = "the-silk-kamata";
const store = getTheSilkStore(SLUG)!;

export const metadata: Metadata = {
  title: `蒲田のthe SILK（ザ シルク）｜料金・体験・口コミとアクセス`,
  description: `蒲田のthe SILK（the SILK 蒲田店）の料金・体験レッスン・アクセスを掲載データで整理。${store.access}。Googleの口コミをもとにした編集部の要約（出典リンクつき）と、蒲田エリアのピラティス比較へのリンク付き。`,
