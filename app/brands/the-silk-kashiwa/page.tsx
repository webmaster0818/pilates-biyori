...
const SLUG = "the-silk-kashiwa";
const store = getTheSilkStore(SLUG)!;

export const metadata: Metadata = {
  title: `柏のthe SILK（ザ シルク）｜料金・体験・口コミとアクセス`,
  description: `柏のthe SILK（the SILK 柏店）の料金・体験レッスン・アクセスを掲載データで整理。${store.access}。Googleの口コミをもとにした編集部の要約（出典リンクつき）と、柏エリアのピラティス比較へのリンク付き。`,
