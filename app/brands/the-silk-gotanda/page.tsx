...
const SLUG = "the-silk-gotanda";
const store = getTheSilkStore(SLUG)!;

export const metadata: Metadata = {
  title: `五反田のthe SILK（ザ シルク）｜料金・体験・口コミとアクセス`,
  description: `五反田のthe SILK（the SILK 五反田店）の料金・体験レッスン・アクセスを掲載データで整理。${store.access}。Googleの口コミをもとにした編集部の要約（出典リンクつき）と、五反田エリアのピラティス比較へのリンク付き。`,
