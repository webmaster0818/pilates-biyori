...
const SLUG = "the-silk-akihabara";
const store = getTheSilkStore(SLUG)!;

export const metadata: Metadata = {
  title: `秋葉原のthe SILK（ザ シルク）｜料金・体験・口コミとアクセス`,
  description: `秋葉原のthe SILK（the SILK 秋葉原店）の料金・体験レッスン・アクセスを掲載データで整理。${store.access}。Googleの口コミをもとにした編集部の要約（出典リンクつき）と、秋葉原エリアのピラティス比較へのリンク付き。`,
