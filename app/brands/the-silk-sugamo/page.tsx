...
const SLUG = "the-silk-sugamo";
const store = getTheSilkStore(SLUG)!;

export const metadata: Metadata = {
  title: `巣鴨のthe SILK（ザ シルク）｜料金・体験・口コミとアクセス`,
  description: `巣鴨のthe SILK（the SILK 巣鴨店）の料金・体験レッスン・アクセスを掲載データで整理。${store.access}。Googleの口コミをもとにした編集部の要約（出典リンクつき）と、巣鴨エリアのピラティス比較へのリンク付き。`,
