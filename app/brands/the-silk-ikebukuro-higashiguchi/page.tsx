...
const SLUG = "the-silk-ikebukuro-higashiguchi";
const store = getTheSilkStore(SLUG)!;

export const metadata: Metadata = {
  title: `池袋東口のthe SILK（ザ シルク）｜料金・体験・口コミとアクセス`,
  description: `池袋東口のthe SILK（the SILK 池袋東口店）の料金・体験レッスン・アクセスを掲載データで整理。${store.access}。Googleの口コミをもとにした編集部の要約（出典リンクつき）と、池袋エリアのピラティス比較へのリンク付き。`,
