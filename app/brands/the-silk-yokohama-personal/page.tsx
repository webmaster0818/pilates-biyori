...
const SLUG = "the-silk-yokohama-personal";
const store = getTheSilkStore(SLUG)!;

export const metadata: Metadata = {
  title: `横浜パーソナルのthe SILK（ザ シルク）｜料金・体験・口コミとアクセス`,
  description: `横浜パーソナルのthe SILK（the SILK 横浜パーソナル店）の料金・体験レッスン・アクセスを掲載データで整理。${store.access}。Googleの口コミをもとにした編集部の要約（出典リンクつき）と、横浜エリアのピラティス比較へのリンク付き。`,
