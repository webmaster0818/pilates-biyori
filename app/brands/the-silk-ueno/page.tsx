...
const SLUG = "the-silk-ueno";
const store = getTheSilkStore(SLUG)!;

export const metadata: Metadata = {
  title: `上野のthe SILK（ザ シルク）｜料金・体験・口コミとアクセス`,
  description: `上野のthe SILK（the SILK 上野店）の料金・体験レッスン・アクセスを掲載データで整理。${store.access}。Googleの口コミをもとにした編集部の要約（出典リンクつき）と、上野エリアのピラティス比較へのリンク付き。`,
