...
const SLUG = "the-silk-urawa";
const store = getTheSilkStore(SLUG)!;

export const metadata: Metadata = {
  title: `浦和のthe SILK（ザ シルク）｜料金・体験・口コミとアクセス`,
  description: `浦和のthe SILK（the SILK 浦和店）の料金・体験レッスン・アクセスを掲載データで整理。${store.access}。Googleの口コミをもとにした編集部の要約（出典リンクつき）と、浦和エリアのピラティス比較へのリンク付き。`,
