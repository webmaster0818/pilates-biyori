...
const SLUG = "the-silk-tennoji-mio";
const store = getTheSilkStore(SLUG)!;

export const metadata: Metadata = {
  title: `天王寺MIOのthe SILK（ザ シルク）｜料金・体験・口コミとアクセス`,
  description: `天王寺MIOのthe SILK（the SILK 天王寺MIO店）の料金・体験レッスン・アクセスを掲載データで整理。${store.access}。Googleの口コミをもとにした編集部の要約（出典リンクつき）と、天王寺エリアのピラティス比較へのリンク付き。`,
