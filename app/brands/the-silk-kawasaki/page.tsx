...
const SLUG = "the-silk-kawasaki";
const store = getTheSilkStore(SLUG)!;

export const metadata: Metadata = {
  title: `川崎のthe SILK（ザ シルク）｜料金・体験・口コミとアクセス`,
  description: `川崎のthe SILK（the SILK 川崎店）の料金・体験レッスン・アクセスを掲載データで整理。${store.access}。Googleの口コミをもとにした編集部の要約（出典リンクつき）と、川崎エリアのピラティス比較へのリンク付き。`,
