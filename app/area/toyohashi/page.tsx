...
export const metadata = {
  title: '【2026最新】ピラティス豊橋おすすめ5選！人気スタジオの料金プランを簡単比較！',
  description: '豊橋エリアのおすすめピラティススタジオ5選を徹底比較。マシンピラティス、体験レッスン、料金相場、選び方まで完全ガイド。JR「豊橋駅」/ 名鉄「豊橋駅」周辺の初心者でも安心して通えるスタジオが見つかります。',
...
const studios = [
  ...
  {
    name: 'luluto（ルルト）豊橋店', image: '/images/studios/luluto.webp', rating: 4.8, reviewCount: 18,
    reviews: [
  ...
  return (
    <>
      ...
      <main className="pt-20 bg-white">
        ...
        <TableOfContents areaName="豊橋" studioNames={studios.map((s) => s.name)} />
        ...
        <section className="py-16 bg-warm-50" id="studios"><div className="max-w-6xl mx-auto px-6 lg:px-8"><h2 className="text-2xl md:text-3xl font-bold text-warm-900 mb-8 text-center">豊橋のおすすめピラティススタジオ5選</h2><div className="space-y-8">{studios.map((studio, index) => (<StudioCard key={index} studio={studio} index={index} />))}</div></div></section>
