...
export const metadata = {
  title: '姫路のピラティス｜初心者OK・無料体験で選ぶ料金比較【2026年6月】',
...
const studios = [
  ...
  {
    name: 'luluto（ルルト）姫路店', image: '/images/studios/luluto.webp', rating: 4.8, reviewCount: 22,
    reviews: [
  ...
  return (
    <>
      ...
      <main className="pt-20 bg-white">
        ...
        <TableOfContents areaName="姫路" studioNames={studios.map((s) => s.name)} />
        ...
        <section className="py-16 bg-warm-50" id="studios"><div className="max-w-6xl mx-auto px-6 lg:px-8"><h2 className="text-2xl md:text-3xl font-bold text-warm-900 mb-8 text-center">姫路のおすすめピラティススタジオ5選</h2><div className="space-y-8">{studios.map((studio, index) => (<StudioCard key={index} studio={studio} index={index} />))}</div></div></section>
