...
export const metadata = {
  title: '【2026最新】ピラティス品川おすすめ6選！人気スタジオの料金プランを簡単比較！｜Pilates Navi',
  description: '品川エリアのおすすめピラティススタジオ6選を徹底比較。マシンピラティス、体験レッスン、料金相場、選び方まで完全ガイド。初心者でも安心して通えるスタジオが見つかります。',
    ...
    reviews: [
      {
        ...
        rating: 5,
        date: '2週間前',
        text: '品川駅港南口から徒歩2分で最高のアクセス。2026年2月にオープンしたばかりの新しいスタジオで設備がピカピカです。',
      },
      {
        author: 'Y.T',
        rating: 5,
        date: '1ヶ月前',
        text: '月4回8,800円という品川エリアでは圧倒的な安さ。女性専用で安心して通えます。初心者が87%以上なので安心。',
      },
      {
        author: 'K.H',
        rating: 4,
        date: '3週間前',
        text: '2店舗通い放題プランが13,800円でお得。品川で新生活を始めた方にもおすすめです。',
      },
    ],
    price: '月4回 8,800円〜',
    trial: '体験レッスン 無料',
    ...
    reviews: [
      {
        ...
        rating: 5,
        date: '1週間前',
        text: '五反田駅から徒歩5分。品川からも1駅。マットもマシンも両方受けられるのが嬉しい。体験1,000円で気軽に始められました。',
      },
      {
        author: 'A.H',
        rating: 4,
        date: '2週間前',
        text: '平日は朝7:30からやっているので出勤前に通えるのが便利。少人数制で丁寧に指導してもらえます。',
      },
      {
        author: 'M.M',
        rating: 5,
        date: '3週間前',
        text: '月4回10,450円はこのエリアでは良心的な料金。全国の店舗が利用可能なのも嬉しいポイント。',
      },
    ],
    ...
    reviews: [
      {
        ...
        rating: 5,
        date: '5日前',
        text: '大井町駅から徒歩3分。品川からも京浜東北線で1駅。zen placeは全国の店舗が利用可能なので出張時にも便利。',
      },
      {
        author: 'H.I',
        rating: 4,
        date: '1週間前',
        text: '少人数制のグループレッスンで丁寧に指導してもらえます。大井町は生活感のある落ち着いた街で通いやすい。',
      },
      {
        author: 'S.N',
        rating: 5,
        date: '2週間前',
        text: 'リフォーマーグループレッスンが充実。マシンを使ったトレーニングで効果を実感しています。',
      },
    ],
...
const faqs = [
  { question: 'ピラティス初心者でも大丈夫ですか？', answer: '大丈夫です！品川エリアのスタジオは初心者が87%以上のスタジオもあり、基礎から丁寧に指導してくれます。' },
  { question: 'マットピラティスとマシンピラティスの違いは？', answer: 'マットは自重エクササイズ、マシンは専用マシン（リフォーマーなど）を使ったトレーニングです。マシンは負荷調整がしやすく初心者におすすめ。' },
  { question: '品川エリアの料金相場は？', answer: 'グループレッスン月4回で8,800円〜15,400円程度。パーソナルは1回6,500円〜10,000円。体験は無料〜1,000円が多いです。' },
  ...
  { question: '体験レッスンは何を持っていけばいいですか？', answer: '動きやすい服装と飲み物があればOK。レンタルできるスタジオが多いです。' },
  ...
  { question: 'パーソナルとグループ、どちらがおすすめ？', answer: 'パーソナルは効果が出やすく、グループは安く楽しく続けられます。体験で試してみてください。' },
]
      ...
      <main className="pt-20 bg-white">
        <section className="bg-gradient-to-br from-warm-50 to-warm-100 py-12 md:py-16">
          <div className="max-w-4xl mx-auto px-6 lg:px-8">
            ...
            <h1 className="text-2xl md:text-3xl lg:text-4xl font-bold text-warm-900 mb-4">【2026最新】ピラティス品川おすすめ6選！<br className="hidden md:block" />人気スタジオの料金プランを簡単比較！</h1>
          </div>
        </section>
        <section className="bg-white py-3 border-b border-warm-100">
          <div className="max-w-6xl mx-auto px-6 lg:px-8"><nav className="text-sm text-warm-400"><Link href="/" className="hover:text-warm-800 transition">ホーム</Link>{' > '}<Link href="/area" className="hover:text-warm-800 transition">地域別</Link>{' > '}<span className="text-warm-600">品川</span></nav></div>
        </section>
        <section className="py-12 bg-white">
          <div className="max-w-4xl mx-auto px-6 lg:px-8">
            ...
            <p className="text-warm-600 leading-relaxed font-medium mb-6">「品川周辺でピラティスを始めたい」</p>
            <p className="text-warm-600 leading-relaxed mb-6">「駅近で通いやすいスタジオを知りたい」</p>
            <p className="text-warm-600 leading-relaxed mb-6">と思っていませんか？</p>
            <p className="text-warm-600 leading-relaxed mb-8">そこでこの記事では、品川エリアでおすすめのピラティススタジオ6選をまとめました。</p>
            <div className="bg-warm-50 border-l-4 border-warm-400 p-6 mb-8">
              <h2 className="text-lg font-bold text-warm-900 mb-4">こんな人におすすめ</h2>
              <ul className="space-y-2 text-warm-700">
                <li className="flex items-start"><span className="text-warm-400 mr-2">✓</span><span>品川・五反田・大井町でピラティススタジオを探している</span></li>
                ...
                <li className="flex items-start"><span className="text-warm-400 mr-2">✓</span><span>安くてコスパの良いスタジオを知りたい</span></li>
        ...
        <section className="py-16 bg-warm-50" id="studios">
          <div className="max-w-6xl mx-auto px-6 lg:px-8">
            <h2 className="text-2xl md:text-3xl font-bold text-warm-900 mb-8 text-center">品川エリアのおすすめピラティススタジオ6選</h2>
          ...
          <div className="max-w-6xl mx-auto px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="border border-warm-200 rounded-lg p-6 hover:shadow-lg transition">
                ...
                <p className="text-warm-600 text-sm mb-4">月額1万円以下から通えるスタジオ。</p>
              ...
              <div className="border border-warm-200 rounded-lg p-6 hover:shadow-lg transition">
                ...
                <p className="text-warm-600 text-sm mb-4">品川駅から徒歩or1駅でアクセス可能。</p>
                <ul className="space-y-2 text-sm">
          ...
          <div className="max-w-6xl mx-auto px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="border-2 border-warm-300 rounded-lg p-6 text-center">
                ...
                <p className="text-sm text-warm-600 mb-4">コスパ抜群のグループレッスン。</p>
                <ul className="text-sm text-warm-700 space-y-1"><li>• Rintosull（月4回 8,800円）</li><li>• zen place（マット月4回 9,625円〜）</li></ul>
              </div>
              <div className="border-2 border-warm-500 rounded-lg p-6 text-center bg-warm-50">
                <div className="inline-block bg-warm-800 text-white text-xs px-3 py-1 rounded-full mb-2">人気</div>
                <h3 className="text-lg font-bold text-warm-900 mb-2">予算 13,000〜16,000円/月</h3>
                <p className="text-3xl font-bold text-warm-800 mb-4">月4回</p>
                <p className="text-sm text-warm-600 mb-4">マシン完備の充実レッスン。</p>
                <ul className="text-sm text-warm-700 space-y-1"><li>• the SILK（ライト3 12,980円〜）</li><li>• Rintosull 通い放題（13,800円）</li><li>• zen place リフォーマー（15,400円〜）</li></ul>
              </div>
              <div className="border-2 border-warm-300 rounded-lg p-6 text-center">
                ...
                <p className="text-sm text-warm-600 mb-4">プライベートレッスン。</p>
                <ul className="text-sm text-warm-700 space-y-1"><li>• STUDIO IVY（1回 6,500円〜）</li><li>• zen place（プライベート 9,900円〜）</li></ul>
              </div>
            </div>
          </div>
        </section>
        <section className="py-16 bg-warm-50">
          <div className="max-w-4xl mx-auto px-6 lg:px-8">
            ...
            <div className="space-y-8">
              ...
              <div className="bg-white rounded-lg p-6 border border-warm-200"><div className="flex items-center mb-4"><span className="bg-warm-800 text-white w-8 h-8 rounded-full flex items-center justify-center font-bold mr-3">2</span><h3 className="text-xl font-bold text-warm-900">予算を決める</h3></div><p className="text-warm-600 leading-relaxed">品川エリアの料金相場は月4回で8,800円〜15,400円程度。無理なく継続できる予算を決めましょう。</p></div>
              <div className="bg-white rounded-lg p-6 border border-warm-200"><div className="flex items-center mb-4"><span className="bg-warm-800 text-white w-8 h-8 rounded-full flex items-center justify-center font-bold mr-3">3</span><h3 className="text-xl font-bold text-warm-900">体験レッスンに行く</h3></div><p className="text-warm-600 leading-relaxed">無料〜1,000円で体験できるスタジオが多いので、気軽に試してみてください。</p></div>
              <div className="bg-white rounded-lg p-6 border border-warm-200"><div className="flex items-center mb-4"><span className="bg-warm-800 text-white w-8 h-8 rounded-full flex items-center justify-center font-bold mr-3">4</span><h3 className="text-xl font-bold text-warm-900">通いやすさを確認する</h3></div><p className="text-warm-600 leading-relaxed">品川はJR山手線・京浜東北線・横須賀線・東海道新幹線・京急線が利用できるターミナル駅。五反田・大井町・田町も近く、zen placeだけで品川区内に複数店舗展開しています。</p></div>
            </div>
          </div>
        </section>
        <section className="py-16 bg-white">
        ...
        <section className="py-16 bg-warm-50">
          <div className="max-w-4xl mx-auto px-6 lg:px-8">
            ...
            <p className="text-warm-600 leading-relaxed mb-6">今回は品川エリアのおすすめピラティススタジオについてご紹介しましたが、いかがでしたか？</p>
            <p className="text-warm-600 leading-relaxed mb-6">品川はJR・京急が利用できるターミナル駅で、五反田・大井町・田町も近隣。2026年にオープンしたRintosull品川店をはじめ、zen placeの複数店舗やパーソナル専門スタジオまで充実しています。</p>
