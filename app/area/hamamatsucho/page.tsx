...
export const metadata = {
  title: '浜松町・大門のピラティス｜初心者OK・無料体験で選ぶ料金比較【2026年6月】',
  description: '浜松町・大門エリアでおすすめのピラティススタジオを料金・無料体験・マシン対応で徹底比較。初心者向けの選び方、駅近スタジオ、体験レッスンの有無まで2026年6月の最新情報でわかります。',
  ...
  return (
    <>
      ...
      <main className="pt-20 bg-white">
        ...
        <TableOfContents areaName="浜松町" studioNames={studios.map((s) => s.name)} />
