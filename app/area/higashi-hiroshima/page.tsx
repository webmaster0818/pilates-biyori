...
export const metadata = {
  title: '【2026年最新】東広島のピラティススタジオ｜料金・体験プラン比較｜Pilates-Biyori',
  description: '東広島市/区のピラティススタジオを比較。公式サイトで確認した料金・体験プラン・住所を掲載。',
  keywords: 'ピラティス,東広島,スタジオ,料金,体験レッスン',
}

export default function Page() {
  const area = areaStudios['higashi-hiroshima']
  if (!area) return null
  return (
    <>
      <BreadcrumbSchema items={[
        ...
        { name: '東広島', url: 'https://biyori-pilates.com/area/higashi-hiroshima/' },
      ]} />
      <Navigation />
      <main className="max-w-4xl mx-auto px-4 py-10">
        ...
        <h1 className="text-3xl md:text-4xl font-bold mb-4">東広島のピラティススタジオ</h1>
        ...
        <section className="mt-12 bg-gray-50 p-6 rounded-lg">
          <h2 className="text-2xl font-bold mb-4">東広島でピラティススタジオを選ぶときのポイント</h2>
