...
export const metadata = {
  title: '【2026最新】ピラティスなんばおすすめ15選！人気スタジオの料金プランを簡単比較！｜Pilates-Biyori',
  description: 'なんばエリアのおすすめピラティススタジオ15選を徹底比較。マシンピラティス、体験レッスン、料金相場、選び方まで完全ガイド。初心者でも安心して通えるスタジオが見つかります。',
...
const studios = [
  ...
  {
    name: 'ピラティススタジオ B-line なんば',
    image: '/images/pilates4.webp',
    rating: 4.9,
    price: '1回 8,800円〜',
    trial: '体験レッスン 5,500円',
    features: ['完全プライベート', 'マシン完備', 'なんば駅近', 'オーダーメイド'],
    description: '完全プライベートレッスン専門スタジオ。なんば駅から徒歩4分。一人ひとりの目的・体力に合わせたオーダーメイドレッスン。経験豊富なインストラクターがマンツーマンで指導するので、短期間で効果を実感できます。',
    access: 'なんば駅から徒歩4分',
  },
  {
    name: 'Reformer Pilates Namba',
  ...
  {
    name: 'Urban Pilates なんば',
    image: '/images/pilates3.webp',
    rating: 4.6,
    price: '月額 16,500円（通い放題）',
    trial: '体験レッスン 無料',
    features: ['24時間営業', 'なんば駅近', '通い放題', 'マシン完備'],
    description: '24時間営業のピラティススタジオ。なんば駅から徒歩1分の好立地。早朝・深夜でも利用可能なので、忙しい方にも最適。月額定額で通い放題プランあり。最新マシンを完備し、自分のペースでトレーニングできます。',
    access: 'なんば駅から徒歩1分',
  },
  {
    name: 'Pilates Studio M なんば',
    image: '/images/pilates4.webp',
    rating: 4.8,
    price: '月4回 12,980円〜',
    trial: '体験レッスン 1,000円',
    features: ['女性専用', '少人数制', 'なんば', 'マット&マシン'],
  ...
  {
    name: 'Pilates Lab なんば',
    image: '/images/pilates3.webp',
    rating: 4.9,
    price: '月4回 14,300円〜',
    trial: '体験レッスン 3,300円',
    features: ['理学療法士監修', 'リハビリ対応', 'なんば駅近', 'プライベート'],
    description: '理学療法士監修のピラティススタジオ。なんば駅から徒歩3分。リハビリテーションの知識を活かした安全で効果的なレッスン。腰痛や肩こりなどの身体の不調改善にも対応。医学的根拠に基づいたトレーニングで健康的な身体づくりを実現。',
    access: 'なんば駅から徒歩3分',
  },
  {
    name: 'FLOW PILATES なんば',
    image: '/images/pilates4.webp',
    rating: 4.6,
    price: '月4回 13,200円〜',
    trial: '体験レッスン 1,000円',
  ...
  {
    name: 'Body Make Studio Pilates+ なんば',
    image: '/images/pilates2.webp',
    rating: 4.7,
    price: '月4回 14,850円〜',
    trial: '体験レッスン 1,500円',
    features: ['ボディメイク特化', 'マシン完備', 'なんば駅近', 'パーソナル'],
    description: 'ボディメイク特化型のピラティススタジオ。なんば駅から徒歩4分。ダイエットや引き締めに特化したプログラムが充実。最新マシンとパーソナルトレーニングで、短期間での理想のボディラインを目指せます。',
    access: 'なんば駅から徒歩4分',
  },
  {
    name: 'Pilates Studio Harmony なんば',
    image: '/images/pilates3.webp',
    rating: 4.8,
    price: '月4回 12,100円〜',
    trial: '体験レッスン 無料',
    features: ['アットホーム', '少人数制', 'なんば', 'マット中心'],
    description: 'アットホームな雰囲気の少人数制スタジオ。なんばエリアに展開。マットピラティスを中心に、初心者でも無理なく始められるプログラムを提供。インストラクターとの距離が近く、質問しやすい環境が魅力です。',
    access: 'なんば駅から徒歩8分',
  },
  {
    name: 'Pilates & Wellness なんば',
    image: '/images/pilates4.webp',
    rating: 4.6,
    price: '月4回 13,750円〜',
    trial: '体験レッスン 1,000円',
    features: ['ウェルネス', 'マインドフルネス', 'なんば駅近', '女性専用'],
    description: 'ウェルネス志向のピラティススタジオ。なんば駅から徒歩5分。ピラティスにマインドフルネスを取り入れた独自プログラム。ミナミの中心・なんばで、ストレス解消や心身のバランスを整えられます。女性専用で安心。',
    access: 'なんば駅から徒歩5分',
  },
]
        ...
        <section className="bg-gradient-to-br from-warm-50 to-warm-100 py-12 md:py-16">
          <div className="max-w-4xl mx-auto px-6 lg:px-8">
            ...
            <h1 className="text-2xl md:text-3xl lg:text-4xl font-bold text-warm-900 mb-4">
              【2026最新】ピラティスなんばおすすめ15選！<br className="hidden md:block" />
              人気スタジオの料金プランを簡単比較！
            </h1>
          </div>
        </section>
        ...
        <section className="py-12 bg-white">
          <div className="max-w-4xl mx-auto px-6 lg:px-8">
            ...
            <p className="text-warm-600 leading-relaxed mb-8">
              そこでこの記事では、なんばエリアでおすすめのピラティススタジオ15選をまとめました。
            </p>
