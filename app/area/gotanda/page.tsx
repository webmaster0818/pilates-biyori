...
export const metadata = {
  ...
  title: '【2026年9月最新】ピラティス五反田おすすめ6選！人気スタジオの料金プランを簡単比較！',
    ...
    <>
      ...
      <div className="my-8 bg-white border border-warm-200 p-5">
        ...
        <div className="flex flex-wrap gap-2">
          ...
          <Link href="/brands/the-silk-gotanda/" className="text-xs text-warm-800 border border-warm-300 bg-white px-3 py-1.5 hover:border-warm-500 transition-colors">the SILK 五反田店の料金・体験を見る</Link>
