...
export const metadata = {
  alternates: { canonical: 'https://biyori-pilates.com/area/korakuen/' },
  title: '【2026年9月最新】後楽園のピラティススタジオおすすめ5選｜無料体験・料金で比較',
  description: '後楽園のピラティススタジオ5社の料金・無料体験・マシン対応を徹底比較。初心者向けの選び方、駅近スタジオ、体験レッスン当日の流れまで2026年7月の最新情報でわかります。',
  ...
  return (
    <>
      ...
      <BreadcrumbSchema items={[
        ...
        { name: '後楽園', url: 'https://pilates-biyori.com/area/korakuen/' },
      ]} />
      ...
      <main className="pt-20 bg-white">
        ...
        <TableOfContents areaName="後楽園" studioNames={[...studios].sort((a,b)=>(((b as any).officialUrl||'').includes('felmat')?1:0)-(((a as any).officialUrl||'').includes('felmat')?1:0)).map((s) => s.name)} />
        ...
        <PriceComparisonTable studios={studios} areaName="後楽園" />
      ...
      <ConsultantSection areaKey="korakuen" areaName="後楽園" />

      <RelatedAreas currentSlug="korakuen" />
      <SiteFooter />
