...
export const metadata = {
  ...
  title: '【2026年9月最新】練馬のピラティス｜初心者OK・無料体験で選ぶ料金比較',
...
const studios = [
  ...
  },
  {
    ...
    description: '1インストラクターにつき最大3名のセミパーソナル方式のマシンピラティススタジオ。1回あたり1,250円（※37,500円の通い放題コースで30日通った場合）〜と手頃な価格でリフォーマーを使った本格レッスンを受けられる。',
    access: '練馬駅 徒歩1分',
    address: '〒176-0012 東京都練馬区豊玉北5丁目18-13 大鳥ビル 303',
    popularPlan: {
      name: 'セミパーソナルプラン',
