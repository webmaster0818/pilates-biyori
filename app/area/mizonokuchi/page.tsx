...
export const metadata = {
  title: '【2026最新】ピラティス溝の口おすすめ5選！人気スタジオの料金プランを簡単比較！｜Pilates-Biyori',
...
const studios = [
  {
    ...
    reviews: [
      { author: 'K.N', rating: 5, date: '1週間前', text: '溝の口駅から徒歩2分で抜群のアクセス。マットもマシンも両方受けられるのが魅力。全国150店舗以上で相互利用可能。' },
