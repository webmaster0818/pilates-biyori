...
export const metadata = {
  title: '【2026最新】ピラティス中野おすすめ12選！人気スタジオの料金プランを簡単比較！｜Pilates-Biyori',
...
const studios = [
    ...
    reviews: [
      {
        ...
        rating: 5,
        date: '2週間前',
        text: '中野駅から徒歩7分。マットグループもマシングループもあり選べるのがいい。男性OKなので夫婦で通っています。',
      },
      {
        author: 'A.S',
        rating: 5,
        date: '1ヶ月前',
        text: 'zen placeは全国にスタジオがあり、他店舗も利用できるので出張先でも通えて便利。インストラクターの質も安定しています。',
      },
      {
        author: 'K.O',
        rating: 4,
        date: '3週間前',
        text: 'マットグループ月4回9,625円からと手頃。マシングループは15,400円〜だけど少人数で丁寧に見てもらえます。',
      },
    ],
    ...
    reviews: [
      {
        ...
        rating: 5,
        date: '2週間前',
        text: '女性専用で安心。中野駅から徒歩4分と近い。リフォーマーを使った本格レッスンが受けられます。',
      },
      {
        author: 'Y.T',
        rating: 5,
        date: '1ヶ月前',
        text: 'マシン専門スタジオなのでリフォーマーの台数が多く、予約が取りやすい。初心者クラスから始められて良かった。',
      },
      {
        author: 'K.H',
        rating: 4,
        date: '3週間前',
        text: '女性専用なので周りを気にせず集中できる。インストラクターが丁寧で初心者にもおすすめ。',
      },
    ],
    price: 'お問い合わせください',
    trial: '体験レッスンあり',
    ...
    reviews: [
      {
        ...
        rating: 5,
        date: '1週間前',
        text: '中野駅南口から徒歩2分で通いやすい。プライベート30分4,400円〜はかなりお得。短時間で集中できます。',
      },
      {
        author: 'R.S',
        rating: 5,
        date: '2週間前',
        text: '女性専用で安心感がある。30分のプライベートレッスンなのでスキマ時間に通える。',
      },
      {
        author: 'N.T',
        rating: 4,
        date: '3週間前',
        text: '駅からすごく近いので仕事帰りに寄れる。30分だから負担が少なく続けやすい。',
      },
    ],
    ...
    reviews: [
      {
        ...
        rating: 5,
        date: '1週間前',
        text: '完全個室でのパーソナルレッスン。周りの目を気にせず集中できる。1回6,250円〜はパーソナルとしてはリーズナブル。',
      },
      {
        author: 'A.H',
        rating: 5,
        date: '2週間前',
        text: '月2回15,000円〜から始められるので、初めてのパーソナルピラティスにちょうどいい。',
      },
      {
        author: 'M.M',
        rating: 4,
        date: '3週間前',
        text: '完全個室なので人目を気にせずレッスンに集中できる。インストラクターの指導も丁寧。',
      },
    ],
    price: '1レッスン 6,250円〜',
    trial: '体験レッスンあり',
    ...
    reviews: [
      {
        ...
        rating: 5,
        date: '1週間前',
        text: '世界最大級のピラティスチェーンだけあって、プログラムがしっかりしている。月4回10,890円〜はお手頃。',
      },
      {
        author: 'Y.M',
        rating: 4,
        date: '2週間前',
        text: 'グループレッスンで最大12名。人数が多めだけどインストラクターが丁寧にフォームを直してくれる。',
      },
      {
        author: 'S.T',
        rating: 4,
        date: '3週間前',
        text: 'レベル分けがしっかりしていて、自分のペースで進められる。初回体験で雰囲気を確認できたのが良かった。',
      },
    ],
    price: '月4回 10,890円〜',
    trial: '体験レッスンあり',
    ...
    reviews: [
      {
        ...
        rating: 5,
        date: '2週間前',
        text: 'LAVA系列なので安心感がある。女性専用でマシンピラティスに特化しているのが嬉しい。',
      },
      {
        author: 'M.I',
        rating: 4,
        date: '1ヶ月前',
        text: 'ホットヨガのLAVAが運営しているので、LAVAの会員証と連携できて便利。',
      },
      {
        author: 'C.N',
        rating: 4,
        date: '3週間前',
        text: 'マシンが充実していて、インストラクターの指導も丁寧。女性専用で安心して通えます。',
      },
    ],
    price: 'お問い合わせください',
    trial: '体験レッスンあり',
    ...
    reviews: [
      {
        ...
        rating: 5,
        date: '1週間前',
        text: '予約不要で30分のレッスンが受けられるのが画期的。仕事帰りに気軽に立ち寄れます。',
      },
      {
        author: 'L.K',
        rating: 4,
        date: '2週間前',
        text: '月4回9,680円でサクッと30分。忙しい人にぴったり。予約なしで行けるのが本当に便利。',
      },
      {
        author: 'F.T',
        rating: 4,
        date: '1ヶ月前',
        text: '30分で終わるので続けやすい。予約不要だから空いた時間にふらっと行ける。',
      },
    ],
    price: '月4回 9,680円',
    trial: '体験レッスンあり',
    ...
    reviews: [
      {
        ...
        rating: 5,
        date: '1週間前',
        text: 'マンツーマン30分で月4回22,000円。パーソナルなのに30分でサクッと終わるのがいい。',
      },
      {
        author: 'P.N',
        rating: 5,
        date: '2週間前',
        text: 'ウェア・タオル・ドリンク・プロテインが無料なので手ぶらで通える。仕事帰りに便利。',
      },
      {
        author: 'G.Y',
        rating: 4,
        date: '3週間前',
        text: '30分パーソナルだから集中力が途切れず効果的。インストラクターが自分に合ったメニューを組んでくれる。',
      },
    ],
    price: '月4回 22,000円',
    trial: '体験レッスン 1,000円〜',
    ...
    reviews: [
      {
        ...
        rating: 5,
        date: '2週間前',
        text: '女性専用でヨガとピラティスの両方が受けられる。月4回7,700円〜はかなりお得。',
      },
      {
        author: 'B.S',
        rating: 4,
        date: '1ヶ月前',
        text: 'アットホームな雰囲気で初心者でも通いやすい。ヨガもピラティスも楽しめるのが嬉しい。',
      },
      {
        author: 'Q.M',
        rating: 4,
        date: '3週間前',
        text: '月4回7,700円〜と手頃な料金。少人数制で丁寧に教えてもらえます。',
      },
    ],
    price: '月4回 7,700円〜',
    trial: '体験レッスンあり',
  ...
  },
  {
    ...
    reviews: [
      {
        ...
        rating: 5,
        date: '1週間前',
        text: '丸ノ内線新中野駅すぐ。ヨガ・ピラティス・エアリアルと種類が豊富で飽きない。女性専用で安心。',
      },
      {
        author: 'U.O',
        rating: 4,
        date: '2週間前',
        text: 'エアリアルヨガも体験できるのが他にない魅力。ピラティスクラスも充実していて満足。',
      },
      {
        author: 'X.E',
        rating: 4,
        date: '1ヶ月前',
        text: '新中野駅から近くて通いやすい。いろいろなレッスンを試せるのが楽しい。',
      },
    ],
    price: 'お問い合わせください',
    trial: '体験レッスンあり',
    ...
    popularPlan: {
      name: 'レギュラープラン',
      description: 'ヨガ・ピラティス・エアリアルが受けられる。',
      price: 'お問い合わせください',
    },
    options: [
      'ヨガレッスン',
    ...
    userProfile: {
      ageRange: '20代〜40代が中心',
      genderRatio: '女性100%（女性専用）',
      purpose: ['リラックス', '体幹強化', '柔軟性向上', '新しい体験'],
    },
    basicInfo: {
      hours: 'お問い合わせください',
      closed: '不定休',
      facilities: ['マットスペース', 'エアリアル設備', 'ロッカー', '更衣室'],
    },
  },
  {
    name: 'CALDO 中野',
    ...
    reviews: [
      {
        ...
        rating: 5,
        date: '2週間前',
        text: 'ホットヨガがメインだけどピラティスクラスもある。月4回8,250円〜でホットヨガもピラティスも楽しめる。',
      },
      {
        author: 'O.L',
        rating: 4,
        date: '1ヶ月前',
        text: '施設がきれいで広い。ホットヨガの後にピラティスを受けると体がよく伸びる気がする。',
      },
      {
        author: 'Z.P',
        rating: 4,
        date: '3週間前',
        text: '予約不要のレッスンもあるので気軽に通える。大手だけあって設備が整っている。',
      },
    ],
    price: '月4回 8,250円〜',
    trial: '体験レッスンあり',
  ...
  },
  {
    ...
    reviews: [
      {
        ...
        rating: 4,
        date: '1週間前',
        text: '月額3,278円で24時間使えるのはコスパ最強。セルフマシンだけど動画を見ながらできるので初心者でも大丈夫。',
      },
      {
        author: 'N.E',
        rating: 4,
        date: '2週間前',
        text: '24時間いつでも行けるので、早朝や深夜でも通える。ピラティス以外のマシンも使えてお得。',
      },
      {
        author: 'K.W',
        rating: 3,
        date: '1ヶ月前',
        text: 'インストラクターはいないけど、この価格なら文句なし。自分のペースでやりたい人向け。',
      },
    ],
    price: '月額 3,278円',
    trial: '入会後すぐ利用可',
    ...
    userProfile: {
      ...
      purpose: ['運動習慣', 'ダイエット', 'コスパ重視', '時間の自由'],
    },
    basicInfo: {
      hours: '24時間',
      closed: '年中無休',
      facilities: ['セルフマシン', 'セルフエステ', 'ロッカー', '更衣室'],
    },
  },
]
