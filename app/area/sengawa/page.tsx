...
const studios = [
  {
    ...
    reviews: [
      ...
      { author: 'A.S', rating: 4, date: '3週間前', text: '仙川駅から近くてアクセス良好。男女共用なので夫婦で通っています。サーキット形式で空いた時間に行けるのが魅力。' },
    ],
    price: '月4回 8,580円〜',
    trial: '体験レッスンあり',
  ...
  },
  {
    ...
    reviews: [
      ...
      { author: 'R.I', rating: 4, date: '3週間前', text: '初心者向けのスタジオ。ミラーを使ったレッスンが他にないユニークなスタイルで楽しい。' },
    ],
    price: '月6回 11,000円',
    trial: '体験レッスン 2,200円',
  ...
  },
  {
    ...
    reviews: [
      ...
      { author: 'E.Y', rating: 4, date: '3週間前', text: 'インストラクターの質が高い。解剖学に基づいた指導で体の変化を実感できます。仙川駅から近い。' },
    ],
    price: '月4回 11,990円〜',
    trial: '体験レッスンあり',
  ...
  },
  {
    ...
    reviews: [
      ...
      { author: 'K.S', rating: 4, date: '3週間前', text: 'パーソナルトレーニングとマシンピラティスの両方が受けられるのが他にない魅力。' },
    ],
  ...
  },
  {
    ...
    reviews: [
      ...
      { author: 'A.M', rating: 4, date: '3週間前', text: '体験1,000円で気軽に試せました。レッスンの種類が豊富で飽きません。' },
    ],
    price: '月4回 13,200円〜',
    trial: '体験レッスン 1,000円',
