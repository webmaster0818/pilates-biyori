...
export const metadata = {
  title: '【2026最新】ピラティス元町おすすめ6選！人気スタジオの料金プランを簡単比較！｜Pilates-Biyori',
  description: '神戸元町エリアのおすすめピラティススタジオ6選を徹底比較。マシンピラティス、体験レッスン、料金相場、選び方まで完全ガイド。初心者でも安心して通えるスタジオが見つかります。',
    ...
    reviews: [
      {
        ...
        rating: 5,
        date: '1週間前',
        text: '元町からも通える三宮・花時計前駅徒歩1分の大手スタジオ。マット・マシン・プライベートと3タイプ選べます。全国150店舗以上で相互利用可能。',
      },
      {
        author: 'Y.I',
        rating: 5,
