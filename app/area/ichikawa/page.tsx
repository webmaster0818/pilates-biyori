...
export const metadata = {
  title: '【2026年最新】市川のピラティススタジオ｜料金・体験プラン比較｜Pilates-Biyori',
  description: '市川市/区のピラティススタジオを比較。公式サイトで確認した料金・体験プラン・住所を掲載。',
  keywords: 'ピラティス,市川,スタジオ,料金,体験レッスン',
}
  ...
  return (
    <>
      <BreadcrumbSchema items={[
        ...
        { name: '市川', url: 'https://biyori-pilates.com/area/ichikawa/' },
      ]} />
      <Navigation />
      <main className="max-w-4xl mx-auto px-4 py-10">
        ...
        <h1 className="text-3xl md:text-4xl font-bold mb-4">市川のピラティススタジオ</h1>
        ...
        <section className="mt-12 bg-gray-50 p-6 rounded-lg">
          <h2 className="text-2xl font-bold mb-4">市川でピラティススタジオを選ぶときのポイント</h2>
