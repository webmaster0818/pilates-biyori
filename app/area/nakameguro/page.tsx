...
export const metadata = {
  alternates: { canonical: 'https://biyori-pilates.com/area/nakameguro/' },
  title: '【2026年9月最新】中目黒のピラティス｜初心者OK・無料体験で選ぶ料金比較',
...
export default function NakameguroPage() {
  return (
    <>
      ...
      <ConsultantSection areaKey="nakameguro" areaName="中目黒" />
