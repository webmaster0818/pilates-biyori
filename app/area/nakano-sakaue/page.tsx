...
const studios = [
  {
    ...
    description: 'クラブピラティス（CLUB PILATES）は世界最大級のマシンピラティスブランド。中野坂上駅から徒歩2分。最大12名の少人数制で、リフォーマー・スプリングボード・TRX・チェアなど15種類のマシン・器具を完備。8つのプログラムと4段階のレベル分け。インストラクター全員が500時間以上の研修修了。',
        ...
        <section className="py-16 bg-warm-800 text-white" id="contact">
          <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
            ...
            >
              ...
              <AreaModifierSections studios={studios} areaName="中野坂上" />
      </main>
        {/* boost-nav-202606 */}
        <section className="py-12 bg-white">
          <div className="max-w-4xl mx-auto px-6 lg:px-8">
      ...
      <ConsultantSection areaKey="nakano-sakaue" areaName="中野坂上" />
            ...
            <div className="my-8 bg-white border border-warm-200 p-5">
              ...
              <div className="flex flex-wrap gap-2">
                <Link href="/brands/club-pilates-nakano-sakaue/" className="text-xs text-warm-800 border border-warm-300 bg-white px-3 py-1.5 hover:border-warm-500 transition-colors">CLUB PILATES 中野坂上店の料金・体験を見る</Link>
              </div>
            </div>
