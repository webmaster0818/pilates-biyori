...
export const metadata = {
  alternates: { canonical: 'https://biyori-pilates.com/area/sugamo/' },
  title: '【2026年9月最新】巣鴨のピラティス9社を比較｜無料体験4社・月額最安2,200円〜',
  description: '巣鴨エリアでおすすめのピラティススタジオを料金・無料体験・マシン対応で徹底比較。初心者向けの選び方、駅近スタジオ、体験レッスンの有無まで2026年6月の最新情報でわかります。',
...
const studios = [
  ...
  },
  {
    ...
    description: '女性専用のマシンピラティス専門スタジオ。レベル別・部位別の豊富なグループプログラムとパーソナルレッスンを提供し、洗練された空間が特徴。巣鴨駅から徒歩1分（情報引用元: the SILK公式サイト the-silk.co.jp）。',
    access: '巣鴨駅から徒歩1分',
  ...
  },
  {
    ...
    access: '巣鴨駅 徒歩5分',
    address: '〒170-0004 東京都豊島区北大塚１-２ ＭＡＮ巣鴨303',
    options: [
...
export default function SugamoAreaPage() {
  return (
    <>
      ...
      <ConsultantSection areaKey="sugamo" areaName="巣鴨" />
      ...
      <div className="my-8 bg-white border border-warm-200 p-5">
        ...
        <div className="flex flex-wrap gap-2">
          ...
          <Link href="/brands/the-silk-sugamo/" className="text-xs text-warm-800 border border-warm-300 bg-white px-3 py-1.5 hover:border-warm-500 transition-colors">the SILK 巣鴨店の料金・体験を見る</Link>
