...
export const metadata = {
  ...
  title: '【2026年9月最新】自由が丘のピラティス6社を比較｜無料体験3社・月額最安10,450円〜',
    ...
    <>
      ...
      <div className="my-8 bg-white border border-warm-200 p-5">
        ...
        <div className="flex flex-wrap gap-2">
          ...
          <Link href="/brands/the-silk-jiyugaoka/" className="text-xs text-warm-800 border border-warm-300 bg-white px-3 py-1.5 hover:border-warm-500 transition-colors">the SILK 自由が丘店の料金・体験を見る</Link>
