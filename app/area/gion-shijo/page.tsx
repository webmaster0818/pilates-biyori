...
export const metadata = {
  title: '【2026最新】ピラティス祇園四条おすすめ5選！人気スタジオの料金プランを簡単比較！｜Pilates-Biyori',
    ...
    reviews: [
      {
        ...
        rating: 5,
        date: '2週間前',
        text: '四条駅12番出口から徒歩1分！全国150以上のスタジオが相互利用可能。マット・マシン・プライベートすべて対応。体験当日入会で入会金無料でした。京都の中心で通いやすい。',
      },
      {
        author: 'Y.T',
        rating: 5,
