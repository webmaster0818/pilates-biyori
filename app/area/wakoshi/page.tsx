...
const studios = [
  ...
  },
  {
    ...
    address: '埼玉県和光市（詳細は��式サイトでご確認ください）',
    popularPlan: {
      name: '女性専用プラン',
      description: 'LAVA系列の女性専用マシンピラティス。和光市駅徒歩1分の好立地。体験無料キャンペーン中。',
      price: 'プレミアムプラン 月額10,978円（税込）',
  ...
  },
  {
    ...
    address: '埼��県和光市（���細は公式サイトでご確認ください）',
    popularPlan: {
      name: '女性専用プラン',
      description: '女性専用の完全個別パーソナルピラティス。一人ひとりの体に合わせたサポートで初心者〜経験者まで対応。',
      price: 'パーソナルレッスン（公式サイトで確認）',
  ...
  },
  {
    ...
    address: '東上線沿線各スタジオ（詳細は公式サイトでご確認くだ���い）',
    popularPlan: {
      name: '全国展開大手プラン',
      description: '全国130店舗以上の大手。東上線沿線のスタジオを利用可能。全店舗利用可能プランで柔軟に通えます。',
      price: '月4回 13,200円��',
...
const faqs = [
  ...
  { question: '和光市のピラティスの料金相場は？', answer: 'Rintosull 和光市店はプレミアムプラン 月額10,978円（税込）、ザバススポーツクラブ和光は月額8,000円〜（施設利用料込）、zen place pilates（東上線沿線）は月4回 13,200円��。目的と頻度に合わせて選びましょう。' },
  ...
  return (
    <>
      ...
      <main className="pt-20 bg-white">
        ...
        <TableOfContents areaName="和光市" studioNames={studios.map((s) => s.name)} />
        <section className="py-12 bg-white">
          <div className="max-w-4xl mx-auto px-6 lg:px-8">
            <p className="text-warm-600 leading-relaxed mb-6">こんにちは。</p><p className="text-warm-600 leading-relaxed mb-6">Pilates-Biyori編集部です！</p><p className="text-warm-600 leading-relaxed mb-6">あなたは、</p><p className="text-warm-600 leading-relaxed font-medium mb-6">「ピラティスを始めてみたい」</p><p className="text-warm-600 leading-relaxed mb-6">「和光市で人気のピラティススタジオを知���たい」</p><p className="text-warm-600 leading-relaxed mb-6">と思っていま��んか？</p>
            <p className="text-warm-600 leading-relaxed mb-8">和光市は東武東上線・東京メトロ有楽町線/副都心線が利用でき、池袋まで東武東上線で約15分、有楽町線で都心直結の好アクセスエリア。東武東上線と東���メトロ有楽町線・副都心線が乗り入れ、都心へのアクセス抜群。理化学研究所や国立保健医療科学院がある学術都市。そんな和光市エリアには、多彩なピラティススタジオが揃っています。</p>
            <p className="text-warm-600 leading-relaxed mb-8">そこでこの��事では、和光市エリアでおすすめの実在するピラティススタジオ5選をまとめました。</p>
            <div className="bg-warm-50 border-l-4 border-warm-400 p-6 mb-8"><h2 className="text-lg font-bold text-warm-900 mb-4">こんな人におすすめ</h2><ul className="space-y-2 text-warm-700"><li className="flex items-start"><span className="text-warm-400 mr-2">✓</span><span>和光市でピラティススタジオを探している</span></li><li className="flex items-start"><span className="text-warm-400 mr-2">✓</span><span>マシンピラティスを体験してみた��</span></li><li className="flex items-start"><span className="text-warm-400 mr-2">✓</span><span>コスパの良いスタジオを知りた��</span></li><li className="flex items-start"><span className="text-warm-400 mr-2">✓</span><span>東武東上線・東京メトロ有楽町線/副都心線沿線で通いやすいスタジオがいい</span></li><li className="flex items-start"><span className="text-warm-400 mr-2">✓</span><span>料金プランを比較したい</span></li></ul></div>
            <p className="text-warm-600 leading-relaxed">それではさっそく見ていきましょう！</p>
          </div>
        </section>
        <PriceComparisonTable studios={studios} areaName="和光市" />
        <section className="py-16 bg-warm-50" id="studios"><div className="max-w-6xl mx-auto px-6 lg:px-8"><h2 className="text-2xl md:text-3xl font-bold text-warm-900 mb-8 text-center">和光市のおすすめピラティススタジオ5選</h2><div className="space-y-8">{studios.map((studio, index) => (<StudioCard key={index} studio={studio} index={index} />))}</div></div></section>
        ...
        <section className="py-16 bg-warm-50" id="how-to-choose"><div className="max-w-4xl mx-auto px-6 lg:px-8"><h2 className="text-2xl md:text-3xl font-bold text-warm-900 mb-8 text-center">失敗しないスタジオの選び方</h2><div className="space-y-8">
          ...
          <div className="bg-white rounded-lg p-6 border border-warm-200"><div className="flex items-center mb-4"><span className="bg-warm-800 text-white w-8 h-8 rounded-full flex items-center justify-center font-bold mr-3">4</span><h3 className="text-xl font-bold text-warm-900">通いやすさを確認する</h3></div><p className="text-warm-600 leading-relaxed">和光市駅から徒歩圏内のスタジオが多数。通勤経路に合わせて選ぶと長続きし��す。</p></div>
        </div></div></section>
