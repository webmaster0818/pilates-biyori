...
export const metadata = {
  title: '【2026最新】ピラティス高松おすすめ5選！人気スタジオの料金プランを簡単比較！',
  description: '高松エリアのおすすめピラティススタジオ5選を徹底比較。マシンピラティス、体験レッスン、料金相場、選び方まで完全ガイド。初心者でも安心して通えるスタジオが見つかります。',
  ...
  return (
    <>
      ...
      <main className="pt-20 bg-white">
        ...
        <TableOfContents areaName="高松" studioNames={studios.map((s) => s.name)} />
