...
export const metadata = {
  title: '【2026年6月最新】ピラティス海老名おすすめ5選！料金・体験レッスン・マシン対応を比較！｜Pilates-Biyori',
  description: '海老名エリアのおすすめピラティススタジオ5選を徹底比較。マシンピラティス、体験レッスン、料金相場、選び方まで完全ガイド。初心者でも安心して通えるスタジオが見つかります。',
    ...
    reviews: [
      {
        ...
        rating: 5,
        date: '1週間前',
        text: 'ピラティス専門の大手スタジオ。マットもマシンも両方受けられるのが魅力。全国150店舗以上で相互利用可能で横浜のスタジオにも通える。',
      },
      {
        author: 'Y.K',
        rating: 4,
    ...
    <>
      ...
      <main className="pt-20 bg-white">
        ...
        <section className="bg-gradient-to-br from-warm-50 to-warm-100 py-12 md:py-16">
          <div className="max-w-4xl mx-auto px-6 lg:px-8">
            ...
            <h1 className="text-2xl md:text-3xl lg:text-4xl font-bold text-warm-900 mb-4">
              【2026最新】ピラティス海老名おすすめ5選！<br className="hidden md:block" />
              人気スタジオの料金プランを簡単比較！
            </h1>
          </div>
        </section>
        ...
        <section className="py-16 bg-white" id="price-market">
          <div className="max-w-4xl mx-auto px-6 lg:px-8">
            <h2 className="text-2xl md:text-3xl font-bold text-warm-900 mb-8 text-center">海老名のピラティス料金相場【2026年4月最新】</h2>
