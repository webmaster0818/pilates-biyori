...
export const metadata = {
  title: '【2026最新】ピラティス飯田橋・神楽坂おすすめ5選！人気スタジオの料金プランを簡単比較！｜Pilates Navi',
...
const studios = [
  {
    ...
    reviews: [
      { author: 'K.S', rating: 5, date: '1週間前', text: '飯田橋駅B4b出口から徒歩1分！マットもマシンも両方受けられるのが魅力。全国150店舗以上で相互利用できるので出張先でも通えます。' },
      { author: 'M.T', rating: 4, date: '2週間前', text: '男性もOKで夫婦で通っています。朝7時からレッスンがあり出勤前に一汗かけるのが嬉しい。インストラクターの質が高い。' },
      { author: 'A.Y', rating: 5, date: '3週間前', text: '体験3,300円で体験当日入会すると入会金33,000円が無料に。4路線使えるアクセスの良さが最高。' },
    ],
    ...
    options: ['月4回プラン（10,450円〜）', 'マシングループ体験（3,000円）', 'プライベートレッスン（体験 9,900円）', '体験当日入会で入会金33,000円→無料'],
  ...
  },
  {
    ...
    reviews: [
      ...
      { author: 'N.T', rating: 4, date: '2週間前', text: '朝7:30から夜21:00まで営業で通いやすい。女性専用なので安心して集中できます。初心者でも楽しめるプログラムが充実。' },
      { author: 'M.S', rating: 5, date: '3週間前', text: 'マシン専門スタジオなのでリフォーマーの台数が多く予約が取りやすい。月額プランの選択肢も多くて自分に合ったプランを選べます。' },
    ],
  ...
  },
  {
    ...
    reviews: [
      ...
      { author: 'H.M', rating: 5, date: '2週間前', text: '体験1,000円（通常12,000円）で試せました。カウンセリングが丁寧で、自分の体の癖や改善ポイントを詳しく教えてもらえます。' },
      { author: 'Y.A', rating: 4, date: '3週間前', text: '飯田橋B1出口から徒歩6分。パーソナル専門なので周りを気にせず集中できる。月3回29,700円と少し高めだが効果は抜群。' },
    ],
  ...
  },
  {
    ...
    reviews: [
      { author: 'C.N', rating: 5, date: '1週間前', text: '女性専用で音楽に合わせたリフォーマーレッスンが楽しい。手ぶらで体験できるのが嬉しい。内装がおしゃれでモチベーションが上がります。' },
      { author: 'A.K', rating: 5, date: '2週間前', text: '朝7:30から夜22:00まで営業で仕事前後に通える。体験者の8割がピラティス未経験者なので初心者でも安心。' },
      { author: 'R.S', rating: 4, date: '3週間前', text: '月3回12,980円〜と通いやすい料金。ウェア・タオル無料貸出やウォーターサーバーも完備で手ぶら通い可能。' },
    ],
...
const faqs = [
  { question: 'ピラティス初心者でも大丈夫ですか？', answer: '大丈夫です！飯田橋・神楽坂エリアのスタジオはほとんどが初心者歓迎。CLUB PILATESは4段階のレベル分け、the SILKは体験者の約8割がピラティス未経験者。' },
  { question: 'マットピラティスとマシンピラティスの違いは？', answer: 'マットは自重エクササイズ、マシンはリフォーマー等の専用マシンを使用。マシンは負荷調整しやすく初心者におすすめ。飯田橋エリアはマシン対応スタジオが充実。' },
  { question: '飯田橋・神楽坂エリアの料金相場は？', answer: 'グループ月4回で10,450円〜15,070円程度。zen placeが月4回10,450円〜。パーソナルはルルトが月3回29,700円〜。' },
  ...
  { question: '体験レッスンは何を持っていけばいいですか？', answer: '動きやすい服装と飲み物があればOK。the SILKは手ぶらで体験可能。CLUB PILATESは無料イントロクラスあり。' },
  { question: 'ピラティスとヨガの違いは何ですか？', answer: 'ピラティスは体幹強化・姿勢改善に特化。ヨガは柔軟性とリラックス重視。zen placeはヨガスタジオも運営しており、両方楽しめます。' },
  { question: '男性でも通えるスタジオはありますか？', answer: 'zen place飯田橋とCLUB PILATES神楽坂は男性も通えます。the SILKとRepilatesは女性専用です。' },
  { question: '理学療法士のレッスンを受けられるスタジオは？', answer: 'ルルトは理学療法士が監修・指導するパーソナルスタジオ。医学的根拠に基づいた指導で怪我予防やリハビリにも対応。満足できなければ全額返金保証付き。' },
  ...
  return (
    <>
      ...
      <main className="pt-20 bg-white">
        <section className="bg-gradient-to-br from-warm-50 to-warm-100 py-12 md:py-16"><div className="max-w-4xl mx-auto px-6 lg:px-8"><p className="text-warm-400 text-xs mb-2">更新日 @2026年04月08日</p><h1 className="text-2xl md:text-3xl lg:text-4xl font-bold text-warm-900 mb-4">【2026最新】ピラティス飯田橋・神楽坂おすすめ5選！<br className="hidden md:block" />人気スタジオの料金プランを簡単比較！</h1></div></section>
        <section className="bg-white py-3 border-b border-warm-100"><div className="max-w-6xl mx-auto px-6 lg:px-8"><nav className="text-sm text-warm-400"><Link href="/" className="hover:text-warm-800 transition">ホーム</Link>{' > '}<Link href="/area" className="hover:text-warm-800 transition">地域別</Link>{' > '}<span className="text-warm-600">飯田橋・神楽坂</span></nav></div></section>
        <section className="py-12 bg-white"><div className="max-w-4xl mx-auto px-6 lg:px-8"><p className="text-warm-600 leading-relaxed mb-6">こんにちは。</p><p className="text-warm-600 leading-relaxed mb-6">Pilates Navi編集部です！</p><p className="text-warm-600 leading-relaxed mb-6">あなたは、</p><p className="text-warm-600 leading-relaxed font-medium mb-6">「ピラティスを始めてみたい」</p><p className="text-warm-600 leading-relaxed mb-6">「飯田橋・神楽坂で人気のピラティススタジオを知りたい」</p><p className="text-warm-600 leading-relaxed mb-6">と思っていませんか？</p><p className="text-warm-600 leading-relaxed mb-8">そこでこの記事では、飯田橋・神楽坂エリアでおすすめのピラティススタジオ5選をまとめました。</p><div className="bg-warm-50 border-l-4 border-warm-400 p-6 mb-8"><h2 className="text-lg font-bold text-warm-900 mb-4">こんな人におすすめ</h2><ul className="space-y-2 text-warm-700"><li className="flex items-start"><span className="text-warm-400 mr-2">✓</span><span>飯田橋・神楽坂でピラティススタジオを探している</span></li><li className="flex items-start"><span className="text-warm-400 mr-2">✓</span><span>マシンピラティスを体験してみたい</span></li><li className="flex items-start"><span className="text-warm-400 mr-2">✓</span><span>無料体験や格安体験のスタジオを知りたい</span></li><li className="flex items-start"><span className="text-warm-400 mr-2">✓</span><span>駅近で通いやすいスタジオがいい</span></li><li className="flex items-start"><span className="text-warm-400 mr-2">✓</span><span>料金プランを比較したい</span></li></ul></div><p className="text-warm-600 leading-relaxed">それではさっそく見ていきましょう！</p></div></section>
        <section className="py-16 bg-warm-50" id="studios"><div className="max-w-6xl mx-auto px-6 lg:px-8"><h2 className="text-2xl md:text-3xl font-bold text-warm-900 mb-8 text-center">飯田橋・神楽坂のおすすめピラティススタジオ5選</h2><div className="space-y-8">{studios.map((studio, index) => (<StudioCard key={index} studio={studio} index={index} />))}</div></div></section>
        ...
        <section className="py-16 bg-warm-50"><div className="max-w-4xl mx-auto px-6 lg:px-8"><h2 className="text-2xl md:text-3xl font-bold text-warm-900 mb-6 text-center">まとめ</h2><p className="text-warm-600 leading-relaxed mb-6">今回は飯田橋・神楽坂エリアのおすすめピラティススタジオについてご紹介してきましたが、いかがでしたか？</p><p className="text-warm-600 leading-relaxed mb-6">この記事では飯田橋・神楽坂エリアにあるピラティススタジオから厳選したものだけを紹介しているので、ひとまず今回まとめた中から探すのもありだと思いますよ。</p><p className="text-warm-600 leading-relaxed mb-6">ぜひこの記事を参考に自分に合うピラティススタジオを見つけてくださいね。</p><p className="text-warm-700 font-medium text-center">あなたにぴったりのピラティススタジオが見つかることを願っています。</p></div></section>
