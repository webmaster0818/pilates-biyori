...
export const metadata = {
  title: '【2026最新】ピラティス飯田橋・神楽坂おすすめ6選！人気スタジオの料金プランを簡単比較！',
  description: '飯田橋・神楽坂エリアのおすすめピラティススタジオ6選を徹底比較。マシンピラティス、体験レッスン、料金相場、選び方まで完全ガイド。初心者でも安心して通えるスタジオが見つかります。',
  ...
  return (
    <>
      ...
      <main className="pt-20 bg-white">
        ...
        <TableOfContents areaName="飯田橋・神楽坂" studioNames={studios.map((s) => s.name)} />
