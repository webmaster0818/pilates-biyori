...
export const metadata = {
  alternates: { canonical: 'https://biyori-pilates.com/area/meidaimae/' },
  title: '【2026年7月最新】ピラティス明大前おすすめ5選！料金・体験レッスン・マシン対応を比較！',
    ...
    reviews: [
      {
        ...
        rating: 5,
        date: '2週間前',
        text: 'エデュケーターの質が高く、初心者でも丁寧に教えてもらえます。マットもマシンも両方受けられるのが嬉しい。',
      },
      {
        author: 'M.S',
        rating: 5,
...
export default function MeidaimaePage() {
  return (
    <>
      ...
      <ConsultantSection areaKey="meidaimae" areaName="明大前" />
