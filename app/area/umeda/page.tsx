...
export const metadata = {
  title: '【2026最新】ピラティス梅田おすすめ15選！人気スタジオの料金プランを簡単比較！｜Pilates Navi',
...
const studios = [
  ...
  {
    name: 'ピラティススタジオ B-line 梅田',
    image: '/images/pilates4.jpg',
    rating: 4.9,
    price: '1回 8,800円〜',
    trial: '体験レッスン 5,500円',
    features: ['完全プライベート', 'マシン完備', '梅田駅近', 'オーダーメイド'],
    description: '完全プライベートレッスン専門スタジオ。梅田駅から徒歩4分。一人ひとりの目的・体力に合わせたオーダーメイドレッスン。経験豊富なインストラクターがマンツーマンで指導するので、短期間で効果を実感できます。',
    access: '梅田駅から徒歩4分',
  },
  {
    name: 'Reformer Pilates Umeda',
    image: '/images/pilates2.jpg',
    rating: 4.7,
    price: '月4回 13,200円〜',
    trial: '体験レッスン 1,000円',
    features: ['リフォーマー専門', '少人数制', '梅田', '初心者歓迎'],
    description: 'リフォーマー専門のピラティススタジオ。梅田エリアに展開。少人数制で丁寧な指導が魅力。最新のリフォーマーマシンを使用した効果的なトレーニングで、姿勢改善やボディメイクを実現します。',
    access: '梅田駅から徒歩5分',
  },
  {
    name: 'Urban Pilates 梅田',
    image: '/images/pilates3.jpg',
    rating: 4.6,
    price: '月額 16,500円（通い放題）',
    trial: '体験レッスン 無料',
    features: ['24時間営業', '梅田駅近', '通い放題', 'マシン完備'],
    description: '24時間営業のピラティススタジオ。梅田駅から徒歩1分の好立地。早朝・深夜でも利用可能なので、忙しい方にも最適。月額定額で通い放題プランあり。最新マシンを完備し、自分のペースでトレーニングできます。',
    access: '梅田駅から徒歩1分',
  },
  {
    name: 'Pilates Studio M 梅田',
    image: '/images/pilates4.jpg',
    rating: 4.8,
    price: '月4回 12,980円〜',
    trial: '体験レッスン 1,000円',
    features: ['女性専用', '少人数制', '梅田', 'マット&マシン'],
    description: '女性専用・少人数制のアットホームなスタジオ。梅田エリアに展開。マットピラティスとマシンピラティスの両方に対応。インストラクターとの距離が近く、丁寧な指導を受けられるのが魅力。初心者でも安心して通えます。',
    access: '梅田駅から徒歩7分',
  },
  {
    name: 'BDC PILATES 梅田',
  ...
  {
    name: 'FLOW PILATES 梅田',
    image: '/images/pilates4.jpg',
    rating: 4.6,
    price: '月4回 13,200円〜',
    trial: '体験レッスン 1,000円',
    features: ['ヨガ×ピラティス', 'リラックス', '梅田', '初心者歓迎'],
    description: 'ヨガとピラティスの融合スタジオ。梅田エリアに展開。心と身体の両方を整えるプログラムが人気。ヨガの呼吸法とピラティスのコアトレーニングを組み合わせた独自メソッドで、柔軟性と筋力を同時に向上させます。',
    access: '梅田駅から徒歩4分',
  },
  {
    name: 'Body Make Studio Pilates+ 梅田',
    image: '/images/pilates2.jpg',
    rating: 4.7,
    price: '月4回 14,850円〜',
    trial: '体験レッスン 1,500円',
    features: ['ボディメイク特化', 'マシン完備', '梅田駅近', 'パーソナル'],
    description: 'ボディメイク特化型のピラティススタジオ。梅田駅から徒歩4分。ダイエットや引き締めに特化したプログラムが充実。最新マシンとパーソナルトレーニングで、短期間での理想のボディラインを目指せます。',
    access: '梅田駅から徒歩4分',
  },
  {
    name: 'Pilates Studio Harmony 梅田',
    image: '/images/pilates3.jpg',
    rating: 4.8,
    price: '月4回 12,100円〜',
    trial: '体験レッスン 無料',
    features: ['アットホーム', '少人数制', '梅田', 'マット中心'],
    description: 'アットホームな雰囲気の少人数制スタジオ。梅田エリアに展開。マットピラティスを中心に、初心者でも無理なく始められるプログラムを提供。インストラクターとの距離が近く、質問しやすい環境が魅力です。',
    access: '梅田駅から徒歩8分',
  },
  {
    name: 'Pilates & Wellness 梅田',
    image: '/images/pilates4.jpg',
    rating: 4.6,
    price: '月4回 13,750円〜',
    trial: '体験レッスン 1,000円',
    features: ['ウェルネス', 'マインドフルネス', '梅田駅近', '女性専用'],
    description: 'ウェルネス志向のピラティススタジオ。梅田駅から徒歩5分。ピラティスにマインドフルネスを取り入れた独自プログラム。大阪最大のターミナル・梅田で、ストレス解消や心身のバランスを整えられます。女性専用で安心。',
    access: '梅田駅から徒歩5分',
  },
]
