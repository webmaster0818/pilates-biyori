...
export const metadata = {
  ...
  title: '【2026年8月最新】表参道のピラティス｜初心者OK・無料体験で選ぶ料金比較',
      ...
      <ConsultantSection areaKey="omotesando" areaName="表参道" />
            ...
            <div className="my-8 bg-white border border-warm-200 p-5">
              ...
              <div className="flex flex-wrap gap-2">
                <Link href="/brands/bdc-omotesando/" className="text-xs text-warm-800 border border-warm-300 bg-white px-3 py-1.5 hover:border-warm-500 transition-colors">BDC PILATES 表参道スタジオの料金・体験を見る</Link>
              </div>
            </div>
