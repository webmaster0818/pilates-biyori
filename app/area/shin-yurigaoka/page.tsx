...
const studios = [
  ...
  {
    name: 'PERSONAL TRAINING STUDIO U 新���合ヶ丘',
    ...
    address: '神奈川県川崎市麻生区（詳細は公式サイトでご確認���ださい）',
    popularPlan: {
      name: 'パーソナル専門プラン',
      description: '新百合ヶ丘駅徒歩2分のパーソナルジム。ピラティス×トレーニングの複合プログラム。',
      price: 'パーソナルレッスン（公式サイトで確認）',
...
const faqs = [
  { question: 'ピラティス初心者でも大丈夫ですか？', answer: '大丈夫です！新百合ヶ丘エリアのスタジオは初心者歓迎がほとんど。zen place pilates 新百合ヶ��は全国展開大手で安心。まずは体験レッスンから始めてみましょう。' },
  ...
  { question: '新百合ヶ丘のピラティスの料金相場は？', answer: 'zen place pilates 新百合ヶ��は月4回 13,200円〜、pilates K 新百合ヶ丘店は月4回 11,220円〜、sincere pilates 新百合ヶ丘は1回約2,300円〜。目的と頻度に合わせて選びましょう。' },
  ...
  { question: '体験レッスンは何を持っていけばいいですか？', answer: '動きやすい服装と飲み物があればOK。zen place pilates 新百合ヶ��は体験レッスン 1,000円、pilates K 新百合ヶ丘店は体験レッスン 0円。' },
  { question: '男性でも通えるスタジオはありますか��', answer: 'zen place pilates 新百合ヶ��、sincere pilates 新百合ヶ丘、PERSONAL TRAINING STUDIO U 新���合ヶ丘は男性もOKです。は女性専用です。' },
  { question: '新百合ヶ丘駅からのアクセスは？', answer: '新百合ヶ丘駅は小田急小田原線・多摩線が利用でき、新宿まで小田急線快速急行で約25分。各スタジオとも駅から徒歩圏内でアクセス良好です��' },
  { question: 'パーソナルレッスンを受けたいのですが？', answer: 'PERSONAL TRAINING STUDIO U 新���合ヶ丘がパーソナルレッスンに対応しています。' },
  ...
  return (
    <>
      ...
      <main className="pt-20 bg-white">
        ...
        <TableOfContents areaName="新百合ヶ丘" studioNames={studios.map((s) => s.name)} />
        <section className="py-12 bg-white">
          <div className="max-w-4xl mx-auto px-6 lg:px-8">
            <p className="text-warm-600 leading-relaxed mb-6">こんにちは。</p><p className="text-warm-600 leading-relaxed mb-6">Pilates-Biyori編集部です！</p><p className="text-warm-600 leading-relaxed mb-6">あなたは、</p><p className="text-warm-600 leading-relaxed font-medium mb-6">「ピラティスを始めてみたい」</p><p className="text-warm-600 leading-relaxed mb-6">「新百合ヶ丘で人気のピラティススタジオを知���たい」</p><p className="text-warm-600 leading-relaxed mb-6">と思っていま��んか？</p>
            ...
            <p className="text-warm-600 leading-relaxed mb-8">そこでこの��事では、新百合ヶ丘エリアでおすすめの実在するピラティススタジオ5選をまとめました。</p>
            <div className="bg-warm-50 border-l-4 border-warm-400 p-6 mb-8"><h2 className="text-lg font-bold text-warm-900 mb-4">こんな人におすすめ</h2><ul className="space-y-2 text-warm-700"><li className="flex items-start"><span className="text-warm-400 mr-2">✓</span><span>新百合ヶ丘でピラティススタジオを探している</span></li><li className="flex items-start"><span className="text-warm-400 mr-2">✓</span><span>マシンピラティスを体験してみた��</span></li><li className="flex items-start"><span className="text-warm-400 mr-2">✓</span><span>コスパの良いスタジオを知りた��</span></li><li className="flex items-start"><span className="text-warm-400 mr-2">✓</span><span>小田急小田原線・多摩線沿線で通いやすいスタジオがいい</span></li><li className="flex items-start"><span className="text-warm-400 mr-2">✓</span><span>料金プランを比較したい</span></li></ul></div>
            <p className="text-warm-600 leading-relaxed">それではさっそく見ていきましょう！</p>
          </div>
        </section>
        <PriceComparisonTable studios={studios} areaName="新百合ヶ丘" />
        <section className="py-16 bg-warm-50" id="studios"><div className="max-w-6xl mx-auto px-6 lg:px-8"><h2 className="text-2xl md:text-3xl font-bold text-warm-900 mb-8 text-center">新百合ヶ丘のおすすめピラティススタジオ5選</h2><div className="space-y-8">{studios.map((studio, index) => (<StudioCard key={index} studio={studio} index={index} />))}</div></div></section>
        ...
        <section className="py-16 bg-white" id="kodawari"><div className="max-w-6xl mx-auto px-6 lg:px-8"><h2 className="text-2xl md:text-3xl font-bold text-warm-900 mb-8 text-center">目的別おすすめスタジオ</h2><div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="border border-warm-200 rounded-lg p-6 hover:shadow-lg transition"><h3 className="text-xl font-bold text-warm-900 mb-4">パーソナル重視</h3><p className="text-warm-600 text-sm mb-4">マンツーマンで丁寧な指導。</p><ul className="space-y-2 text-sm"><li className="text-warm-700">• PERSONAL TRAINING STUDIO U 新���合ヶ丘</li></ul></div>
        ...
        <section className="py-16 bg-warm-50" id="how-to-choose"><div className="max-w-4xl mx-auto px-6 lg:px-8"><h2 className="text-2xl md:text-3xl font-bold text-warm-900 mb-8 text-center">失敗しないスタジオの選び方</h2><div className="space-y-8">
          ...
          <div className="bg-white rounded-lg p-6 border border-warm-200"><div className="flex items-center mb-4"><span className="bg-warm-800 text-white w-8 h-8 rounded-full flex items-center justify-center font-bold mr-3">4</span><h3 className="text-xl font-bold text-warm-900">通いやすさを確認する</h3></div><p className="text-warm-600 leading-relaxed">新百合ヶ丘駅から徒歩圏内のスタジオが多数。通勤経路に合わせて選ぶと長続きし��す。</p></div>
        </div></div></section>
