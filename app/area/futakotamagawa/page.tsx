...
export const metadata = {
  ...
  title: '【2026年9月最新】二子玉川のピラティス6社を比較｜無料体験3社・月額最安10,450円〜',
  ...
  return (
    <>
      ...
      <main className="pt-20 bg-white">
        ...
        <AreaConclusion studios={studios} areaName="二子玉川" />
        ...
        <section className="py-16 bg-warm-800 text-white" id="contact">
          <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
            ...
            >
              ...
              <AreaModifierSections studios={studios} areaName="二子玉川" />
      </main>
        {/* boost-nav-202606 */}
        <section className="py-12 bg-white">
          <div className="max-w-4xl mx-auto px-6 lg:px-8">
      ...
      <ConsultantSection areaKey="futakotamagawa" areaName="二子玉川" />
            ...
            <div className="my-8 bg-white border border-warm-200 p-5">
              ...
              <div className="flex flex-wrap gap-2">
                <Link href="/brands/bdc-futakotamagawa/" className="text-xs text-warm-800 border border-warm-300 bg-white px-3 py-1.5 hover:border-warm-500 transition-colors">BDC PILATES 二子玉川の料金・体験を見る</Link>
              </div>
            </div>
      {/* g1-link-202609 */}
      <div className="my-8 bg-white border border-warm-200 p-5">
        ...
        <p className="text-sm text-warm-700 font-light leading-relaxed mb-3">このエリアの店舗別に料金・体験レッスン・アクセスを整理した詳細ページがあります。</p>
        <div className="flex flex-wrap gap-2">
          <Link href="/brands/the-silk-futakotamagawa/" className="text-xs text-warm-800 border border-warm-300 bg-white px-3 py-1.5 hover:border-warm-500 transition-colors">the SILK 二子玉川店の料金・体験を見る</Link>
        </div>
      </div>
