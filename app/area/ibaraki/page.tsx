...
export const metadata = {
  ...
  title: '【2026年9月最新】ピラティス茨木おすすめ7選！料金・体験レッスン・マシン対応を比較！',
...
const studios = [
  ...
  },
  {
    ...
    description: '完全個室・マンツーマンの女性専用パーソナルピラティススタジオ。入会金不要の月謝制で、一人ひとりに合わせたオリジナルプログラムを提供。茨木市駅から徒歩2分。※一部のご案内やサポート対応は、男性スタッフが行う場合がございます。※24/7Workout併設店舗のため、パーソナルトレーニングの男性会員様がご来店される場合もございます。',
    access: '茨木市駅から徒歩2分',
      ...
      <ConsultantSection areaKey="ibaraki" areaName="茨木" />
            ...
            <div className="my-8 bg-white border border-warm-200 p-5">
              ...
              <div className="flex flex-wrap gap-2">
                <Link href="/brands/rintosull-ibaraki/" className="text-xs text-warm-800 border border-warm-300 bg-white px-3 py-1.5 hover:border-warm-500 transition-colors">Rintosull（リントスル）茨木店の料金・体験を見る</Link>
              </div>
            </div>
