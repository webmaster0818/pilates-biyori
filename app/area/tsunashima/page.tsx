...
const studios = [
  {
    ...
    reviews: [
      ...
      { author: 'K.N', rating: 4, date: '3週��前', text: '全店舗利用可能プランで東横線沿線の別店舗にも通えて便利。体験1,000円で気軽に試せました。' },
    ],
    ...
    options: ['マットグループレッスン', 'マシングループレッスン', 'プ���イベートレッスン（1回 9,900円〜）', '全店舗利用可能プランあり'],
  ...
  },
  {
    ...
    price: '月4回 11,220���〜', trial: '体験レッスン 0円',
    features: ['女性専用', 'マシンピラティス専門', '体験0円', '駅近'],
    description: '女性専用マシンピラティス専門スタジオ。「30歳からの本気ボディ��イク」をコンセプトに、1人1台��リフォーマーで音楽に合わせてトレーニング。体験0円で気軽にスタート。月4回11,220円〜。',
    access: '東急東横線「綱島駅」から徒歩圏内',
    address: '神奈川県横浜市港北区綱島西（詳細は公式サイトでご確認ください）',
    popularPlan: { name: 'マンスリー4メンバー', description: '女性専用マシンピラティス。月4回で無理なく続けられるプラ���。', price: '月4回 11,220円〜（税���）' },
    options: ['マンスリー4メンバー（月4回 11,220��〜）', 'マンスリー8メンバー', 'マンスリーフルメンバー（通い放題）', '体験レッスン 0円'],
    userProfile: { ageRange: '20代〜40代が中心', genderRatio: '女性100%（女性専用）', purpose: ['ボディメ��ク', 'ダイエット', '姿勢改善', 'ヒップアップ'] },
  ...
  },
  {
    ...
    price: 'レッスン料は公式サイトでご確認く���さい', trial: '体験レッスンあり',
    features: ['駅徒歩30秒', 'ピラティス×ウェイト', 'AI姿勢分析', '全員有資格者'],
    description: '綱島駅から徒歩30秒の好立地。ピラティス×ウェイトトレーニングの複合プログラムが特徴。リフォーマー・キャデラック・チェアなど多彩なマシン完備。全員有資格のインストラクターとAI姿���分析で科学的にボディメイク。',
    access: '東急東横線��綱島駅」から徒歩30秒',
    address: '神奈川��横浜市港北区綱島西（詳細は公式サイトでご確認く���さい）',
    popularPlan: { name: '複合プログラム', description: 'ピラティス×ウェイトの複合型。AI姿勢分析付き。', price: '公式サイトでご���認ください' },
    ...
    basicInfo: { hours: '公式サイトでご確認��ださい', closed: '不定休', facilities: ['��フォーマー', 'キャデラック', 'チェア', '更衣室', '���ッカー'] },
  },
  {
    name: 'STUDIO TT 綱島店',
    image: '/images/studios/zen-place-pilates.webp',
    ...
    reviews: [
      ...
      { author: 'C.T', rating: 4, date: '2週���前', text: 'アットホームな雰囲気で初心者にも通いやすいスタジオ。インストラクターが丁寧に教えてくれます。' },
      { author: 'M.I', rating: 4, date: '3週間���', text: '少人数制のレッスンでしっかり見てもらえます。綱島駅からのアクセスも良好。' },
    ],
    price: 'レッスン料は公式サイトでご確認ください', trial: '体験レッスン 1,100円',
    features: ['木目調の落ち着く空間', '体験1,100円', '少人数制', 'アットホーム'],
    description: '木目調の落ち着いた雰囲気のピラティススタジオ。少人数制のレッスンで一人ひとりに合わせた丁寧な指導が特徴。体験レッス��1,100円でリーズナブルに試せます。アットホームな空間で初心者も安心。',
    access: '東急東横線「綱島駅」から徒歩圏内',
    address: '神奈川県横浜市港北区綱島（詳細は公式サイトでご確認く���さい）',
    popularPlan: { name: 'グループレッスン', description: '少人数制の落ち着いた空間でレッスン。', price: '公式サイ���でご確認ください' },
    options: ['グループレッスン', 'プライベートレッスン', '体験レッスン 1,100円'],
    userProfile: { ageRange: '30代〜50代が��心', genderRatio: '��性85% / 男性15%', purpose: ['健康維持', '姿勢改善', 'リフレッシュ', '体幹強化'] },
    basicInfo: { hours: '公式サイ��でご確認ください', closed: '不定休', facilities: ['マシン', '更衣室', 'ロッカー'] },
  },
  {
    ...
    reviews: [
      ...
      { author: 'N.M', rating: 4, date: '3週��前', text: 'プレミアムプランでLAVAのヨガも利用可能。ピラティスとヨガ両方楽しめるのがお得。' },
    ],
    price: 'プレミアム��ラン 月額10,978円（税込）', trial: '体験無料キ���ンペーン実施中',
    features: ['女性専用', 'マシンピラティス', '体験無料', 'LAVA系列'],
    description: 'ホットヨガLAVA系列の女性専用マシンピラティススタジオ。東横線沿線の店舗を利用可能。リフォーマーを使ったレッスンで効率よくボディメイク。体験無料キャンペーン実施中。プレミアムフリーフルタイムプランならLAVA等系列店も���用可能。',
    access: '東急東横線沿線の店舗を利用可能',
    address: '東急東横線沿線各店舗（詳細は公式サイトでご確認ください）',
    popularPlan: { name: 'プレミ��ムプラン', description: '女性専用マシンピラティス。LAVA系列店も利用可能。', price: '月額 10,978円（税込）' },
    options: ['プレミアムプラン（月額 10,978円/税込）', 'プレミアムフリーフルタイム（LAVA等全店利用可）', '体験無料���ャンペーン実施中'],
    userProfile: { ageRange: '20代〜40��が中心', genderRatio: '女性100%���女性専用）', purpose: ['ボディメイ��', 'ダイエット', 'ヨガ&ピラティス両方', '健康維持'] },
    basicInfo: { hours: '���式サイトでご確認ください', closed: '不定休', facilities: ['���フォーマーマシン', '更衣室', 'ロッカー', 'シャワー'] },
  },
]
...
const faqs = [
  ...
  { question: '綱島のピラティスの料金相場は？', answer: 'Rintosullは月額10,978円、pilates Kは月4回11,220円〜、zen placeは月4回13,200円〜。STUDIO TTは体験1,100円。東横線沿線ではリーズナブルな水準で��。' },
  { question: 'どのくらいの頻度で通えばいい��すか？', answer: '初心者は週1〜2回がおすすめ。pilates K綱島店のフルメンバー（通い放題）なら毎日でも。最低2〜3ヶ月は継続しましょう。' },
  ...
  return (
    <>
      ...
      <main className="pt-20 bg-white">
        ...
        <TableOfContents areaName="綱島" studioNames={studios.map((s) => s.name)} />
        <section className="py-12 bg-white">
          <div className="max-w-4xl mx-auto px-6 lg:px-8">
            ...
            <p className="text-warm-600 leading-relaxed mb-8">綱島は東急東横線の急行停車駅で、���谷まで約25分・横浜まで約15分という好アクセスの街。近年は新綱島駅の開業もあり、再開発が進む注目エリアです。温泉が湧く「綱島温泉」で知られる歴史ある街でもあります。そんな綱島には、駅徒歩30秒のFlexFitから大手zen placeまで、充実したスタジオが揃っています。</p>
            <p className="text-warm-600 leading-relaxed mb-8">そこでこの記事では、綱島エリアでおすすめの実在するピラティススタジオ5選をまとめました。</p>
            <div className="bg-warm-50 border-l-4 border-warm-400 p-6 mb-8"><h2 className="text-lg font-bold text-warm-900 mb-4">こんな人におす���め</h2><ul className="space-y-2 text-warm-700"><li className="flex items-start"><span className="text-warm-400 mr-2">✓</span><span>綱島でピラティススタジ��を探している</span></li><li className="flex items-start"><span className="text-warm-400 mr-2">✓</span><span>駅近で通いやすいスタジオがいい</span></li><li className="flex items-start"><span className="text-warm-400 mr-2">✓</span><span>ピラティス×トレーニングの複合プログラムに興味がある</span></li><li className="flex items-start"><span className="text-warm-400 mr-2">✓</span><span>東横線沿線で比較したい</span></li><li className="flex items-start"><span className="text-warm-400 mr-2">✓</span><span>料金プランを比較したい</span></li></ul></div>
            <p className="text-warm-600 leading-relaxed">それではさっそく見ていきましょう！</p>
          </div>
        </section>
        <PriceComparisonTable studios={studios} areaName="綱島" />
        <section className="py-16 bg-warm-50" id="studios"><div className="max-w-6xl mx-auto px-6 lg:px-8"><h2 className="text-2xl md:text-3xl font-bold text-warm-900 mb-8 text-center">綱島のおすすめピラティススタジオ5選</h2><div className="space-y-8">{studios.map((studio, index) => (<StudioCard key={index} studio={studio} index={index} />))}</div></div></section>

        <section className="py-16 bg-white" id="price-market"><div className="max-w-4xl mx-auto px-6 lg:px-8"><h2 className="text-2xl md:text-3xl font-bold text-warm-900 mb-8 text-center">綱島のピラティス料金相場【2026年4月最新】</h2><div className="overflow-x-auto"><table className="w-full text-sm border-collapse"><thead><tr className="bg-warm-800 text-white"><th className="px-4 py-3 text-left">種別</th><th className="px-4 py-3 text-left">料金相場</th></tr></thead><tbody><tr className="border-b border-warm-200"><td className="px-4 py-3 font-medium">グループレッスン（月4回）</td><td className="px-4 py-3">10,978円〜13,200円</td></tr><tr className="border-b border-warm-200 bg-warm-50"><td className="px-4 py-3 font-medium">パーソナルレ��スン</td><td className="px-4 py-3">1回 9,900円〜</td></tr><tr className="border-b border-warm-200"><td className="px-4 py-3 font-medium">体験レッスン</td><td className="px-4 py-3">無料〜1,100円</td></tr></tbody></table></div><p className="text-warm-600 mt-4 text-sm leading-relaxed">綱島エリアは再開発に伴い新しいスタジオが増加中。FlexFitのピラティス×ウェイト複合型やAI姿勢分析など、最先端のプログラムが充実しています。近隣の<Link href="/area/hiyoshi" className="text-warm-700 underline hover:text-warm-900">日吉</Link>エリアと合わせて検討するのもおすすめです。</p></div></section>

        <section className="py-16 bg-warm-50" id="cautions"><div className="max-w-4xl mx-auto px-6 lg:px-8"><h2 className="text-2xl md:text-3xl font-bold text-warm-900 mb-8 text-center">綱島でスタジオ��選ぶ際の注意点</h2><div className="space-y-6">
        ...
        <section className="py-16 bg-warm-50" id="how-to-choose"><div className="max-w-4xl mx-auto px-6 lg:px-8"><h2 className="text-2xl md:text-3xl font-bold text-warm-900 mb-8 text-center">失敗しないスタジオの選び方</h2><div className="space-y-8">
          <div className="bg-white rounded-lg p-6 border border-warm-200"><div className="flex items-center mb-4"><span className="bg-warm-800 text-white w-8 h-8 rounded-full flex items-center justify-center font-bold mr-3">1</span><h3 className="text-xl font-bold text-warm-900">目的を���確にする</h3></div><p className="text-warm-600 leading-relaxed">ボディメイクならFlexFit、本格ピラティスならzen place、コスパならRintosull。</p></div>
          <div className="bg-white rounded-lg p-6 border border-warm-200"><div className="flex items-center mb-4"><span className="bg-warm-800 text-white w-8 h-8 rounded-full flex items-center justify-center font-bold mr-3">2</span><h3 className="text-xl font-bold text-warm-900">レッスン形式を��ぶ</h3></div><p className="text-warm-600 leading-relaxed">グループ（pilates K・Rintosull）、複合型（FlexFit）、本格派（zen place）。好みで選びましょう。</p></div>
