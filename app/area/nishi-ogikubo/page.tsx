...
export const metadata = {
  alternates: { canonical: 'https://biyori-pilates.com/area/nishi-ogikubo/' },
  title: '【2026年8月最新】西荻窪のピラティス｜初心者OK・無料体験で選ぶ料金比較',
  description: '西荻窪エリアでおすすめのピラティススタジオを料金・無料体験・マシン対応で徹底比較。初心者向けの選び方、駅近スタジオ、体験レッスンの有無まで2026年6月の最新情報でわかります。',
...
const studios = [
    ...
    reviews: [
      {
        ...
        rating: 5,
        date: '1週間前',
        text: '西荻窪から中央線で2駅の阿佐ヶ谷駅。全国150店舗他店利用できるので、中央線沿線のスタジオを自由に選べます。',
      },
      {
        author: 'T.M',
        rating: 4,
  ...
  },
  {
    ...
    description: '女性専用のマシンピラティス専門スタジオ。1セッション最大3名のセミパーソナル形式で、グループより手厚くパーソナルより通いやすい価格帯が特徴。西荻窪駅から徒歩2分。',
    access: '西荻窪駅から徒歩2分',
    address: '東京都杉並区西荻北2丁目3-1 シンセンビル201',
  },
]
