...
export const metadata = {
  ...
  title: '【2026年8月最新】ピラティス横浜おすすめ11選！人気スタジオの料金プランを簡単比較！',
    ...
    reviews: [
      {
        ...
        rating: 5,
        date: '2週間前',
        text: '横浜駅から徒歩4分で通いやすいです。全国150以上のスタジオが他店利用できるので出張先でも通えます。エデュケーターの質が高く、体の変化を実感できました。',
      },
      {
        author: 'M.T',
        rating: 5,
    ...
    reviews: [
      {
        ...
        rating: 5,
        date: '1週間前',
        text: 'マット&マシンコンボプランがお得！両方のレッスンを受けられるので飽きません。エデュケーターさんが丁寧で、体の使い方がよくわかります。',
      },
      {
        author: 'K.H',
        rating: 4,
