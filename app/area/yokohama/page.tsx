...
export const metadata = {
  ...
  title: '【2026年9月最新】ピラティス横浜おすすめ11選！人気スタジオの料金プランを簡単比較！',
...
const studios = [
  ...
  },
  {
    ...
    description: '女性専用のマシンピラティス専門スタジオ。レベル別・部位別の豊富なグループプログラムとパーソナルレッスンを提供し、洗練された空間が特徴。横浜駅から徒歩3分（情報引用元: the SILK公式サイト the-silk.co.jp）。',
    access: '横浜駅から徒歩3分',
  ...
  },
  {
    ...
    access: '横浜駅 徒歩5分',
    address: '〒221-0834 神奈川県横浜市神奈川区台町9-13 ルックハイツ横浜台町 502',
    options: [
  ...
  return (
    <>
      ...
      <BreadcrumbSchema items={[
        ...
        { name: '横浜', url: 'https://pilates-biyori.com/area/yokohama/' },
      ]} />
      ...
      <main className="pt-20 bg-white">
        ...
        <TableOfContents areaName="横浜" studioNames={[...studios].sort((a,b)=>(((b as any).officialUrl||'').includes('felmat')?1:0)-(((a as any).officialUrl||'').includes('felmat')?1:0)).map((s) => s.name)} />
      ...
      <ConsultantSection areaKey="yokohama" areaName="横浜" />
      ...
      <div className="my-8 bg-white border border-warm-200 p-5">
        ...
        <div className="flex flex-wrap gap-2">
          ...
          <Link href="/brands/the-silk-yokohama/" className="text-xs text-warm-800 border border-warm-300 bg-white px-3 py-1.5 hover:border-warm-500 transition-colors">the SILK 横浜店の料金・体験を見る</Link>
      ...
      <div className="my-8 bg-white border border-warm-200 p-5">
        ...
        <div className="flex flex-wrap gap-2">
          ...
          <Link href="/brands/the-silk-yokohama-personal/" className="text-xs text-warm-800 border border-warm-300 bg-white px-3 py-1.5 hover:border-warm-500 transition-colors">the SILK 横浜パーソナル店の料金・体験を見る</Link>
