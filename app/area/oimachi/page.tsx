...
export const metadata = {
  ...
  title: '【2026年9月最新】大井町のピラティス｜初心者OK・無料体験で選ぶ料金比較',
...
const studios = [
  ...
  },
  {
    ...
    description: '1インストラクターにつき最大3名のセミパーソナル方式のマシンピラティススタジオ。1回あたり1,250円（※37,500円の通い放題コースで30日通った場合）〜と手頃な価格でリフォーマーを使った本格レッスンを受けられる。グループより丁寧、パーソナルより手頃な価格帯。',
    access: '大井町駅 徒歩2分',
    address: '〒140-0014 東京都品川区大井1丁目11−6 寺崎ビル 6階',
    popularPlan: {
      name: 'セミパーソナルプラン',
      ...
      <ConsultantSection areaKey="oimachi" areaName="大井町" />
            ...
            <div className="my-8 bg-white border border-warm-200 p-5">
              ...
              <div className="flex flex-wrap gap-2">
                <Link href="/brands/rintosull-oimachi/" className="text-xs text-warm-800 border border-warm-300 bg-white px-3 py-1.5 hover:border-warm-500 transition-colors">Rintosull 大井町店の料金・体験を見る</Link>
                <Link href="/brands/pilates-mee-oimachi/" className="text-xs text-warm-800 border border-warm-300 bg-white px-3 py-1.5 hover:border-warm-500 transition-colors">Pilates Mee大井町店の料金・体験を見る</Link>
              </div>
            </div>
