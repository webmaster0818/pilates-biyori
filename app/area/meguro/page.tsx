...
export const metadata = {
  ...
  title: '【2026年9月最新】目黒のピラティス7社を比較｜無料体験3社・月額最安10,450円〜',
  ...
  return (
    <>
      ...
      <main className="pt-20 bg-white">
        ...
        <AreaConclusion studios={studios} areaName="目黒" />
        ...
        <AreaMarketComparison studios={studios} areaName="目黒" />
        ...
        <section className="py-16 bg-warm-800 text-white" id="contact">
          <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
            ...
            >
              ...
              <AreaModifierSections studios={studios} areaName="目黒" />
      </main>
        {/* boost-nav-202606 */}
        <section className="py-12 bg-white">
          <div className="max-w-4xl mx-auto px-6 lg:px-8">
      ...
      <div className="my-8 bg-white border border-warm-200 p-5">
        ...
        <div className="flex flex-wrap gap-2">
          ...
          <Link href="/brands/the-silk-meguro/" className="text-xs text-warm-800 border border-warm-300 bg-white px-3 py-1.5 hover:border-warm-500 transition-colors">the SILK 目黒店の料金・体験を見る</Link>
