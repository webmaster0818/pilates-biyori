...
const studios = [
  {
    ...
    description: '最大3名までのセミパーソナル形式マシンピラティススタジオ。新大阪駅から徒歩7分、西中島南方駅から徒歩6分。定額制で1回あたり1,250円（※37,500円の通い放題コースで30日通った場合）〜と圧倒的なコスパ。当日予約・当日キャンセルOKでチケット持ち越しも可能。',
    access: '新大阪駅 徒歩7分／西中島南方駅 徒歩6分／南方駅 徒歩8分',
    address: '〒532-0011 大阪府大阪市淀川区西中島６丁目９−２０ 新大阪GHビル3階 303号室',
    popularPlan: {
      name: '月4回コース',
        ...
        <section className="py-16 bg-warm-800 text-white" id="contact">
          <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
            ...
            >
              ...
              <AreaModifierSections studios={studios} areaName="新大阪" />
      </main>
