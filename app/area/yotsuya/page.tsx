...
export const metadata = {
  title: '【2026最新】ピラティス四ツ谷おすすめ4選！人気スタジオの料金プランを簡単比較！｜Pilates Navi',
...
const studios = [
  {
    ...
    reviewCount: 95,
    reviews: [
      { author: 'S.K', rating: 5, date: '2週間前', text: '四谷三丁目駅から近くて便利。完全パーソナルなので自分のペースで集中してレッスンを受けられます。1回6,250円〜はパーソナルとしてはリーズナブル。' },
      { author: 'Y.T', rating: 5, date: '1ヶ月前', text: 'オーダーメイドのプログラムで、自分の身体の課題にしっかり向き合えます。姿勢が改善されてきたと実感。' },
      { author: 'K.H', rating: 4, date: '3週間前', text: '体験レッスンで丁寧にカウンセリングしてもらえました。インストラクターの知識が豊富で信頼できます。' },
    ],
    price: '1回 6,250円〜',
    trial: '体験レッスンあり',
  ...
  },
  {
    ...
    reviewCount: 70,
    reviews: [
      { author: 'R.N', rating: 5, date: '1週間前', text: 'マシンとマット両方に対応しているのが嬉しい。30分5,000円の都度払いで気軽に通えます。' },
      { author: 'A.H', rating: 4, date: '2週間前', text: '四谷エリアでマシンピラティスが受けられる貴重なスタジオ。丁寧な指導で初心者でも安心です。' },
      { author: 'M.M', rating: 5, date: '3週間前', text: '都度払いなので、自分のペースで通えるのが良い。予定が不規則な方にもおすすめ。' },
    ],
    price: '30分 5,000円〜',
    trial: '体験レッスンあり',
    ...
    popularPlan: { name: '都度払いプラン', description: 'マシン&マットピラティス。30分から利用可能。', price: '30分 5,000円（税込）〜' },
    options: ['30分プラン（5,000円〜）', '60分プラン（お問い合わせ）', '体験レッスン（お問い合わせ）'],
    userProfile: { ageRange: '20代〜50代', genderRatio: '女性85% / 男性15%', purpose: ['姿勢改善', 'ボディメイク', '短時間トレーニング', '都度利用'] },
    basicInfo: { hours: 'お問い合わせください', closed: '不定休', facilities: ['リフォーマー', 'マット'] },
  },
  {
...
const faqs = [
  { question: 'ピラティス初心者でも大丈夫ですか？', answer: '大丈夫です！四ツ谷エリアのピラティススタジオは初心者歓迎のスタジオがほとんど。経験豊富なインストラクターが基礎から丁寧に指導してくれます。' },
  { question: 'マットピラティスとマシンピラティスの違いは？', answer: 'マットは自重エクササイズ、マシンは専用マシン（リフォーマーなど）を使ったトレーニング。マシンは初心者におすすめです。' },
  { question: '四ツ谷エリアの料金相場は？', answer: 'パーソナルレッスン1回5,000円〜8,800円程度。グループは月4回10,000円〜15,000円が相場です。' },
      ...
      <main className="pt-20 bg-white">
        <section className="bg-gradient-to-br from-warm-50 to-warm-100 py-12 md:py-16">
          <div className="max-w-4xl mx-auto px-6 lg:px-8">
            ...
            <h1 className="text-2xl md:text-3xl lg:text-4xl font-bold text-warm-900 mb-4">【2026最新】ピラティス四ツ谷おすすめ4選！<br className="hidden md:block" />人気スタジオの料金プランを簡単比較！</h1>
          </div>
        </section>
        <section className="bg-white py-3 border-b border-warm-100">
          <div className="max-w-6xl mx-auto px-6 lg:px-8"><nav className="text-sm text-warm-400"><Link href="/" className="hover:text-warm-800 transition">ホーム</Link>{' > '}<Link href="/area" className="hover:text-warm-800 transition">地域別</Link>{' > '}<span className="text-warm-600">四ツ谷</span></nav></div>
        </section>
        <section className="py-12 bg-white">
          <div className="max-w-4xl mx-auto px-6 lg:px-8">
            ...
            <p className="text-warm-600 leading-relaxed font-medium mb-6">「四ツ谷周辺でピラティスを始めたい」</p>
            <p className="text-warm-600 leading-relaxed mb-6">「パーソナルで丁寧に指導してもらえるスタジオを知りたい」</p>
            <p className="text-warm-600 leading-relaxed mb-6">と思っていませんか？</p>
            <p className="text-warm-600 leading-relaxed mb-8">そこでこの記事では、四ツ谷エリアから通えるおすすめのピラティススタジオ4選をまとめました。</p>
            <div className="bg-warm-50 border-l-4 border-warm-400 p-6 mb-8">
              <h2 className="text-lg font-bold text-warm-900 mb-4">こんな人におすすめ</h2>
              <ul className="space-y-2 text-warm-700">
                <li className="flex items-start"><span className="text-warm-400 mr-2">✓</span><span>四ツ谷・四谷三丁目でピラティススタジオを探している</span></li>
        ...
        <section className="py-16 bg-warm-50" id="studios">
          <div className="max-w-6xl mx-auto px-6 lg:px-8">
            <h2 className="text-2xl md:text-3xl font-bold text-warm-900 mb-8 text-center">四ツ谷エリアのおすすめピラティススタジオ4選</h2>
          ...
          <div className="max-w-6xl mx-auto px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="border border-warm-200 rounded-lg p-6 hover:shadow-lg transition">
                ...
                <p className="text-warm-600 text-sm mb-4">グループレッスンで気軽に始めたい方に。</p>
                <ul className="space-y-2 text-sm">
              ...
              <div className="border border-warm-200 rounded-lg p-6 hover:shadow-lg transition">
                ...
                <p className="text-warm-600 text-sm mb-4">丸ノ内線・南北線・中央線で近隣にもアクセス。</p>
                <ul className="space-y-2 text-sm">
        ...
        <section className="py-16 bg-warm-50">
          <div className="max-w-4xl mx-auto px-6 lg:px-8">
            ...
            <div className="bg-white rounded-lg p-8 border border-warm-200">
              ...
              <p className="text-warm-600 leading-relaxed mb-6">週1-2回からスタートがおすすめ。最低2-3ヶ月継続で効果を実感。</p>
        ...
        <section className="py-16 bg-white">
          <div className="max-w-4xl mx-auto px-6 lg:px-8">
            ...
            <div className="space-y-8">
              <div className="bg-white rounded-lg p-6 border border-warm-200"><div className="flex items-center mb-4"><span className="bg-warm-800 text-white w-8 h-8 rounded-full flex items-center justify-center font-bold mr-3">1</span><h3 className="text-xl font-bold text-warm-900">目的を明確にする</h3></div><p className="text-warm-600 leading-relaxed">ダイエット、姿勢改善、体幹強化など、目的に応じてスタジオを選びましょう。</p></div>
              <div className="bg-white rounded-lg p-6 border border-warm-200"><div className="flex items-center mb-4"><span className="bg-warm-800 text-white w-8 h-8 rounded-full flex items-center justify-center font-bold mr-3">2</span><h3 className="text-xl font-bold text-warm-900">予算を決める</h3></div><p className="text-warm-600 leading-relaxed">パーソナルは1回5,000円〜8,800円程度、グループは月4回10,000円〜15,000円が相場です。</p></div>
              <div className="bg-white rounded-lg p-6 border border-warm-200"><div className="flex items-center mb-4"><span className="bg-warm-800 text-white w-8 h-8 rounded-full flex items-center justify-center font-bold mr-3">3</span><h3 className="text-xl font-bold text-warm-900">体験レッスンに行く</h3></div><p className="text-warm-600 leading-relaxed">実際にスタジオの雰囲気やインストラクターとの相性を確認しましょう。</p></div>
              <div className="bg-white rounded-lg p-6 border border-warm-200"><div className="flex items-center mb-4"><span className="bg-warm-800 text-white w-8 h-8 rounded-full flex items-center justify-center font-bold mr-3">4</span><h3 className="text-xl font-bold text-warm-900">通いやすさを確認する</h3></div><p className="text-warm-600 leading-relaxed">四ツ谷はJR中央線・総武線、丸ノ内線、南北線が利用可能。新宿・飯田橋・市ヶ谷も近く、近隣エリアのスタジオも選択肢に入ります。落ち着いた住宅街で通いやすいエリアです。</p></div>
            </div>
          </div>
        </section>
        <section className="py-16 bg-warm-50">
        ...
        <section className="py-16 bg-white">
          <div className="max-w-4xl mx-auto px-6 lg:px-8">
            ...
            <p className="text-warm-600 leading-relaxed mb-6">今回は四ツ谷エリアのおすすめピラティススタジオについてご紹介しました。</p>
            <p className="text-warm-600 leading-relaxed mb-6">四ツ谷はJR中央線・丸ノ内線・南北線が利用でき、新宿・飯田橋方面にも好アクセス。パーソナル専門のスタジオが充実しており、じっくり丁寧に指導してもらいたい方におすすめのエリアです。</p>
        ...
        <section className="py-16 bg-warm-800 text-white" id="contact">
          <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
            ...
            <p className="text-warm-200 mb-8 leading-relaxed">初回限定の体験レッスン500円〜。<br />まずは気軽に体験してみましょう。</p>
