...
export const metadata = {
  alternates: { canonical: 'https://biyori-pilates.com/area/harajuku/' },
  title: '【2026年8月最新】原宿のピラティス｜初心者OK・無料体験で選ぶ料金比較',
  ...
  return (
    <>
      ...
      <main className="pt-20 bg-white">
        ...
        <TableOfContents areaName="原宿" studioNames={[...studios].sort((a,b)=>(((b as any).officialUrl||'').includes('felmat')?1:0)-(((a as any).officialUrl||'').includes('felmat')?1:0)).map((s) => s.name)} />
      ...
      <ConsultantSection areaKey="harajuku" areaName="原宿" />
