...
const studios = [
    ...
    reviews: [
      {
        ...
        rating: 5,
        date: '2週間前',
        text: '高田馬場駅から徒歩5分で通いやすいです。マットもマシンも両方受けられるのが嬉しい。全国150店舗以上で相互利用可能なのも出張時に便利。',
      },
      {
        author: 'Y.T',
        rating: 5,
  ...
  },
  {
    ...
    reviews: [
      {
        ...
        rating: 4,
        date: '1週間前',
        text: '月額3,278円で24時間使えるのは最強のコスパ。ちょこっとマシンピラティスもできるので運動習慣づくりに最適。',
      },
      {
        author: 'B.T',
        rating: 4,
        date: '2週間前',
        text: '高田馬場駅から近くて24時間営業なので、早朝や深夜でも通えるのが便利。学生にも手が届く料金です。',
      },
      {
        author: 'O.R',
        rating: 3,
        date: '3週間前',
        text: '専門スタジオほどのレッスンはないですが、セルフでマシンを使える手軽さが良い。筋トレマシンもあるので総合的に鍛えられます。',
      },
    ],
    price: '月額 3,278円（税込）',
    trial: '見学可能',
    features: ['24時間営業', '月額3,278円', 'セルフ式', '高田馬場駅近'],
    description: 'RIZAP監修のコンビニジム。月額3,278円（税込）で24時間利用可能。高田馬場駅から徒歩圏内。セルフ式でマシンピラティス（ストレッチ系マシン）や筋トレマシンを利用可能。専門的なピラティスレッスンはないが、圧倒的なコスパと手軽さで運動習慣づくりに最適。学生の街・高田馬場ならではの手頃な選択肢。',
    access: 'JR山手線・西武新宿線・東京メトロ東西線「高田馬場駅」徒歩圏内',
    address: '東京都新宿区高田馬場（高田馬場駅徒歩圏内）',
    popularPlan: {
      name: 'スタンダードプラン',
      description: '月額3,278円で全店舗24時間利用可能。マシンピラティス系ストレッチマシン、筋トレマシン、セルフエステなどが使い放題。',
      price: '月額 3,278円（税込）',
    },
    options: [
      'スタンダードプラン（月額 3,278円）',
    ...
    userProfile: {
      ...
      purpose: ['運動習慣づくり', 'ダイエット', '体力向上', 'コスパ重視'],
    },
    basicInfo: {
      hours: '24時間営業',
      closed: '年中無休',
      facilities: ['セルフエステ', 'セルフ脱毛', 'ロッカー', 'Wi-Fi'],
    },
  },
]
        ...
        <section className="bg-gradient-to-br from-warm-50 to-warm-100 py-12 md:py-16">
          <div className="max-w-4xl mx-auto px-6 lg:px-8">
            ...
            <h1 className="text-2xl md:text-3xl lg:text-4xl font-bold text-warm-900 mb-4">
              【2026最新】ピラティス高田馬場おすすめ12選！<br className="hidden md:block" />
              人気スタジオの料金プランを簡単比較！
            </h1>
          </div>
        </section>
