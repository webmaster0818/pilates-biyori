...
export const metadata = {
  title: '【2026最新】ピラティス北大路おすすめ5選！人気スタジオの料金プランを簡単比較！｜Pilates-Biyori',
    ...
    reviews: [
      {
        ...
        rating: 5,
        date: '1週間前',
        text: '四条駅12番出口から徒歩1分。北大路からも地下鉄1本でアクセス可能。マットもマシンも両方受けられる。全国150店舗以上で相互利用可能。',
      },
      {
        author: 'H.M',
        rating: 4,
        ...
        <section className="py-16 bg-white" id="price-market">
          <div className="max-w-4xl mx-auto px-6 lg:px-8">
            ...
            <p className="text-warm-600 mt-4 text-sm leading-relaxed">
              北大路エリアの料金はスタジオのタイプや立地によって異なります。まずは体験レッスンを活用して、料金と内容のバランスが自分に合うスタジオを見つけましょう。
            </p>
          </div>
        </section>
          ...
          <div className="max-w-4xl mx-auto px-6 lg:px-8">
            ...
            <div className="space-y-6">
              <div className="bg-white rounded-lg p-6 border border-warm-200">
                ...
                <p className="text-warm-600 leading-relaxed">
                  北大路では、四条・烏丸エリアのスタジオはアクセス重視、住宅地寄りのスタジオは落ち着いた雰囲気が特徴です。通う目的やライフスタイルに合わせてエリアを選びましょう。
                </p>
              </div>
              <div className="bg-white rounded-lg p-6 border border-warm-200">
              ...
              <div className="bg-white rounded-lg p-6 border border-warm-200">
                ...
                <p className="text-warm-600 leading-relaxed">
                  北大路エリアのスタジオはそれぞれ雰囲気が異なります。少人数制のアットホームなスタジオから大手チェーンまで、2〜3箇所の体験レッスンを受けて自分に合うスタジオを見つけましょう。
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="bg-warm-50 rounded-lg p-8 border border-warm-200">
              ...
              <div className="mt-6 p-4 bg-white rounded border border-warm-200">
                <p className="text-sm text-warm-600">
                  <strong>北大路エリアの豆知識：</strong>スタジオによってはウェアやタオルのレンタルサービスを提供しているところもあります。仕事帰りや外出先から直接通いたい方は、レンタルの有無を事前に確認しておくと便利です。
                </p>
              </div>
            </div>
          </div>
