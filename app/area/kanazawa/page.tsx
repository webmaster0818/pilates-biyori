...
export const metadata = {
  ...
  title: '【2026年9月最新】ピラティス金沢おすすめ6選！料金・体験レッスン・マシン対応を比較！',
...
const studios = [
  ...
  },
  {
    ...
    description: '完全個室・マンツーマンの女性専用パーソナルピラティススタジオ。入会金不要の月謝制で、一人ひとりに合わせたオリジナルプログラムを提供。金沢（香林坊バス停）から徒歩2分。※一部のご案内やサポート対応は、男性スタッフが行う場合がございます。※24/7Workout併設店舗のため、パーソナルトレーニングの男性会員様がご来店される場合もございます。',
...
export default function KanazawaPage() {
  return (
    <>
      ...
      <ConsultantSection areaKey="kanazawa" areaName="金沢" />
