...
const studios = [
  ...
  },
  {
    ...
    description: '完全個室・マンツーマンの女性専用パーソナルピラティススタジオ。入会金不要の月謝制で、一人ひとりに合わせたオリジナルプログラムを提供。高槻駅から徒歩3分。※一部のご案内やサポート対応は、男性スタッフが行う場合がございます。※24/7Workout併設店舗のため、パーソナルトレーニングの男性会員様がご来店される場合もございます。',
    access: '高槻駅から徒歩3分',
    ...
    // 出典: 店舗責任者 原坂様よりメールでご提供（2026-09-05）。
    // ⚠️ MediaXAI指示（2026-09-06）により **メールの内容を正** とする。
    //    ブランド公式(la-pilates.jp)には別記載（定休日=年末年始／JR徒歩5分／月1回・月6回・一般コース）が
    //    あるが、店舗責任者の申告を優先する。公式側で確認できる追加プランは載せていない。
    // ⚠️ 5タブは全て明示指定する。未設定だとStudioCardが架空のダミー値を描画する。
    name: 'La pilates（ラピラティス）高槻店',
    officialUrl: 'https://la-pilates.jp/studio/takatsuki/',
    price: '月2回 22,000円〜（税込・1回11,000円）',
    trial: '体験レッスン 3,000円',
    features: ['女性専用', '整体×マシンピラティス', '阪急高槻駅 徒歩1分', 'パーソナル50分'],
    description:
      '整体とマシンピラティスを組み合わせたパーソナルセッションを行う女性専用スタジオ。1回50分のセッションで、姿勢や身体の悩みにアプローチします。阪急高槻駅から徒歩1分、JR高槻駅からは徒歩6分です。',
    access: '阪急「高槻駅」徒歩1分 / JR「高槻駅」徒歩6分',
    address: '〒569-0802 大阪府高槻市北園町14-11 G.R. 高槻ビル 3F',
    popularPlan: {
      name: '月4回コース',
      description: '整体×マシンピラティスのパーソナルセッション（1回50分）を月4回。1回あたり10,000円です。',
      price: '月額 40,000円（税込・1回10,000円）',
    },
    options: [
      '月2回コース 1回11,000円（月22,000円・税込）',
      '月4回コース 1回10,000円（月40,000円・税込）',
      '体験レッスン 3,000円',
    ],
    userProfile: {
    ...
    basicInfo: {
      hours: '9:00〜21:00',
      closed: '不定休',
      facilities: ['ロッカー', 'パウダールーム', 'ウェアレンタル'],
    },
  },
]
