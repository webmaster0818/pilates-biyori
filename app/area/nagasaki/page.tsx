...
export const metadata = {
  alternates: { canonical: 'https://biyori-pilates.com/area/nagasaki/' },
  title: '【2026年8月最新】ピラティス長崎おすすめ5選！人気スタジオの料金プランを簡単比較！',
  ...
  return (
    <>
      ...
      <main className="pt-20 bg-white">
        ...
        <TableOfContents areaName="長崎" studioNames={[...studios].sort((a,b)=>(((b as any).officialUrl||'').includes('felmat')?1:0)-(((a as any).officialUrl||'').includes('felmat')?1:0)).map((s) => s.name)} />
      ...
      <ConsultantSection areaKey="nagasaki" areaName="長崎" />
