...
export const metadata = {
  title: '【2026最新】ピラティス川崎おすすめ8選！人気スタジオの料金プランを簡単比較！｜Pilates-Biyori',
  description: '川崎エリアのおすすめピラティススタジオ8選を徹底比較。マシンピラティス、体験レッスン、料金相場、選び方まで完全ガイド。初心者でも安心して通えるスタジオが見つかります。',
    ...
    reviews: [
      {
        ...
        rating: 5,
        date: '2週間前',
        text: '京急川崎駅から徒歩5分で通いやすい。全国150店舗が相互利用できるので出張先でも通えます。インストラクターの質が高く、体の変化を実感できました。',
      },
      {
        author: 'N.K',
        rating: 5,
    ...
    reviews: [
      {
        ...
        rating: 5,
        date: '1週間前',
        text: '理学療法士監修で安全。腰痛や肩こりの改善にも対応してくれます。川崎駅東口から徒歩3分で通いやすい。',
      },
      {
        author: 'N.S',
        rating: 5,
        date: '2週間前',
        text: '医学的根拠に基づいたトレーニングで効果を実感。リハビリテーションの知識を活かした指導が魅力。プライベートレッスンで丁寧です。',
      },
      {
        author: 'K.M',
        rating: 4,
        date: '3週間前',
        text: '体の不調改善に特化したプログラム。理学療法士の専門知識で安心して通えます。料金は高めですが価値があります。',
      },
    ],
    price: '月4回 14,300円〜',
    trial: '体験レッスン 3,300円',
    features: ['理学療法士監修', 'リハビリ対応', '川崎駅東口徒歩3分', 'プライベート'],
    description: '理学療法士監修のピラティススタジオ。川崎駅東口から徒歩3分。リハビリテーションの知識を活かした安全で効果的なレッスン。腰痛や肩こりなどの身体の不調改善にも対応。医学的根拠に基づいたトレーニングで健康的な身体づくりを実現。プライベートレッスン中心で一人ひとりに合わせた指導。',
    access: '川崎駅東口から徒歩3分',
    address: '神奈川県川崎市川崎区駅前本町15-8 川崎メディカルビル3F',
    popularPlan: {
      name: 'プライベート月4回プラン',
      description: '理学療法士監修。医学的根拠に基づいた安全で効果的なレッスン。',
      price: '月4回 14,300円（税込）',
    },
    options: [
      'プライベート月8回プラン（26,400円）',
      'グループレッスン（月4回 12,100円）',
      '追加レッスン（1回 3,850円）',
      'リハビリ特化コース（月4回 16,500円）',
    ],
    userProfile: {
      ageRange: '40代〜60代が中心（全体の65%）',
      genderRatio: '女性70% / 男性30%',
      purpose: ['腰痛改善', '肩こり改善', 'リハビリ', '健康維持'],
    },
    basicInfo: {
      hours: '平日 9:00〜20:00 / 土日祝 9:00〜18:00',
      closed: '不定休',
      facilities: ['シャワー', 'ロッカー', 'パウダールーム', 'リハビリ機器', 'マシン完備'],
    },
  },
]
      ...
      <main className="pt-20 bg-white">
        ...
        <section className="bg-gradient-to-br from-warm-50 to-warm-100 py-12 md:py-16">
          <div className="max-w-4xl mx-auto px-6 lg:px-8">
            <p className="text-warm-400 text-xs mb-2">更新日 @2026年04月06日</p>
