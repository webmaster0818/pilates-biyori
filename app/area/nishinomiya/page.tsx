...
export const metadata = {
  alternates: { canonical: 'https://biyori-pilates.com/area/nishinomiya/' },
  title: '【2026年9月最新】西宮のピラティス｜初心者OK・無料体験で選ぶ料金比較',
  description: '西宮エリアでおすすめのピラティススタジオを料金・無料体験・マシン対応で徹底比較。初心者向けの選び方、駅近スタジオ、体験レッスンの有無まで2026年6月の最新情報でわかります。',
...
const studios = [
  ...
  },
  {
    ...
    access: 'JR神戸線 西宮駅 徒歩5分／阪神本線 西宮駅 徒歩8分',
    address: '〒662-0918 兵庫県西宮市六湛寺町2-1 セントラルガーデンタワー104号',
    options: [
  ...
  return (
    <>
      ...
      <main className="pt-20 bg-white">
        ...
        <TableOfContents areaName="西宮" studioNames={[...studios].sort((a,b)=>(((b as any).officialUrl||'').includes('felmat')?1:0)-(((a as any).officialUrl||'').includes('felmat')?1:0)).map((s) => s.name)} />
      ...
      <ConsultantSection areaKey="nishinomiya" areaName="西宮" />
            ...
            <div className="my-8 bg-white border border-warm-200 p-5">
              ...
              <div className="flex flex-wrap gap-2">
                <Link href="/brands/club-pilates-nishinomiyakitaguchi/" className="text-xs text-warm-800 border border-warm-300 bg-white px-3 py-1.5 hover:border-warm-500 transition-colors">CLUB PILATES 西宮北口店の料金・体験を見る</Link>
              </div>
            </div>
