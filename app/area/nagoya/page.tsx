...
export const metadata = {
  alternates: { canonical: 'https://biyori-pilates.com/area/nagoya/' },
  title: '【2026年7月最新】名古屋のピラティス｜初心者OK・無料体験で選ぶ料金比較',
  description: '名古屋エリアでおすすめのピラティススタジオを料金・無料体験・マシン対応で徹底比較。初心者向けの選び方、駅近スタジオ、体験レッスンの有無まで2026年6月の最新情報でわかります。',
...
const studios = [
  ...
  },
  {
    ...
    description: '全国100店舗以上を展開するピラティス専門スタジオ。マットグループ・マシン（リフォーマー）グループ・プライベートを提供し、男性も利用可。全国の系列スタジオを他店利用できる。「名古屋駅」ミヤコ2出口徒歩1分。',
  ...
  return (
    <>
      ...
      <main className="pt-20 bg-white">
        ...
        <TableOfContents areaName="名古屋" studioNames={[...studios].sort((a,b)=>(((b as any).officialUrl||'').includes('felmat')?1:0)-(((a as any).officialUrl||'').includes('felmat')?1:0)).map((s) => s.name)} />
      ...
      <ConsultantSection areaKey="nagoya" areaName="名古屋" />
