...
export const metadata = {
  ...
  title: '【2026年9月最新】ピラティス大分おすすめ6選！人気スタジオの料金プランを簡単比較！',
...
const studios = [
  ...
  },
  {
    ...
    description: '完全個室・マンツーマンの女性専用パーソナルピラティススタジオ。入会金不要の月謝制で、一人ひとりに合わせたオリジナルプログラムを提供。大分駅から徒歩11分。※一部のご案内やサポート対応は、男性スタッフが行う場合がございます。※24/7Workout併設店舗のため、パーソナルトレーニングの男性会員様がご来店される場合もございます。',
    access: '大分駅から徒歩11分',
