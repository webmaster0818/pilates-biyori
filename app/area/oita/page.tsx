...
export const metadata = {
  title: '【2026最新】ピラティス大分おすすめ5選！人気スタジオの料金プランを簡単比較！｜Pilates-Biyori',
...
const studios = [
  ...
  },
  {
    ...
    description: '2025年1月オープンの理学療法士が運営するマシンピラティススタジオ。「���ラティス×理学療法×分子栄養学」を組み合わせた独自メソッドで不調の改善をサポート。',
    access: '大分市内',
    address: '大分県大分市（詳細は公式サイトでご確認ください）',
