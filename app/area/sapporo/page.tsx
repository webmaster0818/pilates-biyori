...
const studios = [
  ...
  },
  {
    ...
    description: '完全個室・マンツーマンの女性専用パーソナルピラティススタジオ。入会金不要の月謝制で、一人ひとりに合わせたオリジナルプログラムを提供。すすきの駅から徒歩5分。※一部のご案内やサポート対応は、男性スタッフが行う場合がございます。※24/7Workout併設店舗のため、パーソナルトレーニングの男性会員様がご来店される場合もございます。',
    access: 'すすきの駅から徒歩5分',
  ...
  },
  {
    ...
    access: '円山公園駅 徒歩2分',
    address: '〒064-0801 北海道札幌市中央区南1条西24丁目1-11 LEADビル302',
    options: [
      'セミパーソナル 月2回 11,000円（1回5,500円・税込）',
      'セミパーソナル 月4回 19,800円（1回4,950円・税込）',
      'パーソナル 月2回 22,000円／月4回 39,600円（税込）',
