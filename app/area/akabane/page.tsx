...
export const metadata = {
  ...
  title: '【2026年9月最新】赤羽のピラティス5社を比較｜無料体験3社・月額最安7,800円〜',
...
const studios = [
  ...
  },
  {
    ...
    access: '赤羽駅 徒歩5分',
    address: '〒115-0055 東京都北区赤羽西1-27-10ウエスト赤羽ビル3F',
    options: [
...
export default function AkabanePage() {
  return (
    <>
      ...
      <ConsultantSection areaKey="akabane" areaName="赤羽" />
      ...
      <div className="my-8 bg-white border border-warm-200 p-5">
        ...
        <div className="flex flex-wrap gap-2">
          ...
          <Link href="/brands/the-silk-akabane/" className="text-xs text-warm-800 border border-warm-300 bg-white px-3 py-1.5 hover:border-warm-500 transition-colors">the SILK 赤羽店の料金・体験を見る</Link>
