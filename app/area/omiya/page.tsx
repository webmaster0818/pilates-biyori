...
export const metadata = {
  ...
  title: '【2026年9月最新】大宮のピラティス｜初心者OK・無料体験で選ぶ料金比較',
...
const studios = [
  ...
  },
  {
    ...
    description: '完全個室・マンツーマンの女性専用パーソナルピラティススタジオ。入会金不要の月謝制で、一人ひとりに合わせたオリジナルプログラムを提供。大宮駅から徒歩3分。※一部のご案内やサポート対応は、男性スタッフが行う場合がございます。',
    access: '大宮駅から徒歩3分',
  ...
  },
  {
    ...
    access: '大宮駅東口 徒歩5分',
    address: '〒330-0846 埼玉県さいたま市大宮区大門町3丁目22-2 新栄ビル2号棟 3階',
    options: [
    ...
    <>
      ...
      <div className="my-8 bg-white border border-warm-200 p-5">
        ...
        <div className="flex flex-wrap gap-2">
          ...
          <Link href="/brands/the-silk-omiya/" className="text-xs text-warm-800 border border-warm-300 bg-white px-3 py-1.5 hover:border-warm-500 transition-colors">the SILK 大宮店の料金・体験を見る</Link>
