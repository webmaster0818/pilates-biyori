...
export const metadata = {
  ...
  title: '【2026年9月最新】浦和のピラティス｜初心者OK・無料体験で選ぶ料金比較',
...
const studios = [
  ...
  },
  {
    ...
    access: '浦和駅 徒歩3分',
    address: '〒330-0055 埼玉県さいたま市浦和区東高砂町18-11　チェリーハイツ 101',
    popularPlan: {
      name: '月4回コース',
  ...
  },
  {
    ...
    description: '完全個室・マンツーマンの女性専用パーソナルピラティススタジオ。入会金不要の月謝制で、一人ひとりに合わせたオリジナルプログラムを提供。北浦和駅から徒歩3分。※一部のご案内やサポート対応は、男性スタッフが行う場合がございます。',
    access: '北浦和駅から徒歩3分',
    ...
    <>
      ...
      <div className="my-8 bg-white border border-warm-200 p-5">
        ...
        <div className="flex flex-wrap gap-2">
          ...
          <Link href="/brands/the-silk-urawa/" className="text-xs text-warm-800 border border-warm-300 bg-white px-3 py-1.5 hover:border-warm-500 transition-colors">the SILK 浦和店の料金・体験を見る</Link>
