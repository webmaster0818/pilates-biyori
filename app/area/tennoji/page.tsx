...
export const metadata = {
  alternates: { canonical: 'https://biyori-pilates.com/area/tennoji/' },
  title: '【2026年9月最新】天王寺のピラティス｜初心者OK・無料体験で選ぶ料金比較',
  description: '天王寺エリアでおすすめのピラティススタジオを料金・無料体験・マシン対応で徹底比較。初心者向けの選び方、駅近スタジオ、体験レッスンの有無まで2026年6月の最新情報でわかります。',
...
const studios = [
  ...
  },
  {
    ...
    description: '医師推奨のパーソナルジム受賞歴を持つDr.トレーニング系列のパーソナルピラティススタジオ。マシン・マット両対応のマンツーマン指導で、姿勢改善やボディメイクを目指せる。天王寺エリア（詳細は公式サイト参照）。',
    access: '天王寺エリア（詳細は公式サイト参照）',
    address: '大阪府（詳細は公式サイト参照）',
  },
  {
    name: 'the SILK 天王寺MIO店',
    ...
    description: '女性専用のマシンピラティス専門スタジオ。レベル別・部位別の豊富なグループプログラムとパーソナルレッスンを提供し、洗練された空間が特徴。天王寺駅から直結（情報引用元: the SILK公式サイト the-silk.co.jp）。',
    access: '天王寺駅から直結',
    address: '大阪府大阪市天王寺区悲田院町10番48号 天王寺ミオプラザ館7階',
  },
]
  ...
  return (
    <>
      ...
      <BreadcrumbSchema items={[
        ...
        { name: '天王寺', url: 'https://pilates-biyori.com/area/tennoji/' },
      ]} />
      ...
      <main className="pt-20 bg-white">
        ...
        <section className="bg-gradient-to-br from-warm-50 to-warm-100 py-12 md:py-16">
          <div className="max-w-4xl mx-auto px-6 lg:px-8">
            ...
            <h1 className="text-2xl md:text-3xl lg:text-4xl font-bold text-warm-900 mb-4">
              【2026最新】ピラティス天王寺おすすめ14選！<br className="hidden md:block" />
              人気スタジオの料金プランを簡単比較！
            </h1>
          </div>
        </section>
        ...
        <TableOfContents areaName="天王寺" studioNames={[...studios].sort((a,b)=>(((b as any).officialUrl||'').includes('felmat')?1:0)-(((a as any).officialUrl||'').includes('felmat')?1:0)).map((s) => s.name)} />
        ...
        <section className="py-12 bg-white">
          <div className="max-w-4xl mx-auto px-6 lg:px-8">
            ...
            <p className="text-warm-600 leading-relaxed mb-8">
              そこでこの記事では、天王寺・阿倍野エリアでおすすめのピラティススタジオ14選をまとめました。
            </p>
      ...
      <ConsultantSection areaKey="tennoji" areaName="天王寺" />
      ...
      <div className="my-8 bg-white border border-warm-200 p-5">
        ...
        <div className="flex flex-wrap gap-2">
          ...
          <Link href="/brands/the-silk-tennoji-mio/" className="text-xs text-warm-800 border border-warm-300 bg-white px-3 py-1.5 hover:border-warm-500 transition-colors">the SILK 天王寺MIO店の料金・体験を見る</Link>
