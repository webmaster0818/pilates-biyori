...
export const metadata = {
  title: '【2026年最新】秋田のピラティススタジオ｜料金・体験プラン比較｜Pilates-Biyori',
  description: '秋田市のピラティススタジオを比較。公式サイトで確認した料金・体験プラン・住所を掲載。',
  keywords: 'ピラティス,秋田,スタジオ,料金,体験レッスン',
}
  ...
  return (
    <>
      <BreadcrumbSchema items={[
        ...
        { name: '秋田', url: 'https://biyori-pilates.com/area/akita/' },
      ]} />
      <Navigation />
      <main className="max-w-4xl mx-auto px-4 py-10">
        ...
        <h1 className="text-3xl md:text-4xl font-bold mb-4">秋田のピラティススタジオ</h1>
        ...
        <section className="mt-12 bg-gray-50 p-6 rounded-lg">
          <h2 className="text-2xl font-bold mb-4">秋田でピラティススタジオを選ぶときのポイント</h2>
