...
export const metadata = {
  title: '秋葉原のピラティス｜初心者OK・無料体験で選ぶ料金比較【2026年6月】',
  description: '秋葉原エリアでおすすめのピラティススタジオを料金・無料体験・マシン対応で徹底比較。初心者向けの選び方、駅近スタジオ、体験レッスンの有無まで2026年6月の最新情報でわかります。',
    ...
    reviews: [
      {
        ...
        rating: 5,
        date: '1週間前',
        text: '神保町駅A7出口から徒歩1分。秋葉原からも電車で数分でアクセスできます。全国150以上のスタジオが他店利用できるのが魅力。マットもリフォーマーも選べて充実しています。',
      },
      {
        author: 'R.H',
        rating: 4,
  ...
  return (
    <>
      ...
      <main className="pt-20 bg-white">
        ...
        <TableOfContents areaName="秋葉原" studioNames={studios.map((s) => s.name)} />
