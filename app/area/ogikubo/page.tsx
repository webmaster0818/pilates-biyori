...
export const metadata = {
  alternates: { canonical: 'https://biyori-pilates.com/area/ogikubo/' },
  title: '【2026年8月最新】荻窪のピラティス｜初心者OK・無料体験で選ぶ料金比較',
  description: '荻窪エリアでおすすめのピラティススタジオを料金・無料体験・マシン対応で徹底比較。初心者向けの選び方、駅近スタジオ、体験レッスンの有無まで2026年6月の最新情報でわかります。',
  ...
  return (
    <>
      ...
      <main className="pt-20 bg-white">
        ...
        <AreaConclusion studios={studios} areaName="荻窪" />


        <TableOfContents areaName="荻窪" studioNames={[...studios].sort((a,b)=>(((b as any).officialUrl||'').includes('felmat')?1:0)-(((a as any).officialUrl||'').includes('felmat')?1:0)).map((s) => s.name)} />
        ...
        <AreaMarketComparison studios={studios} areaName="荻窪" />
        ...
        <section className="py-16 bg-warm-800 text-white" id="contact">
          <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
            ...
            >
              ...
              <AreaModifierSections studios={studios} areaName="荻窪" />
      </main>
        {/* boost-nav-202606 */}
        <section className="py-12 bg-white">
          <div className="max-w-4xl mx-auto px-6 lg:px-8">
      ...
      <ConsultantSection areaKey="ogikubo" areaName="荻窪" />
