...
const faqs = [
  {
    ...
    answer: '大丈夫です！亀戸エリアのスタジオはほとんどが初心者歓迎。the SILKは体験者の約8割がピラティス未経験者、OLUTANAは女性専用で丁寧な指導。',
  },
  {
    question: 'マットピラティスとマシンピラティスの違いは？',
    answer: 'マットは自重エクササイズ、マシンはリフォーマー等の専用マシンを使用。マシンは負荷調整しやすく初心者におすすめ。亀戸はマシン対応スタジオが充実。',
  },
  {
    question: '亀戸エリアの料金相場は？',
    answer: 'グループ月4回で10,450円〜15,070円程度。zen place錦糸町が月4回10,450円〜。ピラティスKは月4回13,420円〜。',
  },
  {
  ...
  },
  {
    ...
    answer: 'zen place錦糸町とhealth fitは男性も通えます。the SILK・OLUTANA・ピラティスKは女性専用です。',
  },
  {
    question: '短時間で効果的なスタジオは？',
    answer: 'OLUTANA pilatesは30分完結のレッスン。忙しい方でも効率的にマシンピラティスが受けられます。',
  },
  {
    question: '無料で体験できるスタジオは？',
    answer: 'the SILKは手ぶらで無料体験可能。zen placeはグループ体験1,000円。ピラティスKは体験2,000円。',
  },
  {
        ...
        <section className="bg-gradient-to-br from-warm-50 to-warm-100 py-12 md:py-16">
          <div className="max-w-4xl mx-auto px-6 lg:px-8">
            ...
            <h1 className="text-2xl md:text-3xl lg:text-4xl font-bold text-warm-900 mb-4">
              【2026最新】ピラティス亀戸おすすめ5選！<br className="hidden md:block" />
              人気スタジオの料金プランを簡単比較！
            </h1>
          </div>
        </section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="border border-warm-200 rounded-lg p-6 hover:shadow-lg transition">
                ...
                <ul className="space-y-2 text-sm">
                  <li className="text-warm-700">• zen place 錦糸町（月4回 10,450円〜）</li>
                  <li className="text-warm-700">• the SILK 亀戸（月3回 12,980円〜）</li>
                </ul>
              </div>
              <div className="border border-warm-200 rounded-lg p-6 hover:shadow-lg transition">
                ...
                <ul className="space-y-2 text-sm">
                  <li className="text-warm-700">• the SILK 亀戸（月3回 12,980円〜）</li>
                  <li className="text-warm-700">• OLUTANA pilates（30分完結）</li>
              ...
              <div className="border border-warm-200 rounded-lg p-6 hover:shadow-lg transition">
                ...
                <ul className="space-y-2 text-sm">
                  <li className="text-warm-700">• the SILK（亀戸駅 徒歩1分）</li>
                  <li className="text-warm-700">• OLUTANA（亀戸駅 徒歩1分）</li>
                </ul>
              </div>
            </div>
          </div>
          ...
          <div className="max-w-4xl mx-auto px-6 lg:px-8">
            ...
            <div className="space-y-8">
              ...
              <div className="bg-white rounded-lg p-6 border border-warm-200">
                ...
                <p className="text-warm-600 leading-relaxed">
                  亀戸エリアの料金相場はグループ月4回で10,450円〜15,070円。入会金やキャンペーンも確認しましょう。
                </p>
              </div>
              <div className="bg-white rounded-lg p-6 border border-warm-200">
                <div className="flex items-center mb-4">
                ...
                <p className="text-warm-600 leading-relaxed">
                  the SILKは無料体験。zen placeは1,000円、ピラティスKは2,000円で体験可能。気軽に試してみましょう。
                </p>
              </div>
              <div className="bg-white rounded-lg p-6 border border-warm-200">
                <div className="flex items-center mb-4">
                ...
                <p className="text-warm-600 leading-relaxed">
                  亀戸はJR総武線、錦糸町はJR総武線・半蔵門線が利用可能。the SILKとOLUTANAは亀戸駅徒歩1分とアクセス抜群。
                </p>
              </div>
            </div>
          </div>
