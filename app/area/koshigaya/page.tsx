        ...
        <section className="py-16 bg-white" id="price-market">
          <div className="max-w-4xl mx-auto px-6 lg:px-8">
            ...
            <p className="text-warm-600 mt-4 text-sm leading-relaxed">
              越谷エリアの料金はスタジオのタイプや立地によって異なります。まずは体験レッスンを活用して、料金と内容のバランスが自分に合うスタジオを見つけましょう。
            </p>
          </div>
        </section>
          ...
          <div className="max-w-4xl mx-auto px-6 lg:px-8">
            ...
            <div className="space-y-6">
              <div className="bg-white rounded-lg p-6 border border-warm-200">
                ...
                <p className="text-warm-600 leading-relaxed">
                  越谷エリアではスタジオの多くが駅徒歩5分圏内に集中しています。駅から離れたスタジオの場合は駐車場・駐輪場の有無を事前に確認しておくと安心です。
                </p>
              </div>
              <div className="bg-white rounded-lg p-6 border border-warm-200">
                <h3 className="text-lg font-bold text-warm-900 mb-3">車・自転車通いの場合は駐車場を確認</h3>
                <p className="text-warm-600 leading-relaxed">
                  越谷は車や自転車で通う方も多いエリアです。スタジオ自体に駐車場がない場合でも、近隣のコインパーキングや提携駐車場がある場合があるので、事前に問い合わせておきましょう。
                </p>
              </div>
              <div className="bg-white rounded-lg p-6 border border-warm-200">
              ...
              <div className="bg-white rounded-lg p-6 border border-warm-200">
                ...
                <p className="text-warm-600 leading-relaxed">
                  越谷エリアでは商業施設の近くにスタジオがある場合、買い物のついでに通えて続けやすいメリットがあります。通い放題プランと組み合わせると生活動線に組み込みやすくおすすめです。
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="bg-warm-50 rounded-lg p-8 border border-warm-200">
              ...
              <div className="mt-6 p-4 bg-white rounded border border-warm-200">
                <p className="text-sm text-warm-600">
                  <strong>越谷エリアの豆知識：</strong>スタジオによってはウェアやタオルのレンタルサービスを提供しているところもあります。仕事帰りや外出先から直接通いたい方は、レンタルの有無を事前に確認しておくと便利です。
                </p>
              </div>
            </div>
          </div>
