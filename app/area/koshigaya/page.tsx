...
export const metadata = {
  ...
  title: '【2026年9月最新】越谷のピラティス｜初心者OK・無料体験で選ぶ料金比較',
...
const studios = [
  ...
  },
  {
    ...
    image: '/images/studios/m-neutral.webp',
    price: 'パーソナルレッスン（要問合せ）',
    trial: '体験レッスンあり',
  ...
  },
  {
    ...
    description: '女性専用のマシンピラティス専門スタジオ。1セッション最大5名のセミパーソナル形式で、グループより手厚くパーソナルより通いやすい価格帯が特徴。越谷駅から徒歩3分。',
    access: '越谷駅から徒歩3分',
