...
export const metadata = {
  ...
  title: '【2026年7月最新】代官山のピラティス｜初心者OK・無料体験で選ぶ料金比較',
...
const studios = [
  ...
  },
  {
    ...
    reviewCount: 18,
    reviews: [
      { author: 'R.K', rating: 5, date: '2週間前', text: '代官山駅北口から徒歩4分。全国150以上のスタジオが他店利用できるので、渋谷や中目黒のスタジオでもレッスンが受けられます。プライベートレッスン専門スタジオとして質の高い指導が受けられます。' },
