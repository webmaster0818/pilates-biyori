...
const studios = [
  {
    ...
    reviews: [
      ...
      { author: 'K.H', rating: 4, date: '3週間前', text: '最大12名の少人数制でしっかり見てもらえます。男性もOKなので夫婦で通っています。恵比寿からも近くて便利。' },
    ],
    price: '月4回 14,190円〜',
  ...
  },
  {
    ...
    reviews: [
      ...
      { author: 'S.T', rating: 5, date: '1ヶ月前', text: 'エデュケーター（インストラクター）の質が高い。代官山のおしゃれな雰囲気の中で、本格的なピラティスが学べます。' },
    ],
    price: '月額 10,450円〜',
  ...
  },
  {
    ...
    reviews: [
      ...
      { author: 'M.K', rating: 4, date: '2週間前', text: '朝8時から夜21時まで営業で仕事前後に通えます。PMA加盟団体のプロ監修レッスンが受けられるのが魅力。代官山からも近くて便利。' },
    ],
    price: '月3回 13,280円〜',
  ...
  },
  {
    ...
    reviews: [
      ...
      { author: 'K.S', rating: 4, date: '3週間前', text: 'マシンピラティス専門で初心者でも安心。鏡を使ったフォーム確認ができるのが特徴的。代官山からも近くて便利です。' },
    ],
  ...
  },
  {
    ...
    reviews: [
      ...
      { author: 'R.O', rating: 4, date: '2週間前', text: '完全パーソナルなので自分のペースで進められます。腰痛改善や姿勢矯正など、悩みに合わせたセッションを組んでくれます。' },
    ],
    price: '回数制（入会金・月会費不要）',
    trial: '体験レッスン 5,500円',
  ...
  },
  {
    ...
    reviews: [
      ...
      { author: 'M.I', rating: 5, date: '1ヶ月前', text: '代官山の落ち着いた雰囲気の中で、質の高いプライベートピラティスが受けられます。福岡にも店舗があり、出張時にも通えて便利。' },
    ],
  ...
  },
  {
    ...
    reviews: [
      ...
      { author: 'Y.S', rating: 5, date: '3週間前', text: 'プライベートレッスンでは体の状態に合わせて完全カスタマイズしてくれます。身体の使い方を根本から学べるので、他のスポーツにも活きています。' },
    ],
    price: '月4回 11,220円〜',
    trial: '体験レッスン 0円',
        ...
        <section className="py-16 bg-white" id="price-market">
          <div className="max-w-4xl mx-auto px-6 lg:px-8">
            ...
            <p className="text-warm-600 mt-4 text-sm leading-relaxed">
              代官山エリアの料金はスタジオのタイプや立地によって異なります。まずは体験レッスンを活用して、料金と内容のバランスが自分に合うスタジオを見つけましょう。
            </p>
          </div>
        </section>
            ...
            <div className="space-y-6">
              <div className="bg-white rounded-lg p-6 border border-warm-200">
                ...
                <p className="text-warm-600 leading-relaxed">
                  代官山エリアは複数路線が利用できる便利な立地ですが、出口によってスタジオまでの距離が大きく変わることがあります。通う前にGoogleマップで自分の利用路線からのルートを確認しておきましょう。
                </p>
              </div>
              <div className="bg-white rounded-lg p-6 border border-warm-200">
                <h3 className="text-lg font-bold text-warm-900 mb-3">平日夜・土日午前は予約が集中</h3>
                <p className="text-warm-600 leading-relaxed">
                  代官山エリアでは平日19時〜21時、土日午前中がレッスン予約のピークタイムです。人気スタジオは早めの予約が必須。平日午前〜昼間は比較的空いているので、時間に融通が利く方は狙い目です。
                </p>
              </div>
              <div className="bg-white rounded-lg p-6 border border-warm-200">
              ...
              <div className="bg-white rounded-lg p-6 border border-warm-200">
                ...
                <p className="text-warm-600 leading-relaxed">
                  代官山エリアにはグループ専門からパーソナル専門まで多彩なスタジオがあります。1つだけで決めず、2〜3スタジオの体験レッスンを受けて、インストラクターとの相性や雰囲気を比較してから入会を決めましょう。
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="bg-warm-50 rounded-lg p-8 border border-warm-200">
              ...
              <div className="mt-6 p-4 bg-white rounded border border-warm-200">
                <p className="text-sm text-warm-600">
                  <strong>代官山エリアの豆知識：</strong>スタジオによってはウェアやタオルのレンタルサービスを提供しているところもあります。仕事帰りや外出先から直接通いたい方は、レンタルの有無を事前に確認しておくと便利です。
                </p>
              </div>
            </div>
          </div>
