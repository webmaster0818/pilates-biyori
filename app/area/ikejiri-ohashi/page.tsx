...
export const metadata = {
  title: '【2026最新】ピラティス池尻大橋おすすめ6選！人気スタジオの料金プランを簡単比較！｜Pilates-Biyori',
...
const studios = [
  {
    ...
    price: '料金は店舗にお問��合わせください',
    trial: '体験レッスンあり',
    features: ['女性専用', '産婦人科医監修', '池尻大橋駅徒歩3分', 'ウェア無料レンタル'],
    description: '池���大橋駅徒歩3分の女性専用パーソナルマシンピラティススタジオ。産婦人科医監修のプログラムで女性の身体に寄り添った指導を提供。最新ブランドのウェア無料レンタル、ウォーターサーバー、パウダールーム完備で手ぶらで通えます。五感を満たすパーソナル空間が魅力。',
    access: '東急田園都市線「池尻大橋駅」徒���3分',
  ...
  },
  {
    ...
    price: '1回 7,200円〜',
    trial: '体験レッスンあり',
    features: ['女性向けパーソナル', '有資格者40名以上', '池尻���橋駅近', 'カウンセリング付き'],
    ...
    basicInfo: { hours: '店舗にお問い合わせく��さい', closed: '店舗にお問い合わせく��さい', facilities: ['���ッカー', 'マシン完備'] },
  },
  {
  ...
  },
  {
    ...
    price: '月4回 22,000円',
    trial: '体験レッスン 3,300円',
    features: ['マンツーマン30分', '月4回 22,000円', '体験3,300円', '池尻��橋・中目黒'],
    description: 'マシンピラティス専門のパーソナルジム。1回30分の短時間マ���ツーマンレッスンで仕事や家事の隙間時間を活用。月4回22,000円とパーソナルの中ではリーズナブル。池尻大橋と中目黒の間に位置し、両駅からアクセス可能。',
    ...
    options: ['月4回プ���ン（22,000円）', '体験レッスン（3,300���）'],
    userProfile: { ageRange: '20代〜40代が中心', genderRatio: '女性75% / 男性25%', purpose: ['ボディメイク', '体幹強化', '姿勢改善', '運動不足解消'] },
    basicInfo: { hours: '店舗にお問い合わせください', closed: '店舗にお問い合わせください', facilities: ['ロ���カー', 'マシン完備'] },
  },
  {
    ...
    userProfile: { ageRange: '20代���50代が中心', genderRatio: '女性85% / 男性15%', purpose: ['姿勢改善', '体幹強化', 'リフレッ��ュ', '健康維持'] },
  ...
  },
  {
    ...
    options: ['月4回プラン（11,220円〜）', '月8回プラン', '通い放題プラ��'],
    userProfile: { ageRange: '20代〜40代が中心', genderRatio: '女性100%（女性専用）', purpose: ['ボディメイク', 'ダイエット', '姿勢改善', '美容'] },
    basicInfo: { hours: '店舗にお問い合わせくだ���い', closed: '店舗にお問い合わせください', facilities: ['ロッカー', 'リフォーマー完備', 'パウダールーム'] },
  },
]
    ...
    <>
      ...
      <main className="pt-20 bg-white">
        ...
        <section className="py-12 bg-white"><div className="max-w-4xl mx-auto px-6 lg:px-8">
          ...
          <div className="bg-warm-50 border-l-4 border-warm-400 p-6 mb-8"><h2 className="text-lg font-bold text-warm-900 mb-4">こんな人におす���め</h2><ul className="space-y-2 text-warm-700"><li className="flex items-start"><span className="text-warm-400 mr-2">✓</span><span>池尻大橋でピラティススタジオを探している</span></li><li className="flex items-start"><span className="text-warm-400 mr-2">✓</span><span>女性専用のパーソナルスタジオを探している</span></li><li className="flex items-start"><span className="text-warm-400 mr-2">���</span><span>産後ケアに対応したスタジオを知り��い</span></li><li className="flex items-start"><span className="text-warm-400 mr-2">✓</span><span>少人数制で丁寧に指導してもらいたい</span></li></ul></div>
        ...
        <section className="py-16 bg-white" id="cautions"><div className="max-w-4xl mx-auto px-6 lg:px-8"><h2 className="text-2xl md:text-3xl font-bold text-warm-900 mb-8 text-center">池尻大橋でスタジオを選ぶ際の注意点</h2><div className="space-y-6">
          ...
          <div className="bg-white rounded-lg p-6 border border-warm-200"><h3 className="text-lg font-bold text-warm-900 mb-3">女性専用スタジオが豊富なエリア</h3><p className="text-warm-600 leading-relaxed">池尻大橋はAruPilates、YUZU、ピラティスKなど女性専用スタジオが充実。産後ケアやボディメイクなど目的に合わせて選べます。男性の方はzen place pilatesやELEMENTをご検��ください。</p></div>
