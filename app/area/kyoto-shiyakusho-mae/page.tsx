...
export const metadata = {
  title: '【2026最新】ピラティス京都市役所前おすすめ5選！人気スタジオの料金プランを簡単比較！｜Pilates Navi',
...
const studios = [
  {
    ...
    reviews: [
      { author: 'M.K', rating: 5, date: '1週間前', text: '四条駅12番出口から徒歩1分で通いやすい。全国150店舗相互利用できるので出張先でも通えるのが便利。グループ体験1,000円で気軽に試せる。' },
      { author: 'S.T', rating: 5, date: '2週間前', text: '男性も通えるスタジオ。マットもマシンも両方あり、自分に合ったレッスンを選べる。インストラクターの質が高い。' },
      { author: 'R.N', rating: 4, date: '3週間前', text: '京都市役所前からも地下鉄で簡単にアクセスできる。月4回10,450円〜とリーズナブル。継続しやすい料金設定。' },
    ],
    ...
    popularPlan: { name: 'グループ月4回プラン', description: 'マット・マシン両対応のグループレッスン。全国150店舗で相互利用可能。', price: '月4回 10,450円（税込）' },
    ...
    basicInfo: { hours: '月〜金 7:00-21:00 / 土日 7:00-18:00', closed: '不定休', facilities: ['リフォーマー', 'マット', '更衣室', 'ロッカー'] },
  },
  {
    name: 'ピラティスK 京都四条烏丸店',
    ...
    reviews: [
      { author: 'K.N', rating: 5, date: '1週間前', text: '女性専用のマシン専門スタジオ。音楽に合わせたレッスンが楽しくてあっという間に時間が過ぎる。体験0円で気軽に試せた。' },
      { author: 'Y.M', rating: 4, date: '2週間前', text: 'リフォーマーマシン専門で本格的。女性専用なので周りの目を気にせず集中できる。京都市役所前から地下鉄ですぐ。' },
      { author: 'A.S', rating: 5, date: '3週間前', text: '月4回13,420円〜。音楽レッスンが他にはない楽しさ。インストラクターも丁寧で初心者でも安心。' },
    ],
  ...
  },
  {
    ...
    reviews: [
      { author: 'E.M', rating: 5, date: '1週間前', text: 'LAVA系列で安心感がある。月4回8,800円はマシンピラティスとしてはかなりリーズナブル。初心者が87%以上で雰囲気も良い。' },
      { author: 'N.K', rating: 5, date: '2週間前', text: '無料体験でパーソナル姿勢診断もしてもらえた。女性専用なので安心。リフォーマーを使った本格レッスン。' },
  ...
  },
  {
    ...
    reviews: [
      { author: 'T.M', rating: 5, date: '1週間前', text: '世界最大級のピラティスブランド。烏丸御池駅徒歩1分で京都市役所前の隣駅。15種類の器具を使った本格レッスンが体験無料。' },
      { author: 'C.Y', rating: 5, date: '2週間前', text: '4段階のレベル分けで初心者から上級者まで対応。男性会員も多く、夫婦で通っている方も。8つのプログラムで飽きない。' },
      { author: 'K.S', rating: 4, date: '3週間前', text: 'インストラクター全員が500時間以上の研修済み。有酸素運動を含むレッスンもあり、ダイエット目的にも最適。' },
    ],
    price: '月4回 14,190円〜', trial: '体験レッスン 無料',
  ...
  },
  {
    ...
    reviews: [
      { author: 'A.K', rating: 5, date: '1週間前', text: '阪急京都河原町駅から徒歩3分。30分で完結するサーキット形式が忙しい日でもちょうどいい。予約不要でふらっと行ける。' },
      { author: 'Y.N', rating: 4, date: '2週間前', text: '月4回9,680円〜とリーズナブル。マシンとフロアを交互に行うサーキット形式で効率よく全身を鍛えられる。' },
      { author: 'M.H', rating: 5, date: '3週間前', text: '予約不要なのが最大の魅力。思い立った時にすぐ行ける。30分で終わるので仕事帰りにもサクッと通える。' },
    ],
    ...
    popularPlan: { name: '月4回プラン', description: 'サーキット形式の30分マシンピラティス。予約不要で通いやすい。', price: '月4回 9,680円（税込）' },
    options: ['月8回プラン', '通い放題プラン', '予約不要', '30分完結レッスン'],
    userProfile: { ageRange: '20代〜40代が中心', genderRatio: '女性85% / 男性15%', purpose: ['ボディメイク', 'ダイエット', '運動不足解消', '時短トレーニング'] },
    basicInfo: { hours: '公式サイトでご確認ください', closed: '不定休', facilities: ['リフォーマーマシン', 'フロアエクササイズ', '更衣室', 'ロッカー'] },
  },
]

const faqs = [
  { question: 'ピラティス初心者でも大丈夫ですか？', answer: '大丈夫です！京都市役所前エリアのスタジオはほとんどが初心者歓迎。Rintosullは初心者87%以上、CLUB PILATESは4段階のレベル分けで安心。' },
  { question: 'マットピラティスとマシンピラティスの違いは？', answer: 'マットは自重エクササイズ、マシンはリフォーマー等の専用マシンを使用。マシンは負荷調整しやすく初心者におすすめ。zen placeは両方対応。' },
  { question: '京都市役所前のピラティスの料金相場は？', answer: 'Rintosullは月4回8,800円〜と最安。アーバンクラシックピラティスは月4回9,680円〜。zen placeは月4回10,450円〜。グループ月4回で8,800円〜14,190円が相場。' },
  ...
  { question: '体験レッスンは何を持っていけばいいですか？', answer: '動きやすい服装と飲み物があればOK。ピラティスKは体験0円、CLUB PILATESとRintosullも無料体験あり。zen placeはグループ体験1,000円。' },
  { question: '男性でも通えるスタジオはありますか？', answer: 'zen place pilates京都スタジオとCLUB PILATES烏丸御池店は男性も通えます。ピラティスK・Rintosullは女性専用です。' },
  { question: '一番安いスタジオは？', answer: 'Rintosullが月4回8,800円〜で最安。次にアーバンクラシックピラティスが月4回9,680円〜、zen placeが月4回10,450円〜。' },
  { question: '予約なしで通えるスタジオはありますか？', answer: 'アーバンクラシックピラティス四条河原町店は予約不要。30分完結のサーキット形式で好きな時間に通えます。' },
  ...
  return (
    <>
      ...
      <main className="pt-20 bg-white">
        ...
        <section className="py-16 bg-warm-50"><div className="max-w-4xl mx-auto px-6 lg:px-8"><h2 className="text-2xl md:text-3xl font-bold text-warm-900 mb-6 text-center">まとめ</h2><p className="text-warm-600 leading-relaxed mb-6">今回は京都市役所前エリアのおすすめピラティススタジオについてご紹介してきましたが、いかがでしたか？</p><p className="text-warm-600 leading-relaxed mb-6">この記事では京都市役所前にあるピラティススタジオから厳選したものだけを紹介しているので、ひとまず今回まとめた中から探すのもありだと思いますよ。</p><p className="text-warm-600 leading-relaxed mb-6">ぜひこの記事を参考に自分に合うピラティススタジオを見つけてくださいね。</p><p className="text-warm-700 font-medium text-center">あなたにぴったりのピラティススタジオが見つかることを願っています。</p></div></section>
