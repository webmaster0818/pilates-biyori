...
export const metadata = {
  title: '【2026年6月最新】ピラティス浅草おすすめ9選！料金・体験レッスン・マシン対応を比較！',
  description: '浅草エリアのおすすめピラティススタジオ9選を徹底比較。スカイツリーを見ながらピラティス、世界最大級のマシンピラティスなど。体験レッスン、料金相場、アクセスまで完全ガイド。',
...
const studios = [
    ...
    reviews: [
      {
        ...
        rating: 5,
        date: '2週間前',
        text: '浅草から半蔵門線で2駅の錦糸町駅。スカイツリー近くで、全国150店舗他店利用できるので、出張先や旅行先でも継続できます。',
      },
      {
        author: 'F.H',
        rating: 4,
    ...
    reviews: [
      {
        ...
        rating: 5,
        date: '1週間前',
        text: '浅草から銀座線で2駅の上野駅。全国150店舗他店利用できるので、浅草・錦糸町・上野の各店舗を自由に選べます。',
      },
      {
        author: 'T.M',
        rating: 4,
  ...
  },
  {
    ...
    access: '浅草橋駅から徒歩3分',
    address: '東京都千代田区東神田2丁目8-7 エスポワール東神田3階',
  },
]
  ...
  return (
    <>
      ...
      <main className="pt-20 bg-white">
        ...
        <section className="bg-gradient-to-br from-warm-50 to-warm-100 py-12 md:py-16">
          <div className="max-w-4xl mx-auto px-6 lg:px-8">
            ...
            <h1 className="text-2xl md:text-3xl lg:text-4xl font-bold text-warm-900 mb-4">
              【2026年6月最新】ピラティス浅草おすすめ9選！<br className="hidden md:block" />
              料金・体験レッスン・マシン対応を比較！
            </h1>
          </div>
        </section>
        ...
        <TableOfContents areaName="浅草" studioNames={studios.map((s) => s.name)} />
