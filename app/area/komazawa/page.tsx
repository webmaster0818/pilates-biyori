...
export const metadata = {
  title: '【2026年6月最新】ピラティス駒沢おすすめ6選！料金・体験レッスン・マシン対応を比較！',
    ...
    reviews: [
      {
        ...
        rating: 5,
        date: '2週間前',
        text: '駒沢大学駅から徒歩4分で通いやすいです。マットもマシンも両方受けられるのが嬉しい。インストラクターの質が高く、体の使い方を丁寧に教えてくれます。',
      },
      {
        author: 'A.T',
        rating: 5,
  ...
  return (
    <>
      ...
      <main className="pt-20 bg-white">
        ...
        <TableOfContents areaName="駒沢" studioNames={studios.map((s) => s.name)} />
