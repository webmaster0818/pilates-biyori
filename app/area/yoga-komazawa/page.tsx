...
export const metadata = {
  title: '【2026最新】ピラティス用賀・駒沢おすすめ6選！人気スタジオの料金プランを簡単比較！｜Pilates-Biyori',
  description: '用賀・駒沢エリアのおすすめピラティススタジオ6選を徹底比較。マシンピラティス、体験レッスン、料金相場、選び方まで完全ガイド。初心者でも安心して通えるスタジオが見つかります。',
    ...
    reviews: [
      {
        ...
        rating: 5,
        date: '1週間前',
        text: '用賀駅東口から徒歩3分。BASIピラティス認定インストラクターが在籍し質の高い指導。AIによる姿勢分析で初心者でも変化を実感しやすい。',
      },
      {
        author: 'M.T',
        rating: 5,
        date: '2週間前',
        text: '全国150店舗以上で相互利用可能。マットもマシンも両方受けられるのが魅力。男性もOKなので夫婦で通っています。',
      },
      {
        author: 'A.H',
        rating: 4,
        date: '3週間前',
        text: 'グループ体験1,000円で気軽に試せました。少人数制で丁寧に見てもらえます。田園都市線沿線で通いやすい。',
      },
    ],
    price: '月4回 10,450円〜',
    trial: 'グループ体験 1,000円',
    ...
    reviews: [
      {
        ...
        rating: 5,
        date: '1週間前',
        text: '駒沢大学駅駒沢公園口から徒歩4分。駒沢公園の近くで環境も良い。マット・マシン・プライベートと選べるレッスン形式が豊富。',
      },
      {
        author: 'R.I',
        rating: 4,
        date: '2週間前',
        text: '少人数制で丁寧な指導。体験1,000円で試せるのが嬉しい。用賀店との相互利用もできるので便利。',
      },
      {
        author: 'N.K',
        rating: 5,
        date: '3週間前',
        text: 'インストラクターの質が高く、体の使い方を丁寧に教えてもらえます。男性OKで夫婦やカップルでも通えます。',
      },
    ],
    price: '月4回 10,450円〜',
    trial: 'グループ体験 1,000円',
    ...
    reviews: [
      {
        ...
        rating: 5,
        date: '1週間前',
        text: '駒沢大学駅西口から徒歩3分。マシンピラティス専門でリフォーマーの台数が豊富。月6,600円〜と大手の中ではかなりリーズナブル。',
      },
      {
        author: 'E.N',
        rating: 5,
        date: '2週間前',
        text: '採光の良い明るいスタジオで気持ちよくレッスンできます。月2回から8回まで選べる回数制で、在籍中はレッスン繰越が無制限なのが嬉しい。',
      },
      {
        author: 'C.M',
        rating: 4,
        date: '3週間前',
        text: '初心者でも安心の丁寧な指導。予約も取りやすく、ストレスなく通えています。',
      },
    ],
    price: '月2回 6,600円〜',
    trial: '体験レッスンあり',
    ...
    reviews: [
      {
        ...
        rating: 5,
        date: '1週間前',
        text: '駒沢公園から徒歩1分の一軒家スタジオ。パーソナルレッスンで一人ひとりに合わせた丁寧な指導。スポーツや身体表現の分野で活躍するインストラクターが在籍。',
      },
      {
        author: 'H.S',
        rating: 5,
        date: '2週間前',
        text: '一軒家のような落ち着いた空間で、日常から離れてピラティスに集中できます。身体・心・食のスペシャリストがトータルにサポート。',
      },
      {
        author: 'M.K',
        rating: 5,
        date: '3週間前',
        text: '完全パーソナルなので自分のペースで進められます。姿勢の癖を見抜いて的確にアドバイスしてもらえる。',
      },
    ],
    price: 'パーソナル 要問合せ',
    trial: '体験レッスンあり',
    ...
    reviews: [
      {
        ...
        rating: 5,
        date: '1週間前',
        text: '1レッスン最大3名のセミパーソナルで1回1,250円〜とコスパ最強。国道246号線沿いのビル4階にあり、駒沢大学駅からアクセスしやすい。',
      },
      {
        author: 'Y.T',
        rating: 4,
        date: '2週間前',
        text: '少人数制なのでインストラクターにしっかり見てもらえます。マシンピラティスをこの価格で受けられるのはすごい。',
      },
      {
        author: 'R.S',
        rating: 5,
        date: '3週間前',
        text: '初心者でも安心のセミパーソナルレッスン。予約も取りやすく通いやすい。',
      },
    ],
    price: '1回 1,250円〜',
    trial: '体験レッスン 9,800円',
    ...
    reviews: [
      {
        ...
        rating: 5,
        date: '1週間前',
        text: '駒沢大学駅東口から徒歩5分。マンツーマンのマシンピラティスが1回2,750円〜と通い放題で利用できる。30分の短時間レッスンで忙しい人にもぴったり。',
      },
      {
        author: 'S.M',
        rating: 4,
        date: '2週間前',
        text: '完全マンツーマンなので自分の体の状態に合わせてメニューを組んでもらえる。短時間で効率的にトレーニングできる。',
      },
      {
        author: 'T.A',
        rating: 5,
        date: '3週間前',
        text: '通い放題プランがあるので好きなだけ通える。初心者でもマンツーマンで安心。',
      },
    ],
        ...
        <section className="bg-gradient-to-br from-warm-50 to-warm-100 py-12 md:py-16">
          <div className="max-w-4xl mx-auto px-6 lg:px-8">
            ...
            <h1 className="text-2xl md:text-3xl lg:text-4xl font-bold text-warm-900 mb-4">
              【2026最新】ピラティス用賀・駒沢おすすめ12選！<br className="hidden md:block" />
              人気スタジオの料金プランを簡単比較！
            </h1>
          </div>
        </section>
        ...
        <section className="py-16 bg-white" id="price-market">
          <div className="max-w-4xl mx-auto px-6 lg:px-8">
            ...
            <p className="text-warm-600 mt-4 text-sm leading-relaxed">
              用賀・駒沢エリアの料金はスタジオのタイプや立地によって異なります。まずは体験レッスンを活用して、料金と内容のバランスが自分に合うスタジオを見つけましょう。
            </p>
          </div>
        </section>
          ...
          <div className="max-w-4xl mx-auto px-6 lg:px-8">
            ...
            <div className="space-y-6">
              <div className="bg-white rounded-lg p-6 border border-warm-200">
                ...
                <p className="text-warm-600 leading-relaxed">
                  用賀・駒沢エリアは複数路線が利用できる便利な立地ですが、出口によってスタジオまでの距離が大きく変わることがあります。通う前にGoogleマップで自分の利用路線からのルートを確認しておきましょう。
                </p>
              </div>
              <div className="bg-white rounded-lg p-6 border border-warm-200">
                <h3 className="text-lg font-bold text-warm-900 mb-3">平日夜・土日午前は予約が集中</h3>
                <p className="text-warm-600 leading-relaxed">
                  用賀・駒沢エリアでは平日19時〜21時、土日午前中がレッスン予約のピークタイムです。人気スタジオは早めの予約が必須。平日午前〜昼間は比較的空いているので、時間に融通が利く方は狙い目です。
                </p>
              </div>
              <div className="bg-white rounded-lg p-6 border border-warm-200">
              ...
              <div className="bg-white rounded-lg p-6 border border-warm-200">
                ...
                <p className="text-warm-600 leading-relaxed">
                  用賀・駒沢エリアにはグループ専門からパーソナル専門まで多彩なスタジオがあります。1つだけで決めず、2〜3スタジオの体験レッスンを受けて、インストラクターとの相性や雰囲気を比較してから入会を決めましょう。
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="bg-warm-50 rounded-lg p-8 border border-warm-200">
              ...
              <div className="mt-6 p-4 bg-white rounded border border-warm-200">
                <p className="text-sm text-warm-600">
                  <strong>用賀・駒沢エリアの豆知識：</strong>スタジオによってはウェアやタオルのレンタルサービスを提供しているところもあります。仕事帰りや外出先から直接通いたい方は、レンタルの有無を事前に確認しておくと便利です。
                </p>
              </div>
            </div>
          </div>
