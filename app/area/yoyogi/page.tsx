...
const studios = [
  {
    ...
    features: ['マンツーマン', '1回30分', 'ウェイトトレーニング併用', '月1回カウンセリング', '女性トレーナー在籍日あり', '男女利用可'],
    description:
      'パーソナルマシンピラティスとウェイトトレーニングを組み合わせ、一人ひとりの目的に合わせたプログラムを提供するマンツーマン専門店。姿勢改善や身体の使い方の改善といったコンディショニングにも対応しています。月1回のカウンセリングで目標設定と進捗を確認しながら継続できる仕組みがあり、女性トレーナーが在籍する曜日もあるため、初心者でも通いやすい環境です。1回30分のレッスンが中心で、月額制の通い放題プランにも対応。ウェア・靴・タオル・プロテイン・ドリンク・アメニティがすべて無料レンタルで手ぶらで通えます。JR「代々木駅」から徒歩5分、男女ともに利用できます。',
    ...
    basicInfo: {
      ...
      closed: 'なし',
      facilities: ['ウェアレンタル（無料）', '靴・タオル（無料）', 'プロテイン・ドリンク（無料）', 'アメニティ'],
    },
  },
  {
