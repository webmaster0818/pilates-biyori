...
export const metadata = {
  alternates: { canonical: 'https://biyori-pilates.com/area/kashiwa/' },
  title: '【2026年9月最新】柏のピラティス6社を比較｜無料体験2社・月額最安7,700円〜',
  description: '柏エリアでおすすめのピラティススタジオを料金・無料体験・マシン対応で徹底比較。初心者向けの選び方、駅近スタジオ、体験レッスンの有無まで2026年6月の最新情報でわかります。',
...
const studios = [
  ...
  },
  {
    ...
    access: '柏駅 徒歩4分',
    address: '〒277-0021 千葉県柏市中央町２−２８ アーク柏中央402',
    options: [
  ...
  return (
    <>
      ...
      <BreadcrumbSchema items={[
        ...
        { name: '柏', url: 'https://pilates-biyori.com/area/kashiwa/' },
      ]} />
      ...
      <main className="pt-20 bg-white">
        ...
        <TableOfContents areaName="柏" studioNames={[...studios].sort((a,b)=>(((b as any).officialUrl||'').includes('felmat')?1:0)-(((a as any).officialUrl||'').includes('felmat')?1:0)).map((s) => s.name)} />
      ...
      <ConsultantSection areaKey="kashiwa" areaName="柏" />
      ...
      <div className="my-8 bg-white border border-warm-200 p-5">
        ...
        <div className="flex flex-wrap gap-2">
          ...
          <Link href="/brands/the-silk-kashiwa/" className="text-xs text-warm-800 border border-warm-300 bg-white px-3 py-1.5 hover:border-warm-500 transition-colors">the SILK 柏店の料金・体験を見る</Link>
