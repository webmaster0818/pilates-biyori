...
export const metadata = {
  title: '【2026最新】ピラティス覚王山おすすめ5選！人気スタジオの料金プランを簡単比較！｜Pilates-Biyori',
...
const studios = [
  ...
  },
  {
    ...
    reviews: [
      { author: 'M.S', rating: 5, date: '1週間前', text: 'ピラティス専門大手スタジオ。覚王山エリアからもアクセスしやすい名古屋市内店舗。全国150店舗以上で相互利用可能。気に入っています。' },
      { author: 'A.Y', rating: 5, date: '2週間前', text: 'インストラクターの指導が丁寧で初心者でも安心。' },
      { author: 'K.T', rating: 4, date: '3週間前', text: '清潔感のあるスタジオで気持ちよくレッスンできます。' },
    ],
  ...
  return (
    <>
      ...
      <main className="pt-20 bg-white">
        ...
        <section className="py-16 bg-warm-50" id="studios"><div className="max-w-6xl mx-auto px-6 lg:px-8"><h2 className="text-2xl md:text-3xl font-bold text-warm-900 mb-8 text-center">覚王山のおすすめピラティススタジオ5選</h2><div className="space-y-8">{studios.map((studio, index) => (<StudioCard key={index} studio={studio} index={index} />))}</div></div></section>
