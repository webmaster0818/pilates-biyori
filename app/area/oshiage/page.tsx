...
export const metadata = {
  alternates: { canonical: 'https://biyori-pilates.com/area/oshiage/' },
  title: '【2026年8月最新】押上のピラティス｜初心者OK・無料体験で選ぶ料金比較',
  description: '押上エリアでおすすめのピラティススタジオを料金・無料体験・マシン対応で徹底比較。初心者向けの選び方、駅近スタジオ、体験レッスンの有無まで2026年6月の最新情報でわかります。',
    ...
    reviews: [
      {
        ...
        rating: 5,
        date: '2週間前',
        text: '押上から半蔵門線で2駅の錦糸町駅。スカイツリー近くで、全国150店舗他店利用できるので、出張先や旅行先でも継続できます。',
      },
      {
        author: 'F.H',
        rating: 4,
...
export default function OshiageAreaPage() {
  return (
    <>
      ...
      <ConsultantSection areaKey="oshiage" areaName="押上" />
