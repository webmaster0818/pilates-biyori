...
const studios = [
  {
    ...
    rating: 4.8, reviewCount: 205,
    reviews: [
      { author: 'K.M', rating: 5, date: '1週間前', text: '吉祥寺駅から近く通いやすい。リフォーマー・キャデラック・チェア・ラダーバレルなど充実のマシン設備。マットもマシンも両方受けられる。' },
      { author: 'Y.S', rating: 5, date: '2週間前', text: '男性もOKで夫婦で通っています。全国150店舗以上で相互利用可能。体験当日入会で入会金無料のキャンペーンも。' },
      { author: 'A.T', rating: 4, date: '3週間前', text: 'ピラティス専門で20年以上の実績。インストラクターの質が高く、朝7時からレッスンがあるので出勤前に通えます。' },
    ],
    ...
    basicInfo: { hours: '平日 7:00〜21:00 / 土日祝 7:00〜18:00', closed: '不定休', facilities: ['リフォーマー', 'キャデラック', 'チェア', 'ラダーバレル', 'マット'] },
  },
  {
    name: 'ピラティスK 吉祥寺店',
    ...
    reviews: [
      { author: 'M.N', rating: 5, date: '1週間前', text: '吉祥寺駅近く。女性専用で音楽に合わせたリフォーマーレッスンが楽しい。脚・お尻・お腹・二の腕・背中の5パート別プログラムが充実。' },
      { author: 'S.H', rating: 5, date: '2週間前', text: '月4回13,420円とコスパ良好。マシンピラティス専門なのでリフォーマーの台数が多く予約が取りやすい。' },
      { author: 'R.K', rating: 4, date: '3週間前', text: '初心者向けクラスも充実。体験レッスンで雰囲気を確認できました。商業エリアにあるのでレッスン後の買い物も楽しめる。' },
    ],
  ...
  },
  {
    ...
    reviews: [
      { author: 'E.Y', rating: 5, date: '1週間前', text: '女性専用で清潔感のあるおしゃれな内装。音楽に合わせたリフォーマーレッスンが楽しい。手ぶら無料体験で気軽に試せました。' },
      { author: 'N.M', rating: 5, date: '2週間前', text: 'ウェア・タオル無料貸出やウォーターサーバーも完備。体験者の8割がピラティス未経験者なので初心者でも安心。' },
      { author: 'T.K', rating: 4, date: '3週間前', text: '月3回12,980円〜と始めやすい料金。入会キャンペーンで入会金無料になることが多い。' },
    ],
  ...
  },
  {
    ...
    reviews: [
      { author: 'C.Y', rating: 5, date: '1週間前', text: 'コナミスポーツ運営で安心。天井の鏡で自分のフォームを確認しながらレッスンできるのが画期的。30分のレッスンで効率的。' },
      { author: 'H.M', rating: 4, date: '2週間前', text: '月6回11,000円と手頃な価格。7回目以降も1回1,100円で追加OK。レッスン前の20分セルフトレーニングも可能。' },
      { author: 'A.K', rating: 5, date: '3週間前', text: '体験2,200円で雰囲気がわかる。プライベートレッスンも30分4,400円〜とリーズナブル。' },
    ],
  ...
  },
  {
    ...
    reviews: [
      { author: 'Y.K', rating: 5, date: '1週間前', text: '吉祥寺駅近くの完全パーソナルマシンピラティス。月謝制で1レッスン6,250円〜とパーソナルとしてはリーズナブル。体の癖に合わせたオーダーメイドレッスン。' },
      { author: 'M.T', rating: 4, date: '2週間前', text: '体験4,500円で丁寧なカウンセリング。マンツーマンなので周りを気にせず集中できる。3ヶ月で体の変化を実感。' },
      { author: 'K.S', rating: 5, date: '3週間前', text: 'リフォーマー・キャデラック・チェアなど本格マシン完備。男性もOK。朝8時から夜21時まで営業。' },
    ],
...
const faqs = [
  { question: 'ピラティス初心者でも大丈夫ですか？', answer: '大丈夫です！吉祥寺エリアのスタジオはほとんどが初心者歓迎。the SILKは体験者の約8割がピラティス未経験者、ピラティスKは初心者向けクラスが充実。' },
  { question: 'マットピラティスとマシンピラティスの違いは？', answer: 'マットは自重エクササイズ、マシンはリフォーマー等の専用マシンを使用。マシンは負荷調整しやすく初心者におすすめ。吉祥寺はマシン専門スタジオが充実。' },
  { question: '吉祥寺のピラティスの料金相場は？', answer: 'グループ月4回で10,450円〜15,070円。ピラティスミラーは月6回11,000円とコスパ◎。パーソナルはSTUDIO IVYが月2回15,000円〜。' },
  ...
  { question: '男性でも通えるスタジオはありますか？', answer: 'zen place吉祥寺、ピラティスミラー、STUDIO IVYは男性も通えます。the SILKとピラティスKは女性専用。' },
  { question: '短時間で効果的なスタジオは？', answer: 'ピラティスミラーは1レッスン30分で効率的。コナミスポーツ運営で安心。月6回11,000円の手頃な料金。' },
  { question: '無料で体験できるスタジオは？', answer: 'the SILKは手ぶらで無料体験可能。zen placeはグループ体験1,000円。' },
  ...
  return (
    <>
      ...
      <main className="pt-20 bg-white">
        ...
        <section className="py-16 bg-warm-50"><div className="max-w-4xl mx-auto px-6 lg:px-8"><h2 className="text-2xl md:text-3xl font-bold text-warm-900 mb-6 text-center">まとめ</h2><p className="text-warm-600 leading-relaxed mb-6">今回は吉祥寺エリアのおすすめピラティススタジオについてご紹介してきましたが、いかがでしたか？</p><p className="text-warm-600 leading-relaxed mb-6">この記事では吉祥寺にあるピラティススタジオから厳選したものだけを紹介しているので、ひとまず今回まとめた中から探すのもありだと思いますよ。</p><p className="text-warm-600 leading-relaxed mb-6">ぜひこの記事を参考に自分に合うピラティススタジオを見つけてくださいね。</p><p className="text-warm-700 font-medium text-center">あなたにぴったりのピラティススタジオが見つかることを願っています。</p></div></section>
