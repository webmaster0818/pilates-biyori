...
const studios = [
  ...
  },
  {
    ...
    access: '吉祥寺駅 徒歩3分',
    address: '〒180-0005 東京都武蔵野市御殿山１丁目６ エルドラド吉祥寺 303',
    options: [
    ...
    <>
      ...
      <div className="my-8 bg-white border border-warm-200 p-5">
        ...
        <div className="flex flex-wrap gap-2">
          ...
          <Link href="/brands/the-silk-kichijoji/" className="text-xs text-warm-800 border border-warm-300 bg-white px-3 py-1.5 hover:border-warm-500 transition-colors">the SILK 吉祥寺店の料金・体験を見る</Link>
