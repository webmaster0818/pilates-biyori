...
export const metadata = {
  title: '【2026年6月最新】ピラティス志木おすすめ5選！料金・体験レッスン・マシン対応を比較！',
    ...
    reviews: [
      {
        ...
        rating: 5,
        date: '1週間前',
        text: 'ピラティス専門の大手スタジオ。マットもマシンも両方受けられるのが魅力。全国150店舗以上で相互利用可能なので出張先でも通える。',
      },
      {
        author: 'Y.S',
        rating: 4,
  ...
  return (
    <>
      ...
      <main className="pt-20 bg-white">
        ...
        <TableOfContents areaName="志木" studioNames={studios.map((s) => s.name)} />
