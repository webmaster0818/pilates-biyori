...
export const metadata = {
  title: '【2026年6月最新】ピラティス駒沢大学おすすめ6選！料金・体験レッスン・マシン対応を比較！',
  ...
  return (
    <>
      ...
      <main className="pt-20 bg-white">
        ...
        <section className="py-16 bg-warm-50" id="studios"><div className="max-w-6xl mx-auto px-6 lg:px-8"><h2 className="text-2xl md:text-3xl font-bold text-warm-900 mb-8 text-center">駒沢大学のおすすめピラティススタジオ6選</h2><div className="space-y-8">{studios.map((studio, index) => (<StudioCard key={index} studio={studio} index={index} />))}</div></div></section>
