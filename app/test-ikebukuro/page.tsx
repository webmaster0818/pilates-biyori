...
const studios = [
  {
    ...
    reviews: [
      {
        ...
        rating: 5,
        date: '2週間前',
        text: 'インストラクターの指導が丁寧で、初心者の私でも安心して通えています。マシンも最新で、姿勢が改善されました！池袋駅から近いのも通いやすくて助かります。',
      },
      {
        author: '佐藤さん',
        rating: 5,
        date: '1ヶ月前',
        text: '体験レッスンから入会しました。少人数制なので一人ひとりしっかり見てもらえます。3ヶ月で腰痛が改善され、姿勢も良くなったと周りから言われるようになりました。',
      },
      {
        author: '鈴木さん',
        rating: 5,
        date: '2ヶ月前',
        text: 'スタジオが清潔で雰囲気が良いです。マットとマシン両方できるので飽きずに続けられます。スタッフの方も親切で、質問にも丁寧に答えてくれます。',
      },
    ],
    price: '月4回 13,200円〜',
    trial: '体験レッスン 1,000円',
    ...
    access: '池袋駅東口から徒歩3分',
    address: '東京都豊島区南池袋1-25-11 第15野萩ビル 8F',
    popularPlan: {
      name: 'フリープラン（月4回）',
  ...
  },
  {
    ...
    reviews: [
      {
        ...
        rating: 5,
        date: '1週間前',
        text: 'AI姿勢分析がすごい！自分の体の歪みが一目で分かり、それに合わせたメニューを組んでくれます。女性専用なので周りの目を気にせず集中できるのも良いです。',
      },
      {
        author: '中村さん',
        rating: 5,
        date: '3週間前',
        text: '池袋駅直結なので雨の日も通いやすいです。マシンが最新で使いやすく、体験レッスンが500円なのも嬉しい。2ヶ月でウエストが-5cm細くなりました！',
      },
      {
        author: '伊藤さん',
        rating: 5,
        date: '1ヶ月前',
        text: '科学的なアプローチで効果が出やすいです。インストラクターの知識も豊富で、質問するといつも分かりやすく説明してくれます。女性専用なのも安心です。',
      },
    ],
    price: '月4回 14,800円〜',
    trial: '体験レッスン 500円',
    ...
    access: '池袋駅西口直結',
    address: '東京都豊島区西池袋1-11-1 メトロポリタンプラザビル 10F',
    popularPlan: {
      name: 'スタンダード4（月4回）',
  ...
  },
  {
    ...
    reviews: [
      {
        ...
        rating: 5,
        date: '5日前',
        text: '暗闇×音楽でテンション上がります！周りを気にせず思いっきり体を動かせるので、ストレス発散にもなります。楽しく続けられて、3ヶ月で-4kg痩せました。',
      },
      {
        author: '小林さん',
        rating: 5,
        date: '2週間前',
        text: '音楽に合わせて動くので飽きずに楽しく続けられます。女性専用で安心ですし、インストラクターも明るくて元気をもらえます。体験レッスンが無料なのも良かったです。',
      },
      {
        author: '加藤さん',
        rating: 5,
        date: '3週間前',
        text: 'グループレッスンですが、一人ひとりしっかり見てくれます。暗闇なので周りの目を気にせず集中できて、普段恥ずかしがり屋の私でも楽しく通えています。',
      },
    ],
    price: '月4回 15,070円〜',
    trial: '無料体験レッスン',
    ...
    access: '池袋駅東口から徒歩5分',
    address: '東京都豊島区東池袋1-3-5 池袋伊藤ビル 7F',
    popularPlan: {
      name: 'マンスリー4メンバー',
  ...
  },
  {
    ...
    description: 'マシンピラティス特化型スタジオ。暗闇×音楽で没入感のあるレッスン。池袋駅メトロポリタン口から徒歩2分の好アクセス。最新のリフォーマーマシンを完備し、音楽に合わせた独自プログラムで楽しくトレーニング。女性専用で初心者も安心。',
    access: '池袋駅メトロポリタン口から徒歩2分',
  },
  {
    ...
    description: 'アメリカ発の世界最大級ピラティススタジオチェーン。池袋駅西口から徒歩3分。グループレッスンからプライベートレッスンまで幅広く対応。全米No.1のピラティスメソッドで、初心者から上級者まで満足できるプログラムを提供。',
    access: '池袋駅西口から徒歩3分',
  },
  {
    ...
    description: '完全プライベートレッスン専門スタジオ。池袋駅東口から徒歩3分。一人ひとりの目的・体力に合わせたオーダーメイドレッスン。経験豊富なインストラクターがマンツーマンで指導するので、短期間で効果を実感できます。',
    access: '池袋駅東口から徒歩3分',
  },
  {
    ...
    description: 'リフォーマー専門のピラティススタジオ。東池袋、目白エリアに展開。少人数制で丁寧な指導が魅力。最新のリフォーマーマシンを使用した効果的なトレーニングで、姿勢改善やボディメイクを実現します。',
    access: '東池袋駅から徒歩5分',
  },
  {
    ...
    description: '24時間営業のピラティススタジオ。池袋駅西口から徒歩1分の好立地。早朝・深夜でも利用可能なので、忙しい方にも最適。月額定額で通い放題プランあり。最新マシンを完備し、自分のペースでトレーニングできます。',
    access: '池袋駅西口から徒歩1分',
  },
  {
    ...
    description: '女性専用・少人数制のアットホームなスタジオ。南池袋、東池袋に展開。マットピラティスとマシンピラティスの両方に対応。インストラクターとの距離が近く、丁寧な指導を受けられるのが魅力。初心者でも安心して通えます。',
    access: '池袋駅東口から徒歩7分',
  },
  {
    name: 'BDC PILATES 池袋',
  ...
  },
  {
    ...
    description: '理学療法士監修のピラティススタジオ。池袋駅北口から徒歩3分。リハビリテーションの知識を活かした安全で効果的なレッスン。腰痛や肩こりなどの身体の不調改善にも対応。医学的根拠に基づいたトレーニングで健康的な身体づくりを実現。',
    access: '池袋駅北口から徒歩3分',
  },
  {
    ...
    description: 'ヨガとピラティスの融合スタジオ。東池袋エリアに展開。心と身体の両方を整えるプログラムが人気。ヨガの呼吸法とピラティスのコアトレーニングを組み合わせた独自メソッドで、柔軟性と筋力を同時に向上させます。',
    access: '東池袋駅から徒歩3分',
  },
  {
    ...
    description: 'ボディメイク特化型のピラティススタジオ。池袋駅西口から徒歩4分。ダイエットや引き締めに特化したプログラムが充実。最新マシンとパーソナルトレーニングで、短期間での理想のボディラインを目指せます。',
    access: '池袋駅西口から徒歩4分',
  },
  {
    ...
    description: 'アットホームな雰囲気の少人数制スタジオ。南池袋エリアに展開。マットピラティスを中心に、初心者でも無理なく始められるプログラムを提供。インストラクターとの距離が近く、質問しやすい環境が魅力です。',
    access: '池袋駅東口から徒歩8分',
  },
  {
    ...
    description: 'ウェルネス志向のピラティススタジオ。池袋駅北口から徒歩5分。ピラティスにマインドフルネスを取り入れた独自プログラム。ストレス解消や心身のバランスを整えることを重視。女性専用で落ち着いた雰囲気の中でレッスンを受けられます。',
    access: '池袋駅北口から徒歩5分',
  },
]
      ...
      <main className="pt-20 bg-white">
        ...
        <section className="bg-gradient-to-br from-warm-50 to-warm-100 py-12 md:py-16">
          <div className="max-w-4xl mx-auto px-6 lg:px-8">
            <p className="text-warm-400 text-xs mb-2">更新日 @2026年04月01日</p>
          ...
          <div className="max-w-6xl mx-auto px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="border border-warm-200 rounded-lg p-6 hover:shadow-lg transition">
                ...
                <p className="text-warm-600 text-sm mb-4">
                  池袋駅から徒歩3分以内。仕事帰りや買い物ついでに通いやすい好立地なスタジオ。
                </p>
                <ul className="space-y-2 text-sm">
