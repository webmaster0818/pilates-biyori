...
export const areaStudios: Record<string, AreaData> = {
  ...
  'hankyu-itami': {
    ...
    studios: [
      ...
      {
        name: 'マシンピラティス&パーソナルトレーニングジム emovere（エモベーレ）',
        officialUrl: 'https://emovere.co.jp',
        price: 'パーソナル25分 月2回8,000円〜月8回29,600円／50分 月2回15,200円〜月8回56,000円／グループ（最大3名）月2回6,200円〜月8回20,000円',
        trial: '無料体験レッスンあり',
        features: ['阪急伊丹駅徒歩3分', 'マシンピラティス＋パーソナル', 'グループ最大3名', '男女利用可'],
        description: 'マシンピラティスとパーソナルトレーニングを組み合わせたジム。25分・50分のパーソナルと最大3名のグループレッスンに対応し、無料体験レッスンも用意。阪急伊丹駅から徒歩3分、男女ともに利用できます。',
        access: '阪急伊丹駅から徒歩3分',
