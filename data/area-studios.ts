  ...
  'kurume': {
    ...
    studios: [
      ...
      },
      {
        ...
        access: '西鉄久留米駅 徒歩5分',
        address: '〒830-0035 福岡県久留米市東和町６−９ フジホーム久留米ビル ９０３',
        options: [
          '月2回コース 8,800円（1回4,400円・税込）',
          '月8回コース 22,000円（1回2,750円・税込）',
          '通い放題コース（人数限定）24,600円（税込）',
    ...
    studios: [
      {
        ...
        trial: '初回体験 無料キャンペーンあり（通常9,800円・毎月先着30名限定）',
        features: ['女性専用', 'マシンピラティス専門', '最大5名セミパーソナル＋完全パーソナル'],
        description: '女性専用のマシンピラティス専門スタジオ。1セッション最大5名のセミパーソナル形式で、グループより手厚くパーソナルより通いやすい価格帯。佐倉駅から徒歩2分。',
        access: '佐倉駅 徒歩2分',
        address: '〒285-0817 千葉県佐倉市大崎台１丁目17−２３ ＴＡＫＡＯビル 202',
        options: [
          '月2回コース 8,800円（1回4,400円・税込）',
          '月8回コース 22,000円（1回2,750円・税込）',
          '通い放題コース（人数限定）24,600円（税込）',
    ...
    studios: [
      {
        ...
        trial: '初回体験 無料キャンペーンあり（通常9,800円・毎月先着30名限定）',
        features: ['女性専用', 'マシンピラティス専門', '最大5名セミパーソナル＋完全パーソナル'],
        description: '女性専用のマシンピラティス専門スタジオ。1セッション最大5名のセミパーソナル形式で、グループより手厚くパーソナルより通いやすい価格帯。西鉄二日市駅から徒歩5分。',
        access: '西鉄二日市駅 徒歩5分',
        address: '〒818-0072 福岡県筑紫野市二日市北３丁目１−１５ サリイビル 2階A号室',
        options: [
          '月2回コース 8,800円（1回4,400円・税込）',
          '月8回コース 22,000円（1回2,750円・税込）',
          '通い放題コース（人数限定）24,600円（税込）',
    ...
    studios: [
      {
        ...
        trial: '初回体験 無料キャンペーンあり（通常9,800円・毎月先着30名限定）',
        features: ['女性専用', 'マシンピラティス専門', '最大5名セミパーソナル＋完全パーソナル'],
        description: '女性専用のマシンピラティス専門スタジオ。1セッション最大5名のセミパーソナル形式で、グループより手厚くパーソナルより通いやすい価格帯。小山駅から徒歩9分。',
        access: '小山駅 徒歩9分',
        address: '〒323-0022 栃木県小山市駅東通り２丁目８−１ 小山ステーションヒルズ 206',
        options: [
          '月2回コース 8,800円（1回4,400円・税込）',
          '月8回コース 22,000円（1回2,750円・税込）',
          '通い放題コース（人数限定）24,600円（税込）',
    ...
    studios: [
      {
        ...
        trial: '初回体験 無料キャンペーンあり（通常9,800円・毎月先着30名限定）',
        features: ['女性専用', 'マシンピラティス専門', '最大5名セミパーソナル＋完全パーソナル'],
        description: '女性専用のマシンピラティス専門スタジオ。1セッション最大5名のセミパーソナル形式で、グループより手厚くパーソナルより通いやすい価格帯。西鉄久留米駅から徒歩5分。',
        access: '西鉄久留米駅 徒歩5分',
        address: '〒830-0035 福岡県久留米市東和町６−９ フジホーム久留米ビル ９０３',
        options: [
          '月2回コース 8,800円（1回4,400円・税込）',
