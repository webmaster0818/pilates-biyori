  ...
  'hankyu-itami': {
    ...
    studios: [
      ...
      },
      {
        ...
        trial: '無料体験レッスン有り',
        features: ['阪急伊丹駅から徒歩3分', 'マシンピラティス／パーソナルトレーニング', 'グループレッスン（最大3名）', '男女両方とも利用可能', '営業：月〜土 8:00-22:00／日・祝 8:00-20:00（不定休）'],
        description: 'マシンピラティスとパーソナルトレーニングを組み合わせたジム。25分間・50分間のパーソナルトレーニングと、最大3名のグループトレーニングに対応し、無料体験レッスンも用意。阪急伊丹駅から徒歩3分、男女ともに利用できます。営業時間は月〜土曜8:00-22:00、日・祝8:00-20:00（不定休）。',
        access: '阪急伊丹駅から徒歩3分',
