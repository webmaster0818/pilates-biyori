...
export const areaStudios: Record<string, AreaData> = {
  ...
  'hongo-sanchome': {
    name: '本郷三丁目',
    region: '関東',
    description: '本郷三丁目エリアのピラティススタジオを掲載。本郷三丁目駅周辺の通いやすいスタジオをまとめています。',
    studios: [
      {
        name: 'BREST PILATES & BODYMAKE 本郷三丁目',
        officialUrl: 'https://t.felmat.net/fmcl?ak=C11549B.1.O159707H.U1357808',
        image: '/images/studios/brest.webp',
        price: '月4回 22,880円〜（パーソナル）',
        trial: '体験レッスンあり（詳細は公式サイト参照）',
        features: ['マシンピラティス', 'ウェイトトレーニング', 'パーソナル', '約30分集中'],
        description: 'マシンピラティスとウェイトトレーニングを組み合わせたパーソナルスタジオ。インナーマッスルとアウターマッスルの両方にアプローチし、約30分の効率的なセッションでボディメイクを目指せます。全国展開のURBAN CLASSIC PILATESの姉妹ブランドで、初心者にもトレーナーが丁寧に対応。本郷三丁目エリアの店舗です。',
        access: '本郷三丁目エリア（詳細は公式サイト参照）',
        address: '東京都（詳細は公式サイト参照）',
        basicInfo: { hours: '詳細は公式サイト参照', closed: '詳細は公式サイト参照', facilities: ['マシンピラティス', 'パーソナル', '更衣室', 'ウェイトエリア'] },
      },
      {
        ...
        price: '詳細は公式サイト参照',
        trial: '体験レッスンあり（詳細は公式サイト参照）',
        features: ['マシンピラティス', '女性専用', '少人数制', '部位別プログラム'],
        description: 'ホットヨガLAVAが運営する女性専用マシンピラティス専門スタジオ。最新のリフォーマーを使い、全身をバランスよく鍛える部位別プログラムを提供しています。少人数制のグループ形式で、初心者の女性でも自分のペースで取り組めます。本郷三丁目駅からすぐ。',
        access: '本郷三丁目駅周辺（詳細は公式サイト参照）',
        address: '東京都文京区（詳細は公式サイト参照）',
        basicInfo: { hours: '詳細は公式サイト参照', closed: '詳細は公式サイト参照', facilities: ['マシンピラティス', '女性専用', '少人数制', '部位別プログラム'] },
      },
      {
        ...
        price: '詳細は公式サイト参照',
        trial: '体験レッスンあり（詳細は公式サイト参照）',
        features: ['マシンピラティス', 'マット', 'プライベート', '男性可'],
        description: '全国展開の大手ピラティス専門スタジオ。マットグループ・マシン（リフォーマー）グループ・プライベートなど多彩なレッスンを提供し、男性も利用できます。本郷三丁目エリアの店舗。',
        access: '本郷三丁目駅周辺（詳細は公式サイト参照）',
        address: '東京都文京区（詳細は公式サイト参照）',
        basicInfo: { hours: '詳細は公式サイト参照', closed: '詳細は公式サイト参照', facilities: ['マシンピラティス', 'マット', 'プライベート', '男性可'] },
      },
    ],
  },
  'awaji': {
    name: '淡路',
    region: '近畿',
    description: '淡路エリアのピラティススタジオを掲載。淡路駅周辺の通いやすいスタジオをまとめています。',
    studios: [
      {
        name: 'BREST PILATES & BODYMAKE 淡路',
        officialUrl: 'https://t.felmat.net/fmcl?ak=C11549B.1.31597027.U1357808',
        image: '/images/studios/brest.webp',
        price: '月4回 22,880円〜（パーソナル）',
        trial: '体験レッスンあり（詳細は公式サイト参照）',
        features: ['マシンピラティス', 'ウェイトトレーニング', 'パーソナル', '約30分集中'],
        description: 'マシンピラティスとウェイトトレーニングを組み合わせたパーソナルスタジオ。インナーマッスルとアウターマッスルの両方にアプローチし、約30分の効率的なセッションでボディメイクを目指せます。全国展開のURBAN CLASSIC PILATESの姉妹ブランドで、初心者にもトレーナーが丁寧に対応。淡路エリアの店舗です。',
        access: '淡路エリア（詳細は公式サイト参照）',
        address: '大阪府（詳細は公式サイト参照）',
        basicInfo: { hours: '詳細は公式サイト参照', closed: '詳細は公式サイト参照', facilities: ['マシンピラティス', 'パーソナル', '更衣室', 'ウェイトエリア'] },
      },
      {
        name: 'URBAN CLASSIC PILATES 淡路店',
        officialUrl: 'https://t.felmat.net/fmcl?ak=Z11337L.1.X156352B.U1357808',
        image: '/images/studios/urban-classic-pilates.webp',
        price: '詳細は公式サイト参照',
        trial: '体験レッスンあり（詳細は公式サイト参照）',
        features: ['マシンピラティス', 'サーキット形式', '予約不要', '通いやすい'],
        description: '予約不要・1回30分のサーキット形式で気軽に通えるマシンピラティス専門スタジオ。リーズナブルな価格と続けやすさが魅力で、全国展開しています。淡路店。',
        access: '淡路駅周辺（詳細は公式サイト参照）',
        address: '大阪府大阪市東淀川区（詳細は公式サイト参照）',
        basicInfo: { hours: '詳細は公式サイト参照', closed: '詳細は公式サイト参照', facilities: ['マシンピラティス', 'サーキット', '更衣室', '女性も通いやすい'] },
      },
    ],
  },
  'gofukumachi': {
    name: '呉服町',
    region: '九州・沖縄',
    description: '呉服町エリアのピラティススタジオを掲載。呉服町駅周辺の通いやすいスタジオをまとめています。',
    studios: [
      {
        name: 'BREST PILATES & BODYMAKE 呉服町',
        officialUrl: 'https://t.felmat.net/fmcl?ak=C11549B.1.E159701B.U1357808',
        image: '/images/studios/brest.webp',
        price: '月4回 22,880円〜（パーソナル）',
        trial: '体験レッスンあり（詳細は公式サイト参照）',
        features: ['マシンピラティス', 'ウェイトトレーニング', 'パーソナル', '約30分集中'],
        description: 'マシンピラティスとウェイトトレーニングを組み合わせたパーソナルスタジオ。インナーマッスルとアウターマッスルの両方にアプローチし、約30分の効率的なセッションでボディメイクを目指せます。全国展開のURBAN CLASSIC PILATESの姉妹ブランドで、初心者にもトレーナーが丁寧に対応。呉服町エリアの店舗です。',
        access: '呉服町エリア（詳細は公式サイト参照）',
        address: '福岡県（詳細は公式サイト参照）',
        basicInfo: { hours: '詳細は公式サイト参照', closed: '詳細は公式サイト参照', facilities: ['マシンピラティス', 'パーソナル', '更衣室', 'ウェイトエリア'] },
      },
      {
        name: 'URBAN CLASSIC PILATES 呉服町店',
        officialUrl: 'https://t.felmat.net/fmcl?ak=Z11337L.1.X156352B.U1357808',
        image: '/images/studios/urban-classic-pilates.webp',
        price: '詳細は公式サイト参照',
        trial: '体験レッスンあり（詳細は公式サイト参照）',
        features: ['マシンピラティス', 'サーキット形式', '予約不要', '通いやすい'],
        description: '予約不要・1回30分のサーキット形式で気軽に通えるマシンピラティス専門スタジオ。リーズナブルな価格と続けやすさが魅力で、全国展開しています。呉服町店。',
        access: '呉服町駅周辺（詳細は公式サイト参照）',
        address: '福岡県福岡市博多区（詳細は公式サイト参照）',
        basicInfo: { hours: '詳細は公式サイト参照', closed: '詳細は公式サイト参照', facilities: ['マシンピラティス', 'サーキット', '更衣室', '女性も通いやすい'] },
      },
    ],
  },
