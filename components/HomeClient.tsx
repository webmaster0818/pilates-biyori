        ...
        <section className="py-20 md:py-28 bg-white" id="area-links">
          <div className="max-w-6xl mx-auto px-6 lg:px-8">
            ...
            <div className="mb-10 fade-up">
              <h3 className="text-sm font-medium text-warm-800 mb-4 pb-2 border-b border-warm-200 uppercase tracking-[0.1em]">注目エリア</h3>
              <div className="flex flex-wrap gap-2">
                {[
                  { name: '浜松町・大門', slug: 'hamamatsucho' },
                  { name: '秋葉原', slug: 'akihabara' },
                  { name: '北浜・淀屋橋', slug: 'kitahama' },
                  { name: '御茶ノ水', slug: 'ochanomizu' },
                  { name: '王子', slug: 'oji' },
                  { name: '和泉中央', slug: 'izumi' },
